...
public class ESC extends CMSSignatureTest
{
	...
	public void testESC1() throws Exception
	{
		...
		params.put(EParameters.P_REFERENCE_DIGEST_ALG, DigestAlg.SHA1);
		...
		//add signer
		bs.addSigner(ESignatureType.TYPE_ESC, getSignerCertificate(), getSignerInterface(SignatureAlg.RSA_SHA1), optionalAttributes, params);
	...
	public void testESC2() throws Exception
	{
		BaseSignedData bs = new BaseSignedData();
