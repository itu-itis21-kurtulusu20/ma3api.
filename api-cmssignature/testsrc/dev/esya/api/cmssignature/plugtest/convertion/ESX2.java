...
public class ESX2 extends  CMSSignatureTest
{
	private final String INPUT_DIR = getDirectory() + "convertion\\plugtests\\esc\\";
	private final String OUTPUT_DIR = getDirectory() +"convertion\\plugtests\\esx2\\";
	...
	throws Exception
	{
		...
		bs.getSignerList().get(0).convert(ESignatureType.TYPE_ESX_Type2, params);
