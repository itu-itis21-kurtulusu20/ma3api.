...
public class T05_ESX1 extends CMSSignatureTest{
	...
	throws Exception
	{
		...
		//add signer
		bs.addSigner(ESignatureType.TYPE_ESX_Type1, getSignerCertificate(), getSignerInterface(SignatureAlg.RSA_SHA1), null, params);
