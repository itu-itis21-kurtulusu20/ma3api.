...
public class T08_ESXLong1_EC extends CMSSignatureTest {
    ...
    public T08_ESXLong1_EC(SignatureAlg signatureAlg) {
    ...
    public void testCreateESXLong1() throws Exception
    {
        ...
        //add signer
        bs.addSigner(ESignatureType.TYPE_ESXLong_Type1, getECSignerCertificate(), getECSignerInterface(signatureAlg), null, params);
