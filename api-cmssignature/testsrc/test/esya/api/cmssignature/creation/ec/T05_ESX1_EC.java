...
public class T05_ESX1_EC extends CMSSignatureTest {
    ...
    public T05_ESX1_EC(SignatureAlg signatureAlg) {
    ...
    public void testCreateESX1() throws Exception
    {
        ...
        //add signer
        bs.addSigner(ESignatureType.TYPE_ESX_Type1, getECSignerCertificate(), getECSignerInterface(signatureAlg), null, params);
