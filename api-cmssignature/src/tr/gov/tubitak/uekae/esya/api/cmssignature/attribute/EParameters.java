...
public class EParameters
{
	 ...
	 * ISignable object
	 */
	public static final String P_EXTERNAL_CONTENT = "P_EXTERNAL_CONTENT";
	/**
     ...
     */
	public static final String P_CERT_VALIDATION_POLICY = "P_CERT_VALIDATION_POLICY";
    /**
     ...
     */
    public static final String P_CERT_VALIDATION_POLICIES = "P_CERT_VALIDATION_POLICYMAP";
    /**
     ...
     */
	@Deprecated
	public static final String P_TS_DIGEST_ALG = "P_TS_DIGEST_ALG"; 
    /**
     * Time Stamp setting to get time stamp
     * TSSettings object
     */
	public static final String P_TSS_INFO = "P_TSS_INFO";  
     ...
     * int[] object
     */
	public static final String P_POLICY_ID = "P_POLICY_ID";  
    /**
     * P_POLICY_VALUE parameter refers to value of policy. 
     * byte[] object
     */
	public static final String P_POLICY_VALUE = "P_POLICY_VALUE";  
    /**
     * P_POLICY_DIGEST_ALGORITHM parameter refers to the algorithm 
     * DigestAlg object, Default Value: SHA1
     */
	public static final String P_POLICY_DIGEST_ALGORITHM = "P_POLICY_DIGEST_ALGORITHM"; 
    /**
     * The certificates to pass signature validation.
     * List{@literal <ECertificate>} object
     */
	public static final String P_INITIAL_CERTIFICATES = "P_INITIAL_CERTIFICATES";  
    /**
     * The crls to pass signature validation.
     * List{@literal <ECRL>} object
     */
	public static final String P_INITIAL_CRLS = "P_INITIAL_CRLS";  
    /**
     * The ocsp responses to pass signature validation.
     * List{@literal <EOCSPResponse>} object
     */
	public static final String P_INITIAL_OCSP_RESPONSES = "P_INITIAL_OCSP_RESPONSES"; 
	/**
	 ...
	 */
	public static final String P_TRUST_SIGNINGTIMEATTR = "P_TRUST_SIGNINGTIMEATTR";  
     ...
     * Calendar object
     */
	public static final String P_SIGNING_TIME = "P_SIGNING_TIME";  
	/**
     ...
     */
	public static final String P_CURRENT_TIME = "P_CURRENT_TIME";  
	/**
     ...
     */
	public static final String P_GRACE_PERIOD = "P_GRACE_PERIOD";
	/**
	 ...
	 */
	public static final String P_REVOCINFO_PERIOD = "P_LAST_REVOCINFO_PERIOD";
     ...
     * Boolean object, Default Value: true
     */
	public static final String P_VALIDATE_CERTIFICATE_BEFORE_SIGNING = "P_VALIDATE_CERTIFICATE_BEFORE_SIGNING"; 
    /**
     ...
     * DigestAlg object, Default Value: SHA256
     */
	public static final String P_REFERENCE_DIGEST_ALG = "P_REFERENCE_DIGEST_ALG";
     ...
     * ECertificate object
     */
	public static final String P_COUNTER_SIGNATURE_CERTIFICATE = "P_COUNTER_SIGNATURE_CERTIFICATE";  
    /** 
     ...
     * BaseSigner object
     */
	public static final String P_COUNTER_SIGNATURE_SIGNER_INTERFACE = "P_COUNTER_SIGNATURE_SIGNER_INTERFACE";
	/**
     ...
     */
	public static final String P_VALIDATE_TIMESTAMP_WHILE_SIGNING = "P_VALIDATE_TIMESTAMP_WHILE_SIGNING";

    /**
     * Where to find referenced validation data
     * @see tr.gov.tubitak.uekae.esya.api.signature.certval.ValidationInfoResolver
     */
    public static final String P_VALIDATION_INFO_RESOLVER = "P_VALIDATION_INFO_RESOLVER";
    
    /**
     * Digest algorithm used for OCSP request
     */
    public static final String P_OCSP_DIGEST_ALG = "P_OCSP_DIGEST_ALG";

	/**
	 * The declared signing time should not be after the timestamp time.
	 * With the help of this parameter, the declared signing time can be delayed up to the amount of time specified via "P_TOLERATE_SIGNING_TIME_BY_SECONDS" parameter.
     */
	public static final String P_TOLERATE_SIGNING_TIME_BY_SECONDS = "P_TOLERATE_SIGNING_TIME_BY_SECONDS";

	public static final String P_VALIDATION_PROFILE = "P_VALIDATION_PROFILE";
}
