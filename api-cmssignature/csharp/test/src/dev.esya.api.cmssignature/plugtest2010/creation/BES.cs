...
namespace dev.esya.api.cmssignature.plugtest2010.creation
{
    ...
    {
        private readonly String OUTPUT_DIR; // = getDirectory() + "CAdES_InitialPackage\\CAdES-BES.SCOK\\TU\\";

        private readonly String ATTRIBUTE_CERTIFICATE_PATH;
        // = getDirectory() + "creation\\plugtests2010\\attributecertificate.cer";

        public BES()
        {
            OUTPUT_DIR = getDirectory() + "CAdES_InitialPackage\\CAdES-BES.SCOK\\TU\\";
            ATTRIBUTE_CERTIFICATE_PATH = getDirectory() + "creation\\plugtests2010\\attributecertificate.cer";
        }
        ...
        public void testCreateBES1()
        {
            ...
            paramaters[EParameters.P_CERT_VALIDATION_POLICY] = getPolicy();
        ...
        public void testCreateBES11()
        {
            ...
            bs2.getSignerList()[0].addCounterSigner(ESignatureType.TYPE_BES, getSecondSignerCertificate(),
                                                    getSecondSignerInterface(SignatureAlg.RSA_SHA1), optionalAttributes,
                                                    parameters);
        ...
        */
        ...
        {            
            ...
            signer[0].getSignerInfo().getSignerIdentifier();
            ...
            List<EAttribute> attrs = bs3.getSignerList()[0].getAttribute(SignerLocationAttr.OID);
            ...
            Assert.AreEqual(true, new String[] { "TUBITAK UEKAE", "GEBZE" }.SequenceEqual(sl.getPostalAddress()));            

            attrs = bs3.getSignerList()[0].getAttribute(ContentIdentifierAttr.OID);
            byte[] identifier = ContentIdentifierAttr.toIdentifier(attrs[0]);

            Assert.AreEqual(true, ASCIIEncoding.ASCII.GetBytes("PL123456789").SequenceEqual(identifier) );
