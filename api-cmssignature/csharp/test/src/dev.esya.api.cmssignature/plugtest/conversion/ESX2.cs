...
namespace dev.esya.api.cmssignature.convertion.plugtests
{
    ...
    public class ESX2 : CMSSignatureTest
    {
        ...
        private readonly String OUTPUT_DIR; // = getDirectory() + "convertion\\plugtests\\esx2\\";

        public ESX2()
        {
            INPUT_DIR = getDirectory() + "convertion\\plugtests\\esc\\";
            OUTPUT_DIR = getDirectory() + "convertion\\plugtests\\esx2\\";
        }


        /**
         * Create ESX2 signature with just CRL revocation references
         * Possible input: Signature-C-C-1.p7s
         */

        [Test]
        public void testConvertESX2FromESC_2()
        {
            ...
            bs.getSignerList()[0].convert(ESignatureType.TYPE_ESX_Type2, parameters);
        ...
        /**
         * Create ESX2 signature with just OCSP revocation references
         * Possible input: Signature-C-C-2.p7s
         */

        [Test]
        public void testConvertESX2FromESC_4()
        {
