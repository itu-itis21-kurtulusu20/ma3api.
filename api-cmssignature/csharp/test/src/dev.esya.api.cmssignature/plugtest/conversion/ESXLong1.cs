...
{
    [TestFixture]
    public class ESXLong1 : CMSSignatureTest
    {
        private readonly String INPUT_DIR; // = getDirectory() + "convertion\\plugtests\\esc\\";
        private readonly String OUTPUT_DIR; // = getDirectory() + "convertion\\plugtests\\esxlong1\\";

        public ESXLong1()
        {
            INPUT_DIR = getDirectory() + "convertion\\plugtests\\esc\\";
            OUTPUT_DIR = getDirectory() + "convertion\\plugtests\\esxlong1\\";
        }
        ...
        public void testConvertESXLong1FromESC_1()
        {
            ...
            bs.getSignerList()[0].convert(ESignatureType.TYPE_ESXLong_Type1, parameters);
