...
namespace tr.gov.tubitak.uekae.esya.api.cmssignature.creation.plugtests
{
    [TestFixture]
    public class EPES : CMSSignatureTest
    {
        ...
        public EPES()
        {
            OUTPUT_DIR = getDirectory() + "creation\\plugtests\\epes\\";
            SIGNATURE_POLICY_PATH = getDirectory() + "creation\\plugtests\\TARGET-SIGPOL-ETSI3.der";
        }
