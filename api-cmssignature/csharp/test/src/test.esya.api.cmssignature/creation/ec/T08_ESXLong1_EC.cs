...
namespace test.esya.api.cmssignature.creation.ec.ma3
{
    ...
    public class ESXLong1_EC : CMSSignatureTest {
        ...
        public void testCreateESXLong1(SignatureAlg signatureAlg) {
            ...
            // add signer
            bs.addSigner(ESignatureType.TYPE_ESXLong_Type1, getECSignerCertificate(), getECSignerInterface(signatureAlg), null, _params);
