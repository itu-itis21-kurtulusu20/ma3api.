...
namespace test.esya.api.cmssignature.creation.ec.ma3
{
    ...
    public class ESX2_EC : CMSSignatureTest {
        ...
        public void testCreateESX2(SignatureAlg signatureAlg) {
            ...
            // add signer
            bs.addSigner(ESignatureType.TYPE_ESX_Type2, getECSignerCertificate(), getECSignerInterface(signatureAlg), null, _params);
