...
using DisplayText = tr.gov.tubitak.uekae.esya.asn.cms.DisplayText;
 ...
 *
 */
    public class SignaturePolicyIdentifierAttr : AttributeValue
    {
        private readonly DigestAlg mDigestAlg = DigestAlg.SHA256;
        public static readonly Asn1ObjectIdentifier OID = AttributeOIDs.id_aa_ets_sigPolicyId;

        private readonly byte[] mHash;
        private readonly int[] mPolicyOid;
        private String spURI;
        private readonly String userNotice;
        /**
         * Create SignaturePolicyIdentifierAttr with given parameters
          * @param aProfile Turkish e-signature profile
          */
        public SignaturePolicyIdentifierAttr(TurkishESigProfile aProfile)
        {
         ...
         * Create SignaturePolicyIdentifierAttr with given parameters
          ...
          */
        public SignaturePolicyIdentifierAttr(TurkishESigProfile aProfile, DigestAlg aDigestAlg)
        {
