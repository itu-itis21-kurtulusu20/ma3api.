...
{
    /**
 * turktelekom mobile signature profile request implementation
 * @see IProfileRequest
 */

    public class TurkTelekomProfileRequest : IProfileRequest
    {
        ...
        public TurkTelekomProfileRequest(MSSParams aParams)
        {
            ...
            logger.Debug("turktelekomProfileRequest parametreleri belirlenecek.");
            setMSSParams(aParams);
            logger.Debug("turktelekomProfileRequest parametreleri belirlendi.");
        }
     ...
     */
        public IProfileResponse sendRequest(String aMSISDN, String aApTransId)
        {
            ...
            try
            {
                MSS_ProfileRespType response = _service.MSS_ProfileQuery(_request);
                logger.Debug("Request gönderildi. Response geldi.");
                return new TurkTelekomProfileResponse(response);
            }
            catch (Exception exc)
            {
