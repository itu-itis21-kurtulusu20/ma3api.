 ...
 */
    ...
    public class TurkTelekomSignatureRequest : ISignatureRequest
    {
        ...
        public ISignatureResponse sendRequest(String aTransId, String aMSISDN, ISignable aSignable)
        {
            ...
            try
            {
                ...
                return new TurkTelekomSignatureResponse(trcellResp);
            }
            catch (Exception exc)
            {
        ...
        private void _fillInSignatureRequest()
        {
            ...
            int queryTimeOut = _params.QueryTimeOutInSeconds;
            _request.TimeOut = "" + queryTimeOut;
        }
    }
}