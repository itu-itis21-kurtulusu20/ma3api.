...
// ----------------------------------------------------------------------------
// $Id: HashFactory.java,v 1.1 2004/11/02 11:39:40 serdar Exp $
//
...
public class HashFactory
{
     ...
     * @throws InternalError if the implementation does not pass its self-
     *                       test.
     */
    public static IMessageDigest getInstance(String name)
    {
        ...
        else if (name.equalsIgnoreCase(Registry.SHA224_HASH)) {
            result = new Sha224();
        }
        ...
        else if(name.equalsIgnoreCase(Registry.NONE_HASH)){
        	result = new NoneHash();
        }
