...
public class Sha224 implements IMessageDigest
{
    ...
    public boolean selfTest()
    {
        if (valid == null) {
            ...
            //output stream'e değerler basıyordu. Kaldırıldı.
            //System.out.println("found    : " + result);
            //System.out.println("expected : " + DIGEST0);
        }
...
//        X[xOff] = Pack.bigEndianToInt(in, inOff);
    ...
    {
        IMessageDigest md = new Sha224();
        System.out.println(md.selfTest());

        byte[] test = new byte[1003];
        md.reset();
        md.update(test, 0, test.length);

        System.out.println("B597BB7641655FBD6FAE53E58A5E25F1455A1CABC2E2435C0CA14465");
        System.out.println(""+Util.toString(md.digest()));
