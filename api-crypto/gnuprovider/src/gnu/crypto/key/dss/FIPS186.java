...
// ----------------------------------------------------------------------------
// $Id: FIPS186.java,v 1.1 2005/12/22 09:48:37 serdar Exp $
//
...
public class FIPS186 {
    ...
    *
    * <ul>
    *    <li><code>2<sup>159</sup> {@literal < q <} 2<sup>160</sup></code></li>
    *    <li><code>2<sup>L-1</sup> {@literal < p <} 2<sup>L</sup></code> for a
    *    specified <code>L</code>, where <code>L = 512 + 64j</code> for some
    *    <code>0 {@literal <= j <=} 8</code></li>
    *    <li>q divides p - 1.</li>
    * </ul>
    * <br>
    ...
    * to construct a prime, <code>q</code>, in the range 2<sup>159</sup> {@literal <} q
    * {@literal <} 2<sup>160</sup>. Once this is accomplished, the same <i>SEED</i>
    * value is used to construct an <code>X</code> in the range <code>2</code><sup>L-1
    * </sup> {@literal < X <} 2<sup>L</sup>. The prime, <code>p</code>, is then
