...
// ----------------------------------------------------------------------------
// $Id: Cast5.java,v 1.1 2004/11/02 11:39:39 serdar Exp $
//
...
public class Cast5 extends BaseCipher {
    ...
    *   <li> {@literal (L0,R0) <-- (m1...m64).}  (Split the plaintext into left and right
    ...
    *     </ul>
    *   </li>
    *   <li> {@literal c1...c64 <-- (R16,L16).} (Exchange final blocks L16, R16 and
