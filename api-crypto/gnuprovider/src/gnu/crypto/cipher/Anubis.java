...
// ----------------------------------------------------------------------------
// $Id: Anubis.java,v 1.1 2004/11/02 11:39:39 serdar Exp $
//
...
//   }
    ...
    * always use R values, R = 8 + N, and {@literal 4 <= N <= 10.}
    */
    ...
    *
    * @param uk the 32N-bit user-supplied key material, {@literal 4 <= N <= 10.}
