...
// ----------------------------------------------------------------------------
// $Id: Registry.java,v 1.3 2006/10/06 08:55:35 serdar Exp $
//
...
public interface Registry
{
    ...
    String UEKAE_CRYPTO_CARD_PRNG = "uekae_crypto_card";
    
    String SMART_CARD_PRNG = "smartcard_prng";
    
    String DGKGF_PRNG = "dgkgf";
    ...
    String ECDSA_SIG = "ecdsa";
    String RSA_ISO9796d2 = "rsa-iso9796d2";
    String RSA_RAW = "rsa-raw";
