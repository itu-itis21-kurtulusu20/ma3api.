...
// ----------------------------------------------------------------------------
// $Id: ISignature.java,v 1.1 2004/11/02 11:39:42 serdar Exp $
//
 ...
 *
 * <p>The Handbook of Applied Cryptography (HAC), by A. Menezes {@literal &} al. states:
...
public interface ISignature extends Cloneable {
    ...
    * {@link java.util.Random} instance to
