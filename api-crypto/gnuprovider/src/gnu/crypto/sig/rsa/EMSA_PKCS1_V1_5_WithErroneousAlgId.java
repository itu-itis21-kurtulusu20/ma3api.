...
// ----------------------------------------------------------------------------
// $Id: EMSA_PKCS1_V1_5.java,v 1.1 2004/11/02 11:39:42 serdar Exp $
//
 ...
 * @author ayetgin
 */
public class EMSA_PKCS1_V1_5_WithErroneousAlgId implements Cloneable {
   ...
   /* Notes.
      ...
      SHA-224: (0x)30 2D 30 0D 06 09 60 86 48 01 65 03 04 02 04 05 00 04 1C || H   by Orcun
      SHA-256: (0x)30 31 30 0d 06 09 60 86 48 01 65 03 04 02 01 05 00 04 20 || H
      SHA-384: (0x)30 41 30 0d 06 09 60 86 48 01 65 03 04 02 02 05 00 04 30 || H
      SHA-512: (0x)30 51 30 0d 06 09 60 86 48 01 65 03 04 02 03 05 00 04 40 || H
   */
   private static final byte[] MD2_PREFIX = {
      (byte) 0x30, /*(byte) 0x20*/(byte) 0x1E, (byte) 0x30, /*(byte) 0x0c*/(byte) 0x0a,
   ...
   private static final byte[] SHA160_PREFIX = {
      (byte) 0x30, /*(byte) 0x21*/(byte) 0x1F, (byte) 0x30, /*(byte) 0x09*/(byte) 0x07,
   ...
   private static final byte [] SHA224_PREFIX = {
	   0x30, /*0x2D*/(byte) 0x2B, 0x30, /*(byte) 0x0d*/(byte) 0x0b,
	   0x06, 0x09, 0x60, (byte) 0x86,
	   0x48, 0x01, 0x65, 0x03,
	   0x04, 0x02, 0x04, /*0x05,
	   0x00,*/ 0x04, 0x1C
   };
    ...
    private static final byte[] SHA256_PREFIX = {
       (byte) 0x30, /*(byte) 0x31*/ (byte)0x2F, (byte) 0x30, /*(byte) 0x0d*/(byte) 0x0b,
   ...
   private static final byte[] SHA384_PREFIX = {
      (byte) 0x30, /*(byte) 0x41*/(byte) 0x3F, (byte) 0x30, /*(byte) 0x0d*/(byte) 0x0b,
      (byte) 0x06, (byte) 0x09, (byte) 0x60, (byte) 0x86,
      (byte) 0x48, (byte) 0x01, (byte) 0x65, (byte) 0x03,
   ...
   private static final byte[] SHA512_PREFIX = {
      (byte) 0x30, /*(byte) 0x51*/(byte) 0x4F, (byte) 0x30, /*(byte) 0x0d*/(byte) 0x0b,
      (byte) 0x06, (byte) 0x09, (byte) 0x60, (byte) 0x86,
      (byte) 0x48, (byte) 0x01, (byte) 0x65, (byte) 0x03,
   ...
   private static final byte [] NONE_PREFIX = {};
    ...
    */
   private EMSA_PKCS1_V1_5_WithErroneousAlgId(final IMessageDigest hash) {
      super();
      this.hash = hash;
      hLen = hash.hashSize();
      ...
      }else if(name.equals(Registry.SHA224_HASH)){
    	  prefix = SHA224_PREFIX;
      ...
      } else if (name.equals(Registry.NONE_HASH)){
    	  prefix = NONE_PREFIX;
      } else {
