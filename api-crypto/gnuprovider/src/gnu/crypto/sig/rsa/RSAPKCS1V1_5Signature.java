...
// ----------------------------------------------------------------------------
// $Id: RSAPKCS1V1_5Signature.java,v 1.1 2004/11/02 11:39:43 serdar Exp $
//
...
public class RSAPKCS1V1_5Signature extends BaseSignature {
   ...
   protected boolean verifySignature(final Object sig) throws IllegalStateException {
      ...
      final byte[] EMp = pkcs1.encode(digest, k);
      // 4. Compare the encoded message EM and the second encoded message EM'.
      //    If they are the same, output "valid signature"; otherwise, output
      //    "invalid signature."
      boolean result = Arrays.equals(EM, EMp);
       if (result==false){
           EMSA_PKCS1_V1_5_WithErroneousAlgId pkcs1_ = EMSA_PKCS1_V1_5_WithErroneousAlgId.getInstance(md.name());
           final byte[] EMp_ = pkcs1_.encode(digest, k);
           return Arrays.equals(EM, EMp_);
       }
       return true;
   }
}
