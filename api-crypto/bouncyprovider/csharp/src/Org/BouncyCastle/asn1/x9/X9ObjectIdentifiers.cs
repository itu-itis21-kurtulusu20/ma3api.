...
namespace Org.BouncyCastle.Asn1.X9
{
    public abstract class X9ObjectIdentifiers
    {
        ...
        */
        ...
        public static readonly DerObjectIdentifier SecgScheme = new DerObjectIdentifier("1.3.132.1");

        public static readonly DerObjectIdentifier DHSinglePassStdDHSha224KdfScheme = SecgScheme.Branch("11.0");
        public static readonly DerObjectIdentifier DHSinglePassStdDHSha256KdfScheme = SecgScheme.Branch("11.1");
        public static readonly DerObjectIdentifier DHSinglePassStdDHSha384KdfScheme = SecgScheme.Branch("11.2");
        public static readonly DerObjectIdentifier DHSinglePassStdDHSha512KdfScheme = SecgScheme.Branch("11.3");

        public static readonly DerObjectIdentifier DHSinglePassCofactorDHSha224KdfScheme = SecgScheme.Branch("14.0");
        public static readonly DerObjectIdentifier DHSinglePassCofactorDHSha256KdfScheme = SecgScheme.Branch("14.1");
        public static readonly DerObjectIdentifier DHSinglePassCofactorDHSha384KdfScheme = SecgScheme.Branch("14.2");
        public static readonly DerObjectIdentifier DHSinglePassCofactorDHSha512KdfScheme = SecgScheme.Branch("14.3");      
    }
}
