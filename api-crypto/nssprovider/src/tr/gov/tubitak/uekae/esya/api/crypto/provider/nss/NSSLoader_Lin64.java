 ...
 * <b>Description</b>: <br/>
 */
class NSSLoader_Lin64 extends NSSLoader {
    private static Logger logger = LoggerFactory.getLogger(NSSLoader_Lin64.class);

    NSSLoader_Lin64(String tempNSSDir, boolean fipsMode) {
    ...
    protected String getLibrary() {
        return "/org/nss/"+NSS_VERSION+"/lin64/lib.zip";
    }
    ...
    private void addExecutePrivilage(String commandPath) throws ESYAException {
        try {
