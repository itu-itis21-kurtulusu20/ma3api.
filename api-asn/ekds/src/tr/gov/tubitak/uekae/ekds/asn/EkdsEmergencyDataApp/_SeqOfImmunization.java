...
public class _SeqOfImmunization extends Asn1Type {
   public Immunization[] elements;

   public _SeqOfImmunization () {
      elements = null;
   }
    ...
    * populated.
    */
   public _SeqOfImmunization (int numRecords) {
      elements = new Immunization [numRecords];
   }
    ...
    * given the array.  
    */
   public _SeqOfImmunization (Immunization[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, IOException
   {
      ...
      java.util.LinkedList<Immunization> llist =
         new java.util.LinkedList<Immunization>();
      ...
      while (!_context.expired()) {
         element = new Immunization();
         element.decode (buffer, true, elemLen);
         llist.add (element);
      }

      elements = new Immunization [llist.size()];
