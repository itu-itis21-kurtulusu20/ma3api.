...
public class PersonalInformationDataObject extends Asn1Type {
   public final static Asn1Tag TAG =
      new Asn1Tag (Asn1Tag.APPL, Asn1Tag.CONS, 6);

   public PIData personelInfoData;
   public DataObjectAttributes dataObjectAttributes;
   public Asn1Integer errDetectionCode;

   public PersonalInformationDataObject () {
      super();
      init();
   }
    ...
    * the given objects 
    */
   public PersonalInformationDataObject (PIData personelInfoData_,
      DataObjectAttributes dataObjectAttributes_,
      ...
      throws Asn1Exception, IOException
   {
      ...
      // decode personelInfoData

      if (_context.matchElemTag (Asn1Tag.CTXT, Asn1Tag.CONS, 0, elemLen, true)) {
         personelInfoData = new PIData();
         personelInfoData.decode (buffer, false, elemLen.value);
      }
      ...
      throws Asn1Exception
   {
      ...
      // encode personelInfoData

      len = personelInfoData.encode (buffer, false);
   ...
   public void print (PrintStream _out, String _varName, int _level)
   {
      ...
      if (personelInfoData != null) personelInfoData.print (_out, "personelInfoData", _level+1);
