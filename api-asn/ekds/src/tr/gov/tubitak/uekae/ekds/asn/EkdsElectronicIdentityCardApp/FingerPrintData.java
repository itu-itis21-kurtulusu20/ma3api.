...
public class FingerPrintData extends Asn1Type {
   public Asn1Boolean fingerPrintExcused;
    ...
    */
   public FingerPrintData (
      Asn1Boolean fingerPrintExcused_,
      HandType hand_,
      FingerType finger_,
      Asn1OctetString imageData_
   ) {
      super();
      fingerPrintExcused = fingerPrintExcused_;
      hand = hand_;
      finger = finger_;
    ...
    * the given objects 
    */
   public FingerPrintData (boolean fingerPrintExcused_,
      HandType hand_,
      FingerType finger_,
      byte[] imageData_
   ) {
      super();
      fingerPrintExcused = new Asn1Boolean (fingerPrintExcused_);
      hand = hand_;
      finger = finger_;
      ...
      throws Asn1Exception, IOException
   {
      ...
      // decode fingerPrintExcused

      if (_context.matchElemTag (Asn1Tag.CTXT, Asn1Tag.PRIM, 0, elemLen, true)) {
         fingerPrintExcused = new Asn1Boolean();
         fingerPrintExcused.decode (buffer, false, elemLen.value);
      }
      ...
      if (_context.matchElemTag (Asn1Tag.CTXT, Asn1Tag.PRIM, 1, elemLen, true)) {
         ...
         if (!((imageData.getLength() >= 0 && imageData.getLength() <= 8192))) {
      ...
      throws Asn1Exception
   {
      ...
      // encode fingerPrintExcused

      len = fingerPrintExcused.encode (buffer, false);
   ...
   public void print (PrintStream _out, String _varName, int _level)
   {
      ...
      if (fingerPrintExcused != null) fingerPrintExcused.print (_out, "fingerPrintExcused", _level+1);
