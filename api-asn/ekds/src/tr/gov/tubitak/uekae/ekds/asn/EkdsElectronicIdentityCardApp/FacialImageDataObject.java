...
public class FacialImageDataObject extends Asn1Type {
   public final static Asn1Tag TAG =
      new Asn1Tag (Asn1Tag.APPL, Asn1Tag.CONS, 5);
    ...
    * the given objects 
    */
   public FacialImageDataObject (FIData facialImageData_,
      DataObjectAttributes dataObjectAttributes_,
      ...
      throws Asn1Exception, IOException
   {
      ...
      // decode facialImageData

      if (_context.matchElemTag (Asn1Tag.CTXT, Asn1Tag.CONS, 0, elemLen, true)) {
         facialImageData = new FIData();
         facialImageData.decode (buffer, false, elemLen.value);
      }
      ...
      throws Asn1Exception
   {
      ...
      // encode facialImageData

      len = facialImageData.encode (buffer, false);
   ...
   public void print (PrintStream _out, String _varName, int _level)
   {
      ...
      if (facialImageData != null) facialImageData.print (_out, "facialImageData", _level+1);
