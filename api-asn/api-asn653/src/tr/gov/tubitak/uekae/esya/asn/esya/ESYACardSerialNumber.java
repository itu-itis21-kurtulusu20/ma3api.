...
public class ESYACardSerialNumber extends Asn1OctetString {
   ...
   public String getAsn1TypeName()  {
      return "ESYACardSerialNumber";
   }

   public ESYACardSerialNumber () {
      super();
   }
    ...
    *              in binary form.
    */
   public ESYACardSerialNumber (byte[] data) {
      super (data);
   }
    ...
    */
   public ESYACardSerialNumber (byte[] data, int offset, int nbytes) {
    ...
    */
   public ESYACardSerialNumber (String value_) throws Asn1ValueParseException {
      super (value_);
   }
