...
public class NameConstraints extends Asn1Seq {
   ...
   public boolean equals( Object obj ) {
      ...
      if ( !(obj instanceof NameConstraints) ) return false;
   ...
   public int hashCode() {
      ...
      if (permittedSubtrees != null) __code = 31*__code + permittedSubtrees.hashCode();
      if (excludedSubtrees != null) __code = 31*__code + excludedSubtrees.hashCode();
   ...
   public Object getElementValue(int index){
      switch(index)  {
         case 0: return permittedSubtrees;
         case 1: return excludedSubtrees;
         default: return null;
      }
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      if (_context.matchElemTag (Asn1Tag.CTXT, Asn1Tag.CONS, 0, elemLen, true)) {
         ...
         permittedSubtrees.decode (buffer, false, elemLen.value);
      ...
      if (_context.matchElemTag (Asn1Tag.CTXT, Asn1Tag.CONS, 1, elemLen, true)) {
         ...
         excludedSubtrees.decode (buffer, false, elemLen.value);
