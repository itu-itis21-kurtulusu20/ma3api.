...
public class CertificatePolicies extends Asn1SeqOf {
    ...
    * populated.
    */
   public CertificatePolicies (int numRecords) {
      elements = new PolicyInformation [numRecords];
   }
    ...
    * given the array.  
    */
   public CertificatePolicies (PolicyInformation[] elements_) {
      elements = elements_;
   }
   ...
   public boolean equals( Object obj ) {
      ...
      if ( !(obj instanceof CertificatePolicies) ) return false;
      CertificatePolicies rhs = (CertificatePolicies) obj;
      PolicyInformation[] rhsElements = rhs.elements;
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      java.util.LinkedList<PolicyInformation> llist =
         new java.util.LinkedList<PolicyInformation>();
      ...
      while (!_context.expired()) {
         element = new PolicyInformation();
         element.decode (buffer, true, elemLen);
         llist.add (element);
      }

      elements = new PolicyInformation [llist.size()];
