...
public class POPODecKeyChallContent extends Asn1SeqOf {
    ...
    * populated.
    */
   public POPODecKeyChallContent (int numRecords) {
      elements = new Challenge [numRecords];
   }
    ...
    * given the array.  
    */
   public POPODecKeyChallContent (Challenge[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      java.util.LinkedList<Challenge> llist =
         new java.util.LinkedList<Challenge>();
      ...
      elements = new Challenge [llist.size()];
