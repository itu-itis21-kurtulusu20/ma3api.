...
public class RevocationInfoChoices extends Asn1SetOf {
   ...
   public RevocationInfoChoice[] elements;
    ...
    * populated.
    */
   public RevocationInfoChoices (int numRecords) {
      elements = new RevocationInfoChoice [numRecords];
   }
    ...
    * given the array.  
    */
   public RevocationInfoChoices (RevocationInfoChoice[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      java.util.LinkedList<RevocationInfoChoice> llist =
         new java.util.LinkedList<RevocationInfoChoice>();
      Asn1BerDecodeContext _context =
          new Asn1BerDecodeContext (buffer, llen);
      RevocationInfoChoice element;
      int elemLen = 0;

      while (!_context.expired()) {
         element = new RevocationInfoChoice();
         element.decode (buffer, true, elemLen);
         llist.add (element);
      }

      elements = new RevocationInfoChoice [llist.size()];
