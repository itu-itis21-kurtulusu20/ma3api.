...
public class ATSHashIndex_crlsHashIndex extends Asn1SeqOf {
   ...
   public ATSHashIndex_crlsHashIndex () {
      elements = null;
   }
    ...
    * populated.
    */
   public ATSHashIndex_crlsHashIndex (int numRecords) {
    ...
    * given the array.  
    */
   public ATSHashIndex_crlsHashIndex (Asn1OctetString[] elements_) {
      elements = elements_;
   }
