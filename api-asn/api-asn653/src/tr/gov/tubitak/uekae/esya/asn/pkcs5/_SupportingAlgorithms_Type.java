...
public class _SupportingAlgorithms_Type extends Asn1OctetString {
   ...
   public _SupportingAlgorithms_Type () {
      super();
   }
    ...
    *              in binary form.
    */
   public _SupportingAlgorithms_Type (byte[] data) {
      super (data);
   }
    ...
    */
   public _SupportingAlgorithms_Type (byte[] data, int offset, int nbytes) {
    ...
    */
   public _SupportingAlgorithms_Type (String value_) throws Asn1ValueParseException {
      super (value_);
   }
