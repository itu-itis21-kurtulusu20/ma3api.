...
public class ATSHashIndex_certificatesHashIndex extends Asn1SeqOf {
   ...
   public ATSHashIndex_certificatesHashIndex () {
      elements = null;
   }
    ...
    * populated.
    */
   public ATSHashIndex_certificatesHashIndex (int numRecords) {
    ...
    * given the array.  
    */
   public ATSHashIndex_certificatesHashIndex (Asn1OctetString[] elements_) {
      elements = elements_;
   }
