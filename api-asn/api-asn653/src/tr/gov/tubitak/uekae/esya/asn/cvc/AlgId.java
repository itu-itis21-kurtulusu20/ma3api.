...
public class AlgId extends Asn1OctetString {
   private static final long serialVersionUID = 55;
   public final static Asn1Tag TAG =
      new Asn1Tag (Asn1Tag.UNIV, Asn1Tag.PRIM, 6);
    ...
    */
   public AlgId (byte[] data, int offset, int nbytes) {
    ...
    */
   public AlgId (String value_) throws Asn1ValueParseException {
      super (value_);
   }
   ...
   {
      int llen = matchTag (buffer, Asn1Tag.UNIV, Asn1Tag.PRIM, 6);
