...
public class BasicOCSPResponse extends Asn1Seq {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      if (_context.matchElemTag (Asn1Tag.UNIV, Asn1Tag.CONS, 16, elemLen, false)) {
         ...
         tbsResponseData.decode (buffer, true, elemLen.value);
      }
      else throw new Asn1MissingRequiredException (buffer, "tbsResponseData");
      ...
      throws Asn1Exception
   {
      ...
      if (tbsResponseData != null) {
         len = tbsResponseData.encode (buffer, true);
         _aal += len;
      }
      else throw new Asn1MissingRequiredException ("tbsResponseData");
