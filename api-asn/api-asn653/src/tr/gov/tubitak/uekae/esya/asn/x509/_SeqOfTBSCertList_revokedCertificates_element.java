...
public class _SeqOfTBSCertList_revokedCertificates_element extends Asn1SeqOf {
   ...
   public TBSCertList_revokedCertificates_element[] elements;

   public _SeqOfTBSCertList_revokedCertificates_element () {
      elements = null;
   }
    ...
    * populated.
    */
   public _SeqOfTBSCertList_revokedCertificates_element (int numRecords) {
      elements = new TBSCertList_revokedCertificates_element [numRecords];
   }
    ...
    * given the array.  
    */
   public _SeqOfTBSCertList_revokedCertificates_element (TBSCertList_revokedCertificates_element[] elements_) {
      elements = elements_;
   }
   ...
   public boolean equals( Object obj ) {
      ...
      if ( !(obj instanceof _SeqOfTBSCertList_revokedCertificates_element) ) return false;
      _SeqOfTBSCertList_revokedCertificates_element rhs = (_SeqOfTBSCertList_revokedCertificates_element) obj;
      TBSCertList_revokedCertificates_element[] rhsElements = rhs.elements;
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      java.util.LinkedList<TBSCertList_revokedCertificates_element> llist =
         new java.util.LinkedList<TBSCertList_revokedCertificates_element>();
      ...
      elements = new TBSCertList_revokedCertificates_element [llist.size()];
