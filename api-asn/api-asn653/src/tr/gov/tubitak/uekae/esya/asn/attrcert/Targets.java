...
public class Targets extends Asn1SeqOf {
    ...
    * populated.
    */
   public Targets (int numRecords) {
      elements = new Target [numRecords];
   }
    ...
    * given the array.  
    */
   public Targets (Target[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      java.util.LinkedList<Target> llist =
         new java.util.LinkedList<Target>();
      ...
      elements = new Target [llist.size()];
