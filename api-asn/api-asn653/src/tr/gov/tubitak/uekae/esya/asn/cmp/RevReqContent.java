...
public class RevReqContent extends Asn1SeqOf {
    ...
    * populated.
    */
   public RevReqContent (int numRecords) {
    ...
    * given the array.  
    */
   public RevReqContent (RevDetails[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      java.util.LinkedList<RevDetails> llist =
         new java.util.LinkedList<RevDetails>();
      ...
      elements = new RevDetails [llist.size()];
