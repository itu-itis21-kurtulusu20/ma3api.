...
public class PreferredSignatureAlgorithms extends Asn1SeqOf {
   ...
   public PreferredSignatureAlgorithm[] elements;
    ...
    * populated.
    */
   public PreferredSignatureAlgorithms (int numRecords) {
      elements = new PreferredSignatureAlgorithm [numRecords];
   }
    ...
    * given the array.  
    */
   public PreferredSignatureAlgorithms (PreferredSignatureAlgorithm[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      java.util.LinkedList<PreferredSignatureAlgorithm> llist =
         new java.util.LinkedList<PreferredSignatureAlgorithm>();
      Asn1BerDecodeContext _context =
          new Asn1BerDecodeContext (buffer, llen);
      PreferredSignatureAlgorithm element;
      int elemLen = 0;

      while (!_context.expired()) {
         element = new PreferredSignatureAlgorithm();
         element.decode (buffer, true, elemLen);
         llist.add (element);
      }

      elements = new PreferredSignatureAlgorithm [llist.size()];
