...
public class AttributeCertificateRefs extends Asn1SeqOf {
    ...
    * populated.
    */
   public AttributeCertificateRefs (int numRecords) {
      elements = new OtherCertID [numRecords];
   }
    ...
    * given the array.  
    */
   public AttributeCertificateRefs (OtherCertID[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      java.util.LinkedList<OtherCertID> llist =
         new java.util.LinkedList<OtherCertID>();
      ...
      while (!_context.expired()) {
         element = new OtherCertID();
         element.decode (buffer, true, elemLen);
         llist.add (element);
      }

      elements = new OtherCertID [llist.size()];
