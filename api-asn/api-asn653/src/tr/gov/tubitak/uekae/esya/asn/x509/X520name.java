...
public class X520name extends Asn1Choice {
   ...
   public X520name (byte choiceId_, Asn1Type element_) {
      super();
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      if (tag.equals (Asn1Tag.UNIV, Asn1Tag.PRIM, 12))
      {
         ...
         if (!((utf8String.getLength() >= 1 && utf8String.getLength() <= 32768))) {
      ...
      else if (tag.equals (Asn1Tag.UNIV, Asn1Tag.PRIM, 19))
      {
         ...
         if (!((printableString.getLength() >= 1 && printableString.getLength()
             <= 32768))) {
      ...
      else if (tag.equals (Asn1Tag.UNIV, Asn1Tag.PRIM, 20))
      {
         ...
         if (!((teletexString.getLength() >= 1 && teletexString.getLength() <= 32768))) {
      ...
      else if (tag.equals (Asn1Tag.UNIV, Asn1Tag.PRIM, 28))
      {
         ...
         if (!((universalString.getLength() >= 1 && universalString.getLength()
             <= 32768))) {
      ...
      else if (tag.equals (Asn1Tag.UNIV, Asn1Tag.PRIM, 30))
      {
         ...
         if (!((bmpString.getLength() >= 1 && bmpString.getLength() <= 32768))) {
