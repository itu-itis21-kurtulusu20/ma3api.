...
public class AuthorityInfoAccessSyntax extends Asn1SeqOf {
    ...
    * populated.
    */
   public AuthorityInfoAccessSyntax (int numRecords) {
    ...
    * given the array.  
    */
   public AuthorityInfoAccessSyntax (AccessDescription[] elements_) {
      elements = elements_;
   }
   ...
   public boolean equals( Object obj ) {
      ...
      if ( !(obj instanceof AuthorityInfoAccessSyntax) ) return false;
      AuthorityInfoAccessSyntax rhs = (AuthorityInfoAccessSyntax) obj;
