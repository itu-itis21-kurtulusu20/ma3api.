...
public class BuiltInDomainDefinedAttributes extends Asn1SeqOf {
    ...
    * populated.
    */
   public BuiltInDomainDefinedAttributes (int numRecords) {
      elements = new BuiltInDomainDefinedAttribute [numRecords];
   }
    ...
    * given the array.  
    */
   public BuiltInDomainDefinedAttributes (BuiltInDomainDefinedAttribute[] elements_) {
      elements = elements_;
   }
   ...
   public boolean equals( Object obj ) {
      ...
      if ( !(obj instanceof BuiltInDomainDefinedAttributes) ) return false;
      BuiltInDomainDefinedAttributes rhs = (BuiltInDomainDefinedAttributes) obj;
      BuiltInDomainDefinedAttribute[] rhsElements = rhs.elements;
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      java.util.LinkedList<BuiltInDomainDefinedAttribute> llist =
         new java.util.LinkedList<BuiltInDomainDefinedAttribute>();
      Asn1BerDecodeContext _context =
          new Asn1BerDecodeContext (buffer, llen);
      BuiltInDomainDefinedAttribute element;
      int elemLen = 0;

      while (!_context.expired()) {
         element = new BuiltInDomainDefinedAttribute();
         element.decode (buffer, true, elemLen);
         llist.add (element);
      }

      elements = new BuiltInDomainDefinedAttribute [llist.size()];
