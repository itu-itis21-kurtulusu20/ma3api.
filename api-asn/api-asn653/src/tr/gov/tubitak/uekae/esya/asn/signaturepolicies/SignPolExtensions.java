...
public class SignPolExtensions extends Asn1SeqOf {
    ...
    * populated.
    */
   public SignPolExtensions (int numRecords) {
      elements = new SignPolExtn [numRecords];
   }
    ...
    * given the array.  
    */
   public SignPolExtensions (SignPolExtn[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      java.util.LinkedList<SignPolExtn> llist =
         new java.util.LinkedList<SignPolExtn>();
      ...
      while (!_context.expired()) {
         element = new SignPolExtn();
         element.decode (buffer, true, elemLen);
         llist.add (element);
      }

      elements = new SignPolExtn [llist.size()];
