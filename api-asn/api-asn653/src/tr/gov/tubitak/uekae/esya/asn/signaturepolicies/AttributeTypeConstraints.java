...
public class AttributeTypeConstraints extends Asn1SeqOf {
    ...
    * populated.
    */
   public AttributeTypeConstraints (int numRecords) {
    ...
    * given the array.  
    */
   public AttributeTypeConstraints (Asn1ObjectIdentifier[] elements_) {
      elements = elements_;
   }
