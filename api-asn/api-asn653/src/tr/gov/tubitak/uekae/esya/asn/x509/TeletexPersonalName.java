...
public class TeletexPersonalName extends Asn1Set {
   ...
   public Asn1T61String given_name;  // optional
   public Asn1T61String initials;  // optional
   public Asn1T61String generation_qualifier;  // optional
    ...
    */
   public TeletexPersonalName (
      Asn1T61String surname_,
      Asn1T61String given_name_,
      Asn1T61String initials_,
      Asn1T61String generation_qualifier_
   ) {
      super();
      surname = surname_;
    ...
    * the given objects 
    */
   public TeletexPersonalName (String surname_,
      String given_name_,
      String initials_,
      String generation_qualifier_
   ) {
      super();
      surname = new Asn1T61String (surname_);
      given_name = new Asn1T61String (given_name_);
      initials = new Asn1T61String (initials_);
      generation_qualifier = new Asn1T61String (generation_qualifier_);
   }
   ...
   public boolean equals( Object obj ) {
      ...
      if ( !(obj instanceof TeletexPersonalName) ) return false;

      TeletexPersonalName rhs = (TeletexPersonalName) obj;
   ...
   public Object getElementValue(int index){
      switch(index)  {
         ...
         case 1: return given_name;
         case 2: return initials;
         case 3: return generation_qualifier;
         default: return null;
      }
   }
   ...
   public String getElementName(int index){
      switch(index)  {
         ...
         case 2: return "initials";
         case 3: return "generation-qualifier";
         default: return null;
      }
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      while (!_context.expired()) {
         ...
         else if (tag.equals (Asn1Tag.CTXT, Asn1Tag.PRIM, 3))
         {
            if (! _context.hasDecoded (tag)) {
               _context.addTag (tag);
               generation_qualifier = new Asn1T61String();
