...
public class RecipientInfos extends Asn1SetOf {
    ...
    * populated.
    */
   public RecipientInfos (int numRecords) {
    ...
    * given the array.  
    */
   public RecipientInfos (RecipientInfo[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      java.util.LinkedList<RecipientInfo> llist =
         new java.util.LinkedList<RecipientInfo>();
      ...
      elements = new RecipientInfo [llist.size()];
