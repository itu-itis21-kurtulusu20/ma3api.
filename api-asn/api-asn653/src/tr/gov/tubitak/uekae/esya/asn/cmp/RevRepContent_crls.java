...
public class RevRepContent_crls extends Asn1SeqOf {
    ...
    * populated.
    */
   public RevRepContent_crls (int numRecords) {
    ...
    * given the array.  
    */
   public RevRepContent_crls (CertificateList[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      java.util.LinkedList<CertificateList> llist =
         new java.util.LinkedList<CertificateList>();
      ...
      elements = new CertificateList [llist.size()];
