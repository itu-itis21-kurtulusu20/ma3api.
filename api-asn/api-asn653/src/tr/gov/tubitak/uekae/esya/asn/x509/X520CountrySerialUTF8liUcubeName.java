...
public class X520CountrySerialUTF8liUcubeName extends Asn1Choice {
   ...
   public String getAsn1TypeName()  {
      return "X520CountrySerialUTF8liUcubeName";
   }
   ...
   public X520CountrySerialUTF8liUcubeName () {
      super();
   }

   public X520CountrySerialUTF8liUcubeName (byte choiceId_, Asn1Type element_) {
      super();
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      if (tag.equals (Asn1Tag.UNIV, Asn1Tag.PRIM, 12))
      {
         ...
         if (!((utf8String.getLength() >= 1 && utf8String.getLength() <= 128))) {
      ...
      else if (tag.equals (Asn1Tag.UNIV, Asn1Tag.PRIM, 19))
      {
         ...
         if (!((printableString.getLength() >= 1 && printableString.getLength() <= 128
            ))) {
      ...
      else if (tag.equals (Asn1Tag.UNIV, Asn1Tag.PRIM, 20))
      {
         ...
         if (!((teletexString.getLength() >= 1 && teletexString.getLength() <= 128))) {
      ...
      else if (tag.equals (Asn1Tag.UNIV, Asn1Tag.PRIM, 28))
      {
         ...
         if (!((universalString.getLength() >= 1 && universalString.getLength() <= 128
            ))) {
      ...
      else if (tag.equals (Asn1Tag.UNIV, Asn1Tag.PRIM, 30))
      {
         ...
         if (!((bmpString.getLength() >= 1 && bmpString.getLength() <= 128))) {
