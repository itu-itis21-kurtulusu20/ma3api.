...
public class KeyRecRepContent_caCerts extends Asn1SeqOf {
    ...
    * populated.
    */
   public KeyRecRepContent_caCerts (int numRecords) {
    ...
    * given the array.  
    */
   public KeyRecRepContent_caCerts (CMPCertificate[] elements_) {
      elements = elements_;
   }
