...
public class PollReqContent extends Asn1SeqOf {
   ...
   public PollReqContent_element[] elements;
    ...
    * populated.
    */
   public PollReqContent (int numRecords) {
      elements = new PollReqContent_element [numRecords];
   }
    ...
    * given the array.  
    */
   public PollReqContent (PollReqContent_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      java.util.LinkedList<PollReqContent_element> llist =
         new java.util.LinkedList<PollReqContent_element>();
      Asn1BerDecodeContext _context =
          new Asn1BerDecodeContext (buffer, llen);
      PollReqContent_element element;
      int elemLen = 0;

      while (!_context.expired()) {
         element = new PollReqContent_element();
         element.decode (buffer, true, elemLen);
         llist.add (element);
      }

      elements = new PollReqContent_element [llist.size()];
