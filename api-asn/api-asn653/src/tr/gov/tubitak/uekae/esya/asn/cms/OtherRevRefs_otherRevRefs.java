...
public class OtherRevRefs_otherRevRefs extends Asn1SeqOf {
   ...
   public OtherRevRefs_otherRevRefs () {
      elements = null;
   }
    ...
    * populated.
    */
   public OtherRevRefs_otherRevRefs (int numRecords) {
    ...
    * given the array.  
    */
   public OtherRevRefs_otherRevRefs (Asn1OpenType[] elements_) {
      elements = elements_;
   }
