...
public class BuiltInStandardAttributes extends Asn1Seq {
   ...
   public Object getElementValue(int index){
      switch(index)  {
         ...
         case 1: return administration_domain_name;
         case 2: return network_address;
         case 3: return terminal_identifier;
         case 4: return private_domain_name;
         case 5: return organization_name;
         case 6: return numeric_user_identifier;
         case 7: return personal_name;
         case 8: return organizational_unit_names;
         default: return null;
      }
   }
   ...
   public String getElementName(int index){
      switch(index)  {
         case 0: return "country-name";
         case 1: return "administration-domain-name";
         case 2: return "network-address";
         case 3: return "terminal-identifier";
         case 4: return "private-domain-name";
         case 5: return "organization-name";
         case 6: return "numeric-user-identifier";
         case 7: return "personal-name";
         case 8: return "organizational-unit-names";
         default: return null;
      }
   }
