...
public class CertificateTrustTrees extends Asn1SeqOf {
   ...
   public CertificateTrustPoint[] elements;
    ...
    * populated.
    */
   public CertificateTrustTrees (int numRecords) {
      elements = new CertificateTrustPoint [numRecords];
   }
    ...
    * given the array.  
    */
   public CertificateTrustTrees (CertificateTrustPoint[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      java.util.LinkedList<CertificateTrustPoint> llist =
         new java.util.LinkedList<CertificateTrustPoint>();
      Asn1BerDecodeContext _context =
          new Asn1BerDecodeContext (buffer, llen);
      CertificateTrustPoint element;
      int elemLen = 0;

      while (!_context.expired()) {
         element = new CertificateTrustPoint();
         element.decode (buffer, true, elemLen);
         llist.add (element);
      }

      elements = new CertificateTrustPoint [llist.size()];
