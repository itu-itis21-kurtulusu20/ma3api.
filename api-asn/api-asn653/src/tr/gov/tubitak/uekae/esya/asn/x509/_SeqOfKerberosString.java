...
public class _SeqOfKerberosString extends Asn1SeqOf {
    ...
    * populated.
    */
   public _SeqOfKerberosString (int numRecords) {
      elements = new Asn1GeneralString [numRecords];
   }
    ...
    * given the array.  
    */
   public _SeqOfKerberosString (Asn1GeneralString[] elements_) {
      elements = elements_;
   }
   ...
   public boolean equals( Object obj ) {
      ...
      if ( !(obj instanceof _SeqOfKerberosString) ) return false;
      _SeqOfKerberosString rhs = (_SeqOfKerberosString) obj;
      Asn1GeneralString[] rhsElements = rhs.elements;
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      java.util.LinkedList<Asn1GeneralString> llist =
         new java.util.LinkedList<Asn1GeneralString>();
      Asn1BerDecodeContext _context =
          new Asn1BerDecodeContext (buffer, llen);
      Asn1GeneralString element;
      int elemLen = 0;

      while (!_context.expired()) {
         element = new Asn1GeneralString();
         element.decode (buffer, true, elemLen);
         llist.add (element);
      }

      elements = new Asn1GeneralString [llist.size()];
