...
public class _SeqOfOcspResponsesID extends Asn1SeqOf {
    ...
    * populated.
    */
   public _SeqOfOcspResponsesID (int numRecords) {
      elements = new OcspResponsesID [numRecords];
   }
    ...
    * given the array.  
    */
   public _SeqOfOcspResponsesID (OcspResponsesID[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      java.util.LinkedList<OcspResponsesID> llist =
         new java.util.LinkedList<OcspResponsesID>();
      Asn1BerDecodeContext _context =
          new Asn1BerDecodeContext (buffer, llen);
      OcspResponsesID element;
      int elemLen = 0;

      while (!_context.expired()) {
         element = new OcspResponsesID();
         element.decode (buffer, true, elemLen);
         llist.add (element);
      }

      elements = new OcspResponsesID [llist.size()];
