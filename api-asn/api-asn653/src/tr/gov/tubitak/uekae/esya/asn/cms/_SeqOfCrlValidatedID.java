...
public class _SeqOfCrlValidatedID extends Asn1SeqOf {
   ...
   public CrlValidatedID[] elements;

   public _SeqOfCrlValidatedID () {
      elements = null;
   }
    ...
    * populated.
    */
   public _SeqOfCrlValidatedID (int numRecords) {
      elements = new CrlValidatedID [numRecords];
   }
    ...
    * given the array.  
    */
   public _SeqOfCrlValidatedID (CrlValidatedID[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      java.util.LinkedList<CrlValidatedID> llist =
         new java.util.LinkedList<CrlValidatedID>();
      Asn1BerDecodeContext _context =
          new Asn1BerDecodeContext (buffer, llen);
      CrlValidatedID element;
      int elemLen = 0;

      while (!_context.expired()) {
         element = new CrlValidatedID();
         element.decode (buffer, true, elemLen);
         llist.add (element);
      }

      elements = new CrlValidatedID [llist.size()];
