...
public class CRLDistributionPoints extends Asn1SeqOf {
    ...
    * populated.
    */
   public CRLDistributionPoints (int numRecords) {
      elements = new DistributionPoint [numRecords];
   }
    ...
    * given the array.  
    */
   public CRLDistributionPoints (DistributionPoint[] elements_) {
      elements = elements_;
   }
   ...
   public boolean equals( Object obj ) {
      ...
      if ( !(obj instanceof CRLDistributionPoints) ) return false;
      CRLDistributionPoints rhs = (CRLDistributionPoints) obj;
      DistributionPoint[] rhsElements = rhs.elements;
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      java.util.LinkedList<DistributionPoint> llist =
         new java.util.LinkedList<DistributionPoint>();
      ...
      while (!_context.expired()) {
         element = new DistributionPoint();
         element.decode (buffer, true, elemLen);
         llist.add (element);
      }

      elements = new DistributionPoint [llist.size()];
