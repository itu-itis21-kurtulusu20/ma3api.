...
public class CompleteCertificateRefs extends Asn1SeqOf {
    ...
    * populated.
    */
   public CompleteCertificateRefs (int numRecords) {
    ...
    * given the array.  
    */
   public CompleteCertificateRefs (OtherCertID[] elements_) {
      elements = elements_;
   }
