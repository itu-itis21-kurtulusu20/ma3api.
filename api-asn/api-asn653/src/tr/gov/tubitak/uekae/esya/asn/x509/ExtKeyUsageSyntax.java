...
public class ExtKeyUsageSyntax extends Asn1SeqOf {
    ...
    * populated.
    */
   public ExtKeyUsageSyntax (int numRecords) {
    ...
    * given the array.  
    */
   public ExtKeyUsageSyntax (Asn1ObjectIdentifier[] elements_) {
      elements = elements_;
   }
   ...
   public boolean equals( Object obj ) {
      ...
      if ( !(obj instanceof ExtKeyUsageSyntax) ) return false;
