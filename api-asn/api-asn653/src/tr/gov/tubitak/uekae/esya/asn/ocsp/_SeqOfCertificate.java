...
public class _SeqOfCertificate extends Asn1SeqOf {
    ...
    * populated.
    */
   public _SeqOfCertificate (int numRecords) {
    ...
    * given the array.  
    */
   public _SeqOfCertificate (Certificate[] elements_) {
      elements = elements_;
   }
