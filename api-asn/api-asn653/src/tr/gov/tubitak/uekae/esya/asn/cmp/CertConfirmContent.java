...
public class CertConfirmContent extends Asn1SeqOf {
    ...
    * populated.
    */
   public CertConfirmContent (int numRecords) {
      elements = new CertStatus [numRecords];
   }
    ...
    * given the array.  
    */
   public CertConfirmContent (CertStatus[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      java.util.LinkedList<CertStatus> llist =
         new java.util.LinkedList<CertStatus>();
      ...
      elements = new CertStatus [llist.size()];
