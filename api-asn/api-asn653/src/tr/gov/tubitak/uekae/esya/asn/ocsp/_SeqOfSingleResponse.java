...
public class _SeqOfSingleResponse extends Asn1SeqOf {
    ...
    * populated.
    */
   public _SeqOfSingleResponse (int numRecords) {
      elements = new SingleResponse [numRecords];
   }
    ...
    * given the array.  
    */
   public _SeqOfSingleResponse (SingleResponse[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      java.util.LinkedList<SingleResponse> llist =
         new java.util.LinkedList<SingleResponse>();
      ...
      while (!_context.expired()) {
         element = new SingleResponse();
         element.decode (buffer, true, elemLen);
         llist.add (element);
      }

      elements = new SingleResponse [llist.size()];
