...
public class CRLResponse_responseBytes extends Asn1SeqOf {
   ...
   public CRLResponse_responseBytes () {
      elements = null;
   }
    ...
    * populated.
    */
   public CRLResponse_responseBytes (int numRecords) {
    ...
    * given the array.  
    */
   public CRLResponse_responseBytes (Asn1OctetString[] elements_) {
      elements = elements_;
   }
