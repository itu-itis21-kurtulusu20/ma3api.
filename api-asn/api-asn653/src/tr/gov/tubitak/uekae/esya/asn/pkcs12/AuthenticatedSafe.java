...
public class AuthenticatedSafe extends Asn1SeqOf {
    ...
    * populated.
    */
   public AuthenticatedSafe (int numRecords) {
      elements = new ContentInfo [numRecords];
   }
    ...
    * given the array.  
    */
   public AuthenticatedSafe (ContentInfo[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      java.util.LinkedList<ContentInfo> llist =
         new java.util.LinkedList<ContentInfo>();
      ...
      while (!_context.expired()) {
         element = new ContentInfo();
         element.decode (buffer, true, elemLen);
         llist.add (element);
      }

      elements = new ContentInfo [llist.size()];
