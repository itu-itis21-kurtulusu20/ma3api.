...
public class CertificateTemplateOID extends Asn1Seq {
   ...
   public Object getElementValue(int index){
      switch(index)  {
         ...
         case 1: return templateMajorVersion;
         case 2: return templateMinorVersion;
         default: return null;
      }
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      if (_context.matchElemTag (Asn1Tag.UNIV, Asn1Tag.PRIM, 2, elemLen, false)) {
         ...
         if (!((templateMajorVersion.value >= 0 && templateMajorVersion.value
             <= 4294967295L))) {
      ...
      if (_context.matchElemTag (Asn1Tag.UNIV, Asn1Tag.PRIM, 2, elemLen, false)) {
         ...
         if (!((templateMinorVersion.value >= 0 && templateMinorVersion.value
             <= 4294967295L))) {
