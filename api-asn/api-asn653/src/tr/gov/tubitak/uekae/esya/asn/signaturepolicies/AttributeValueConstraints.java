...
public class AttributeValueConstraints extends Asn1SeqOf {
    ...
    * populated.
    */
   public AttributeValueConstraints (int numRecords) {
    ...
    * given the array.  
    */
   public AttributeValueConstraints (AttributeTypeAndValue[] elements_) {
      elements = elements_;
   }
