...
public class Cha extends Asn1OctetString {
   private static final long serialVersionUID = 55;
   public final static Asn1Tag TAG =
      new Asn1Tag (Asn1Tag.APPL, Asn1Tag.PRIM, 76);
    ...
    */
   public Cha (byte[] data, int offset, int nbytes) {
    ...
    */
   public Cha (String value_) throws Asn1ValueParseException {
      super (value_);
   }
   ...
   {
      int llen = matchTag (buffer, Asn1Tag.APPL, Asn1Tag.PRIM, 76);
      ...
      throws Asn1Exception
   {
      ...
      len += buffer.encodeTagAndLength (Asn1Tag.APPL, Asn1Tag.PRIM, 76, len);
      return (len);
   }
