...
public class PKIHeader_generalInfo extends Asn1SeqOf {
   private static final long serialVersionUID = 55;
   public final static Asn1Tag TAG =
      new Asn1Tag (Asn1Tag.CTXT, Asn1Tag.CONS, 8);
    ...
    * populated.
    */
   public PKIHeader_generalInfo (int numRecords) {
    ...
    * given the array.  
    */
   public PKIHeader_generalInfo (InfoTypeAndValue[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      java.util.LinkedList<InfoTypeAndValue> llist =
         new java.util.LinkedList<InfoTypeAndValue>();
      ...
      elements = new InfoTypeAndValue [llist.size()];
