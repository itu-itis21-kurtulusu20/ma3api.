...
public class ESYASertifikaIptalTalep_kartSeriNo extends Asn1SeqOf {
   ...
   public ESYASertifikaIptalTalep_kartSeriNo () {
      elements = null;
   }
    ...
    * populated.
    */
   public ESYASertifikaIptalTalep_kartSeriNo (int numRecords) {
    ...
    * given the array.  
    */
   public ESYASertifikaIptalTalep_kartSeriNo (Asn1OctetString[] elements_) {
      elements = elements_;
   }
