...
public class GeneralSubtrees extends Asn1SeqOf {
    ...
    * populated.
    */
   public GeneralSubtrees (int numRecords) {
      elements = new GeneralSubtree [numRecords];
   }
    ...
    * given the array.  
    */
   public GeneralSubtrees (GeneralSubtree[] elements_) {
      elements = elements_;
   }
   ...
   public boolean equals( Object obj ) {
      ...
      if ( !(obj instanceof GeneralSubtrees) ) return false;
      GeneralSubtrees rhs = (GeneralSubtrees) obj;
      GeneralSubtree[] rhsElements = rhs.elements;
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      java.util.LinkedList<GeneralSubtree> llist =
         new java.util.LinkedList<GeneralSubtree>();
      ...
      while (!_context.expired()) {
         element = new GeneralSubtree();
         element.decode (buffer, true, elemLen);
         llist.add (element);
      }

      elements = new GeneralSubtree [llist.size()];
