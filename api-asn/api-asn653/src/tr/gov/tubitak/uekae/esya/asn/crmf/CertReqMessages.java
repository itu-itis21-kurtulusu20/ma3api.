...
public class CertReqMessages extends Asn1SeqOf {
    ...
    * populated.
    */
   public CertReqMessages (int numRecords) {
      elements = new CertReqMsg [numRecords];
   }
    ...
    * given the array.  
    */
   public CertReqMessages (CertReqMsg[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      java.util.LinkedList<CertReqMsg> llist =
         new java.util.LinkedList<CertReqMsg>();
      ...
      while (!_context.expired()) {
         element = new CertReqMsg();
         element.decode (buffer, true, elemLen);
         llist.add (element);
      }

      elements = new CertReqMsg [llist.size()];
