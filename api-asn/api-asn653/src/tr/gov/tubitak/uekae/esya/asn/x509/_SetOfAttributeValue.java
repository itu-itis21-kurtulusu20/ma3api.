...
public class _SetOfAttributeValue extends Asn1SetOf {
    ...
    * populated.
    */
   public _SetOfAttributeValue (int numRecords) {
    ...
    * given the array.  
    */
   public _SetOfAttributeValue (Asn1OpenType[] elements_) {
      elements = elements_;
   }

   public boolean equals( Object obj ) {
      if ( this == obj ) return true;
      if ( !(obj instanceof _SetOfAttributeValue) ) return false;
