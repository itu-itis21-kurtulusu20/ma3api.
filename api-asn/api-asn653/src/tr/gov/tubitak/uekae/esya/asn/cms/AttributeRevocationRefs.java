...
public class AttributeRevocationRefs extends Asn1SeqOf {
    ...
    * populated.
    */
   public AttributeRevocationRefs (int numRecords) {
      elements = new CrlOcspRef [numRecords];
   }
    ...
    * given the array.  
    */
   public AttributeRevocationRefs (CrlOcspRef[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      java.util.LinkedList<CrlOcspRef> llist =
         new java.util.LinkedList<CrlOcspRef>();
      ...
      while (!_context.expired()) {
         element = new CrlOcspRef();
         element.decode (buffer, true, elemLen);
         llist.add (element);
      }

      elements = new CrlOcspRef [llist.size()];
