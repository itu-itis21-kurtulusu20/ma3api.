...
public class _SeqOfBasicOCSPResponse extends Asn1SeqOf {
    ...
    * populated.
    */
   public _SeqOfBasicOCSPResponse (int numRecords) {
    ...
    * given the array.  
    */
   public _SeqOfBasicOCSPResponse (BasicOCSPResponse[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      java.util.LinkedList<BasicOCSPResponse> llist =
         new java.util.LinkedList<BasicOCSPResponse>();
      ...
      elements = new BasicOCSPResponse [llist.size()];
