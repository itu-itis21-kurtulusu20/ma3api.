...
public class DiffieHellmanPublicNumber extends Asn1Integer {
   ...
   public String getAsn1TypeName()  {
      return "DiffieHellmanPublicNumber";
   }

   public DiffieHellmanPublicNumber () {
      super();
   }

   public DiffieHellmanPublicNumber (long value_) {
      super (value_);
   }
