...
public class SignaturePolicyId_sigPolicyQualifiers extends Asn1SeqOf {
    ...
    * populated.
    */
   public SignaturePolicyId_sigPolicyQualifiers (int numRecords) {
      elements = new SigPolicyQualifierInfo [numRecords];
   }
    ...
    * given the array.  
    */
   public SignaturePolicyId_sigPolicyQualifiers (SigPolicyQualifierInfo[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      java.util.LinkedList<SigPolicyQualifierInfo> llist =
         new java.util.LinkedList<SigPolicyQualifierInfo>();
      Asn1BerDecodeContext _context =
          new Asn1BerDecodeContext (buffer, llen);
      SigPolicyQualifierInfo element;
      int elemLen = 0;

      while (!_context.expired()) {
         element = new SigPolicyQualifierInfo();
         element.decode (buffer, true, elemLen);
         llist.add (element);
      }

      elements = new SigPolicyQualifierInfo [llist.size()];
