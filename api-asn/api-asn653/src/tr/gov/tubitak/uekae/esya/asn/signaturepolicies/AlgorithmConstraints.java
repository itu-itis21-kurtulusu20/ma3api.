...
public class AlgorithmConstraints extends Asn1SeqOf {
    ...
    * populated.
    */
   public AlgorithmConstraints (int numRecords) {
      elements = new AlgAndLength [numRecords];
   }
    ...
    * given the array.  
    */
   public AlgorithmConstraints (AlgAndLength[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      java.util.LinkedList<AlgAndLength> llist =
         new java.util.LinkedList<AlgAndLength>();
      Asn1BerDecodeContext _context =
          new Asn1BerDecodeContext (buffer, llen);
      AlgAndLength element;
      int elemLen = 0;

      while (!_context.expired()) {
         element = new AlgAndLength();
         element.decode (buffer, true, elemLen);
         llist.add (element);
      }

      elements = new AlgAndLength [llist.size()];
