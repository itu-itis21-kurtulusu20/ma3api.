...
public class PollRepContent extends Asn1SeqOf {
   ...
   public PollRepContent_element[] elements;
    ...
    * populated.
    */
   public PollRepContent (int numRecords) {
      elements = new PollRepContent_element [numRecords];
   }
    ...
    * given the array.  
    */
   public PollRepContent (PollRepContent_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      java.util.LinkedList<PollRepContent_element> llist =
         new java.util.LinkedList<PollRepContent_element>();
      Asn1BerDecodeContext _context =
          new Asn1BerDecodeContext (buffer, llen);
      PollRepContent_element element;
      int elemLen = 0;

      while (!_context.expired()) {
         element = new PollRepContent_element();
         element.decode (buffer, true, elemLen);
         llist.add (element);
      }

      elements = new PollRepContent_element [llist.size()];
