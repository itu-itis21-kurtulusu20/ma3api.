...
public class BiometricSyntax extends Asn1SeqOf {
   ...
   public BiometricData[] elements;

   public BiometricSyntax () {
      elements = null;
   }
    ...
    * populated.
    */
   public BiometricSyntax (int numRecords) {
      elements = new BiometricData [numRecords];
   }
    ...
    * given the array.  
    */
   public BiometricSyntax (BiometricData[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      java.util.LinkedList<BiometricData> llist =
         new java.util.LinkedList<BiometricData>();
      ...
      while (!_context.expired()) {
         element = new BiometricData();
         element.decode (buffer, true, elemLen);
         llist.add (element);
      }

      elements = new BiometricData [llist.size()];
