...
public class _SeqOfESSCertIDv2 extends Asn1SeqOf {
    ...
    * populated.
    */
   public _SeqOfESSCertIDv2 (int numRecords) {
    ...
    * given the array.  
    */
   public _SeqOfESSCertIDv2 (ESSCertIDv2[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      java.util.LinkedList<ESSCertIDv2> llist =
         new java.util.LinkedList<ESSCertIDv2>();
      ...
      elements = new ESSCertIDv2 [llist.size()];
