...
public class SMIMECapabilities extends Asn1SeqOf {
    ...
    * populated.
    */
   public SMIMECapabilities (int numRecords) {
      elements = new SMIMECapability [numRecords];
   }
    ...
    * given the array.  
    */
   public SMIMECapabilities (SMIMECapability[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      java.util.LinkedList<SMIMECapability> llist =
         new java.util.LinkedList<SMIMECapability>();
      Asn1BerDecodeContext _context =
          new Asn1BerDecodeContext (buffer, llen);
      SMIMECapability element;
      int elemLen = 0;

      while (!_context.expired()) {
         element = new SMIMECapability();
         element.decode (buffer, true, elemLen);
         llist.add (element);
      }

      elements = new SMIMECapability [llist.size()];
