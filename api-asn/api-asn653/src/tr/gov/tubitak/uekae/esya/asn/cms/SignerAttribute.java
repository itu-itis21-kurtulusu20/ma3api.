...
public class SignerAttribute extends Asn1SeqOf {
    ...
    * populated.
    */
   public SignerAttribute (int numRecords) {
      elements = new SignerAttribute_element [numRecords];
   }
    ...
    * given the array.  
    */
   public SignerAttribute (SignerAttribute_element[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      java.util.LinkedList<SignerAttribute_element> llist =
         new java.util.LinkedList<SignerAttribute_element>();
      Asn1BerDecodeContext _context =
          new Asn1BerDecodeContext (buffer, llen);
      SignerAttribute_element element;
      int elemLen = 0;

      while (!_context.expired()) {
         element = new SignerAttribute_element();
         element.decode (buffer, true, elemLen);
         llist.add (element);
      }

      elements = new SignerAttribute_element [llist.size()];
