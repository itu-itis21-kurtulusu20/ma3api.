...
public class _SetOfPKCS12Attribute extends Asn1SetOf {
   ...
   public PKCS12Attribute[] elements;

   public _SetOfPKCS12Attribute () {
      elements = null;
   }
    ...
    * populated.
    */
   public _SetOfPKCS12Attribute (int numRecords) {
      elements = new PKCS12Attribute [numRecords];
   }
    ...
    * given the array.  
    */
   public _SetOfPKCS12Attribute (PKCS12Attribute[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      java.util.LinkedList<PKCS12Attribute> llist =
         new java.util.LinkedList<PKCS12Attribute>();
      Asn1BerDecodeContext _context =
          new Asn1BerDecodeContext (buffer, llen);
      PKCS12Attribute element;
      int elemLen = 0;

      while (!_context.expired()) {
         element = new PKCS12Attribute();
         element.decode (buffer, true, elemLen);
         llist.add (element);
      }

      elements = new PKCS12Attribute [llist.size()];
