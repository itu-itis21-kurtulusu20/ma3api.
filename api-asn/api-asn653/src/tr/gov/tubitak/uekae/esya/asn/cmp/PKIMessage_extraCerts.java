...
public class PKIMessage_extraCerts extends Asn1SeqOf {
    ...
    * populated.
    */
   public PKIMessage_extraCerts (int numRecords) {
    ...
    * given the array.  
    */
   public PKIMessage_extraCerts (CMPCertificate[] elements_) {
      elements = elements_;
   }
