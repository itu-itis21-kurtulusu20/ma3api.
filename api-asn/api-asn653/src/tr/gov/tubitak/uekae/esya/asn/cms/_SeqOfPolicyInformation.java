...
public class _SeqOfPolicyInformation extends Asn1SeqOf {
    ...
    * populated.
    */
   public _SeqOfPolicyInformation (int numRecords) {
    ...
    * given the array.  
    */
   public _SeqOfPolicyInformation (PolicyInformation[] elements_) {
      elements = elements_;
   }
