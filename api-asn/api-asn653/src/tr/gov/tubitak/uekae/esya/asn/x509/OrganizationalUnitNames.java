...
public class OrganizationalUnitNames extends Asn1SeqOf {
    ...
    * populated.
    */
   public OrganizationalUnitNames (int numRecords) {
    ...
    * given the array.  
    */
   public OrganizationalUnitNames (Asn1PrintableString[] elements_) {
      elements = elements_;
   }
   ...
   public boolean equals( Object obj ) {
      ...
      if ( !(obj instanceof OrganizationalUnitNames) ) return false;
      OrganizationalUnitNames rhs = (OrganizationalUnitNames) obj;
