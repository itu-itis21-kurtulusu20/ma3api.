...
public class ProxyInfo extends Asn1SeqOf {
    ...
    * populated.
    */
   public ProxyInfo (int numRecords) {
      elements = new Targets [numRecords];
   }
    ...
    * given the array.  
    */
   public ProxyInfo (Targets[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      java.util.LinkedList<Targets> llist =
         new java.util.LinkedList<Targets>();
      ...
      elements = new Targets [llist.size()];
