...
public class _SupportingAlgorithms_Type_1 extends Asn1OctetString {
   ...
   public _SupportingAlgorithms_Type_1 () {
      super();
   }
    ...
    *              in binary form.
    */
   public _SupportingAlgorithms_Type_1 (byte[] data) {
      super (data);
   }
    ...
    */
   public _SupportingAlgorithms_Type_1 (byte[] data, int offset, int nbytes) {
    ...
    */
   public _SupportingAlgorithms_Type_1 (String value_) throws Asn1ValueParseException {
      super (value_);
   }
