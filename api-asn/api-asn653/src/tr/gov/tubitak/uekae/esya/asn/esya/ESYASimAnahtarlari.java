...
public class ESYASimAnahtarlari extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "ESYASimAnahtarlari";
   }

   public ESYASimAnahtari[] elements;

   public ESYASimAnahtarlari () {
      elements = null;
   }
    ...
    * populated.
    */
   public ESYASimAnahtarlari (int numRecords) {
      elements = new ESYASimAnahtari [numRecords];
   }
    ...
    * given the array.  
    */
   public ESYASimAnahtarlari (ESYASimAnahtari[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      java.util.LinkedList<ESYASimAnahtari> llist =
         new java.util.LinkedList<ESYASimAnahtari>();
      Asn1BerDecodeContext _context =
          new Asn1BerDecodeContext (buffer, llen);
      ESYASimAnahtari element;
      int elemLen = 0;

      while (!_context.expired()) {
         element = new ESYASimAnahtari();
         element.decode (buffer, true, elemLen);
         llist.add (element);
      }

      elements = new ESYASimAnahtari [llist.size()];
