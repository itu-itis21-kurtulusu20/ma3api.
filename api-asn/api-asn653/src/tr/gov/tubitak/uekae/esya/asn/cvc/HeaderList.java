...
public class HeaderList extends Asn1OctetString {
   private static final long serialVersionUID = 55;
   public final static Asn1Tag TAG =
      new Asn1Tag (Asn1Tag.APPL, Asn1Tag.PRIM, 13);
    ...
    */
   public HeaderList (String value_) throws Asn1ValueParseException {
      super (value_);
   }
   ...
   {
      int llen = matchTag (buffer, Asn1Tag.APPL, Asn1Tag.PRIM, 13);
