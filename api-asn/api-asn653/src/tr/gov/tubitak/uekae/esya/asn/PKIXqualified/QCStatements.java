...
public class QCStatements extends Asn1SeqOf {
    ...
    * populated.
    */
   public QCStatements (int numRecords) {
      elements = new QCStatement [numRecords];
   }
    ...
    * given the array.  
    */
   public QCStatements (QCStatement[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      java.util.LinkedList<QCStatement> llist =
         new java.util.LinkedList<QCStatement>();
      ...
      while (!_context.expired()) {
         element = new QCStatement();
         element.decode (buffer, true, elemLen);
         llist.add (element);
      }

      elements = new QCStatement [llist.size()];
