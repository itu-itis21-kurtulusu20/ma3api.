...
public class PolicyInformation_policyQualifiers extends Asn1SeqOf {
    ...
    * populated.
    */
   public PolicyInformation_policyQualifiers (int numRecords) {
      elements = new PolicyQualifierInfo [numRecords];
   }
    ...
    * given the array.  
    */
   public PolicyInformation_policyQualifiers (PolicyQualifierInfo[] elements_) {
      elements = elements_;
   }
   ...
   public boolean equals( Object obj ) {
      ...
      if ( !(obj instanceof PolicyInformation_policyQualifiers) ) return false;
      PolicyInformation_policyQualifiers rhs = (PolicyInformation_policyQualifiers) obj;
      PolicyQualifierInfo[] rhsElements = rhs.elements;
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      java.util.LinkedList<PolicyQualifierInfo> llist =
         new java.util.LinkedList<PolicyQualifierInfo>();
      Asn1BerDecodeContext _context =
          new Asn1BerDecodeContext (buffer, llen);
      PolicyQualifierInfo element;
      int elemLen = 0;

      while (!_context.expired()) {
         element = new PolicyQualifierInfo();
         element.decode (buffer, true, elemLen);
         llist.add (element);
      }

      elements = new PolicyQualifierInfo [llist.size()];
