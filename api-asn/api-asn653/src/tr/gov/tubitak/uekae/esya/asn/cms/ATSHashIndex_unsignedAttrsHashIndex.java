...
public class ATSHashIndex_unsignedAttrsHashIndex extends Asn1SeqOf {
   ...
   public ATSHashIndex_unsignedAttrsHashIndex () {
      elements = null;
   }
    ...
    * populated.
    */
   public ATSHashIndex_unsignedAttrsHashIndex (int numRecords) {
    ...
    * given the array.  
    */
   public ATSHashIndex_unsignedAttrsHashIndex (Asn1OctetString[] elements_) {
      elements = elements_;
   }
