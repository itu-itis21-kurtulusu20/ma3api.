...
public class SuppLangTagsValue extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "SuppLangTagsValue";
   }

   public Asn1UTF8String[] elements;

   public SuppLangTagsValue () {
      elements = null;
   }
    ...
    * populated.
    */
   public SuppLangTagsValue (int numRecords) {
      elements = new Asn1UTF8String [numRecords];
   }
    ...
    * given the array.  
    */
   public SuppLangTagsValue (Asn1UTF8String[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      java.util.LinkedList<Asn1UTF8String> llist =
         new java.util.LinkedList<Asn1UTF8String>();
      Asn1BerDecodeContext _context =
          new Asn1BerDecodeContext (buffer, llen);
      Asn1UTF8String element;
      int elemLen = 0;

      while (!_context.expired()) {
         element = new Asn1UTF8String();
         element.decode (buffer, true, elemLen);
         llist.add (element);
      }

      elements = new Asn1UTF8String [llist.size()];
