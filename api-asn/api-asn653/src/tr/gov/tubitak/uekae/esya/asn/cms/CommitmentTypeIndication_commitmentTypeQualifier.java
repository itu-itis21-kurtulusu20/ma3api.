...
public class CommitmentTypeIndication_commitmentTypeQualifier extends Asn1SeqOf {
    ...
    * populated.
    */
   public CommitmentTypeIndication_commitmentTypeQualifier (int numRecords) {
    ...
    * given the array.  
    */
   public CommitmentTypeIndication_commitmentTypeQualifier (CommitmentTypeQualifier[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      java.util.LinkedList<CommitmentTypeQualifier> llist =
         new java.util.LinkedList<CommitmentTypeQualifier>();
      ...
      elements = new CommitmentTypeQualifier [llist.size()];
