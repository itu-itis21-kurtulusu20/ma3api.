...
public class ESYAKartAnahtarlari extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "ESYAKartAnahtarlari";
   }

   public ESYAKartAnahtar[] elements;

   public ESYAKartAnahtarlari () {
      elements = null;
   }
    ...
    * populated.
    */
   public ESYAKartAnahtarlari (int numRecords) {
      elements = new ESYAKartAnahtar [numRecords];
   }
    ...
    * given the array.  
    */
   public ESYAKartAnahtarlari (ESYAKartAnahtar[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      java.util.LinkedList<ESYAKartAnahtar> llist =
         new java.util.LinkedList<ESYAKartAnahtar>();
      Asn1BerDecodeContext _context =
          new Asn1BerDecodeContext (buffer, llen);
      ESYAKartAnahtar element;
      int elemLen = 0;

      while (!_context.expired()) {
         element = new ESYAKartAnahtar();
         element.decode (buffer, true, elemLen);
         llist.add (element);
      }

      elements = new ESYAKartAnahtar [llist.size()];
