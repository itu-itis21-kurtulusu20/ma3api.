...
public class ESYAParametreleri extends Asn1SeqOf {
   ...
   public String getAsn1TypeName()  {
      return "ESYAParametreleri";
   }

   public ESYAParametre[] elements;

   public ESYAParametreleri () {
      elements = null;
   }
    ...
    * populated.
    */
   public ESYAParametreleri (int numRecords) {
      elements = new ESYAParametre [numRecords];
   }
    ...
    * given the array.  
    */
   public ESYAParametreleri (ESYAParametre[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      java.util.LinkedList<ESYAParametre> llist =
         new java.util.LinkedList<ESYAParametre>();
      Asn1BerDecodeContext _context =
          new Asn1BerDecodeContext (buffer, llen);
      ESYAParametre element;
      int elemLen = 0;

      while (!_context.expired()) {
         element = new ESYAParametre();
         element.decode (buffer, true, elemLen);
         llist.add (element);
      }

      elements = new ESYAParametre [llist.size()];
