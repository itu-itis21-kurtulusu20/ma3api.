...
public class RecipientEncryptedKeys extends Asn1SeqOf {
    ...
    * populated.
    */
   public RecipientEncryptedKeys (int numRecords) {
    ...
    * given the array.  
    */
   public RecipientEncryptedKeys (RecipientEncryptedKey[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      java.util.LinkedList<RecipientEncryptedKey> llist =
         new java.util.LinkedList<RecipientEncryptedKey>();
      ...
      elements = new RecipientEncryptedKey [llist.size()];
