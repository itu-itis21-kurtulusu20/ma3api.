...
public class TeletexDomainDefinedAttributes extends Asn1SeqOf {
    ...
    * populated.
    */
   public TeletexDomainDefinedAttributes (int numRecords) {
      elements = new TeletexDomainDefinedAttribute [numRecords];
   }
    ...
    * given the array.  
    */
   public TeletexDomainDefinedAttributes (TeletexDomainDefinedAttribute[] elements_) {
      elements = elements_;
   }
   ...
   public boolean equals( Object obj ) {
      ...
      if ( !(obj instanceof TeletexDomainDefinedAttributes) ) return false;
      TeletexDomainDefinedAttributes rhs = (TeletexDomainDefinedAttributes) obj;
      TeletexDomainDefinedAttribute[] rhsElements = rhs.elements;
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      java.util.LinkedList<TeletexDomainDefinedAttribute> llist =
         new java.util.LinkedList<TeletexDomainDefinedAttribute>();
      Asn1BerDecodeContext _context =
          new Asn1BerDecodeContext (buffer, llen);
      TeletexDomainDefinedAttribute element;
      int elemLen = 0;

      while (!_context.expired()) {
         element = new TeletexDomainDefinedAttribute();
         element.decode (buffer, true, elemLen);
         llist.add (element);
      }

      elements = new TeletexDomainDefinedAttribute [llist.size()];
