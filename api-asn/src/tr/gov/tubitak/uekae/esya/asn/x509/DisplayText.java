...
public class DisplayText extends Asn1Choice {
   ...
   public final static byte _IA5STRING = 2;
   public final static byte _VISIBLESTRING = 3;
   public final static byte _BMPSTRING = 4;
   ...
   public String getElemName () {
      ...
      case _IA5STRING: return "ia5String";
   ...
   public void set_ia5String (Asn1IA5String value) {
      setElement (_IA5STRING, value);
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      else if (tag.equals (Asn1Tag.UNIV, Asn1Tag.PRIM, 22))
      {
         ...
         ia5String.decode (buffer, true, len);
         if (!((ia5String.getLength() >= 1 && ia5String.getLength() <= 200))) {
            throw new Asn1ConsVioException ("ia5String.getLength()", ia5String.getLength());
         }

         setElement (_IA5STRING, ia5String);
      }
      ...
      throws Asn1Exception
   {
      ...
      // encode ia5String
      case _IA5STRING:
         Asn1IA5String ia5String = (Asn1IA5String) getElement();
         if (!((ia5String.getLength() >= 1 && ia5String.getLength() <= 200))) {
            throw new Asn1ConsVioException ("ia5String.getLength()", ia5String.getLength());
         }

         len = ia5String.encode (buffer, true);
         _aal += len;
         break;
