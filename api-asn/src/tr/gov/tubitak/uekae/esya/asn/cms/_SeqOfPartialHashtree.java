...
public class _SeqOfPartialHashtree extends Asn1Type {
   private static final long serialVersionUID = 55;
   static {
      setKey (_etsi101733Rtkey._rtkey);
   }

   public PartialHashtree[] elements;

   public _SeqOfPartialHashtree () {
      elements = null;
   }
    ...
    * populated.
    */
   public _SeqOfPartialHashtree (int numRecords) {
      elements = new PartialHashtree [numRecords];
   }
    ...
    * given the array.  
    */
   public _SeqOfPartialHashtree (PartialHashtree[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      java.util.LinkedList<PartialHashtree> llist =
         new java.util.LinkedList<PartialHashtree>();
      Asn1BerDecodeContext _context =
          new Asn1BerDecodeContext (buffer, llen);
      PartialHashtree element;
      int elemLen = 0;

      while (!_context.expired()) {
         element = new PartialHashtree();
         element.decode (buffer, true, elemLen);
         llist.add (element);
      }

      elements = new PartialHashtree [llist.size()];
