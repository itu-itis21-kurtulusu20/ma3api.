...
public class SCObjectBag extends Asn1Type {
   private static final long serialVersionUID = 55;
   static {
   }

   public SCObject[] elements;
    ...
    * populated.
    */
   public SCObjectBag (int numRecords) {
      elements = new SCObject [numRecords];
   }
    ...
    * given the array.  
    */
   public SCObjectBag (SCObject[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      java.util.LinkedList<SCObject> llist =
         new java.util.LinkedList<SCObject>();
      ...
      while (!_context.expired()) {
         element = new SCObject();
         element.decode (buffer, true, elemLen);
         llist.add (element);
      }

      elements = new SCObject [llist.size()];
