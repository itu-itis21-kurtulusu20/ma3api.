...
public class ArchiveTimeStampChain extends Asn1Type {
   private static final long serialVersionUID = 55;
   static {
      setKey (_etsi101733Rtkey._rtkey);
   }

   public ArchiveTimeStamp[] elements;
    ...
    * populated.
    */
   public ArchiveTimeStampChain (int numRecords) {
      elements = new ArchiveTimeStamp [numRecords];
   }
    ...
    * given the array.  
    */
   public ArchiveTimeStampChain (ArchiveTimeStamp[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      java.util.LinkedList<ArchiveTimeStamp> llist =
         new java.util.LinkedList<ArchiveTimeStamp>();
      ...
      while (!_context.expired()) {
         element = new ArchiveTimeStamp();
         element.decode (buffer, true, elemLen);
         llist.add (element);
      }

      elements = new ArchiveTimeStamp [llist.size()];
