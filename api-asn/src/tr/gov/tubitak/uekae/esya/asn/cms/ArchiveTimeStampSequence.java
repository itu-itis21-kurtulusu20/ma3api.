...
public class ArchiveTimeStampSequence extends Asn1Type {
   private static final long serialVersionUID = 55;
   static {
      setKey (_etsi101733Rtkey._rtkey);
   }

   public ArchiveTimeStampChain[] elements;
    ...
    * populated.
    */
   public ArchiveTimeStampSequence (int numRecords) {
      elements = new ArchiveTimeStampChain [numRecords];
   }
    ...
    * given the array.  
    */
   public ArchiveTimeStampSequence (ArchiveTimeStampChain[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      java.util.LinkedList<ArchiveTimeStampChain> llist =
         new java.util.LinkedList<ArchiveTimeStampChain>();
      ...
      while (!_context.expired()) {
         element = new ArchiveTimeStampChain();
         element.decode (buffer, true, elemLen);
         llist.add (element);
      }

      elements = new ArchiveTimeStampChain [llist.size()];
