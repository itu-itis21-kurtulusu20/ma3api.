...
public class SignerInfos extends Asn1Type {
    ...
    * populated.
    */
   public SignerInfos (int numRecords) {
      elements = new SignerInfo [numRecords];
   }
    ...
    * given the array.  
    */
   public SignerInfos (SignerInfo[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      java.util.LinkedList<SignerInfo> llist =
         new java.util.LinkedList<SignerInfo>();
      ...
      elements = new SignerInfo [llist.size()];
