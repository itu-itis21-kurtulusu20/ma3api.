...
public class NoticeReference extends Asn1Type {
   ...
   public boolean equals( Object obj ) {
      ...
      if ( !(obj instanceof NoticeReference) ) return false;
   ...
   public int hashCode() {
      ...
      if (organization != null) __code = 31*__code + organization.hashCode();
      if (noticeNumbers != null) __code = 31*__code + noticeNumbers.hashCode();
