...
public class CertificateChoices extends Asn1Choice {
   ...
   public final static byte _V1ATTRCERT = 3;
   public final static byte _V2ATTRCERT = 4;
   public final static byte _OTHER = 5;

   public CertificateChoices () {
      super();
   }

   public CertificateChoices (byte choiceId_, Asn1Type element_) {
      super();
   ...
   public void set_v1AttrCert (AttributeCertificateV1 value) {
      ...
      throws Asn1Exception
   {
      ...
      // encode v1AttrCert
      case _V1ATTRCERT:
    	  AttributeCertificateV1 v1AttrCert = (AttributeCertificateV1) getElement();
