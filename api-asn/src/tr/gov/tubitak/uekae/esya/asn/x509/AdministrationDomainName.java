...
public class AdministrationDomainName extends Asn1Choice {
   ...
   public final static Asn1Tag TAG =
      new Asn1Tag (Asn1Tag.APPL, Asn1Tag.CONS, 2);
   ...
   public AdministrationDomainName (byte choiceId_, Asn1Type element_) {
      super();
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      if (tag.equals (Asn1Tag.UNIV, Asn1Tag.PRIM, 18))
      {
         ...
         if (!((numeric.getLength() >= 0 && numeric.getLength() <= 16))) {
      ...
      else if (tag.equals (Asn1Tag.UNIV, Asn1Tag.PRIM, 19))
      {
         ...
         if (!((printable.getLength() >= 0 && printable.getLength() <= 16))) {
