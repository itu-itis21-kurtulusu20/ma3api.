...
public class FieldID extends Asn1Type {
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      if (_context.matchElemTag (Asn1Tag.UNIV, Asn1Tag.PRIM, 6, elemLen, false)) {
         ...
         fieldType.decode (buffer, true, elemLen.value);
      }
      else throw new Asn1MissingRequiredException (buffer, "fieldType");
      ...
      throws Asn1Exception
   {
      ...
      else throw new Asn1MissingRequiredException ("fieldType");
