...
public class PassportCVCerticate extends Asn1Type {
   ...
   public PassportCVCertificateBody certificateBody;
   public Asn1OctetString signature;

   public PassportCVCerticate () {
      super();
      init();
   }
    ...
    */
   public PassportCVCerticate (
           PassportCVCertificateBody certificateBody_,
           Asn1OctetString signature_
   ) {
      super();
      certificateBody = certificateBody_;
    ...
    * the given objects
    */
   public PassportCVCerticate (PassportCVCertificateBody certificateBody_,
                               byte[] signature_
   ) {
      super();
      certificateBody = certificateBody_;
           ...
           throws Asn1Exception, java.io.IOException
   {
      ...
      if (_context.matchElemTag (Asn1Tag.APPL, Asn1Tag.CONS, 78, elemLen, false)) {
         certificateBody = new PassportCVCertificateBody();
         certificateBody.decode (buffer, true, elemLen.value);
      }
      else throw new Asn1MissingRequiredException (buffer, "certificateBody");
           ...
           throws Asn1Exception
   {
      ...
      if (certificateBody != null) {
         len = certificateBody.encode (buffer, true);
         _aal += len;
      }
      else throw new Asn1MissingRequiredException ("certificateBody");
   ...
   public void print (java.io.PrintStream _out, String _varName, int _level)
   {
      ...
      if (certificateBody != null) certificateBody.print (_out, "certificateBody", _level+1);
