...
public class _SeqOfAlgorithmIdentifier extends Asn1Type {
   ...
   public _SeqOfAlgorithmIdentifier () {
      elements = null;
   }
    ...
    * populated.
    */
   public _SeqOfAlgorithmIdentifier (int numRecords) {
    ...
    * given the array.  
    */
   public _SeqOfAlgorithmIdentifier (AlgorithmIdentifier[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      java.util.LinkedList<AlgorithmIdentifier> llist =
         new java.util.LinkedList<AlgorithmIdentifier>();
      ...
      elements = new AlgorithmIdentifier [llist.size()];
