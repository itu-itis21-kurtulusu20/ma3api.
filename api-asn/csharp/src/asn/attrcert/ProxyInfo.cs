...
namespace tr.gov.tubitak.uekae.esya.asn.attrcert {
   ...
   public class ProxyInfo : Asn1Type {
      ...
      /// populated.
      /// </summary>
      public ProxyInfo (int numRecords) : base()
      {
      ...
      /// given the array.  
      /// </summary>
      public ProxyInfo (Targets[] elements_) : base()
      {
         elements = elements_;
      }
         ...
         (Asn1BerDecodeBuffer buffer, bool explicitTagging, int implicitLength)
      {
         ...
         elements = new Targets [llist.Count];
