...
namespace tr.gov.tubitak.uekae.esya.asn.ocsp {
   ...
   public class AcceptableResponses : Asn1Type {
      public Asn1ObjectIdentifier[] elements;

      static AcceptableResponses ()
      {
         Asn1Type.SetKey2 (_ocspValues._rtkey);
      }

      public AcceptableResponses () : base()
      {
         elements = null;
      }
      ...
      /// populated.
      /// </summary>
      public AcceptableResponses (int numRecords) : base()
      {
      ...
      /// given the array.  
      /// </summary>
      public AcceptableResponses (Asn1ObjectIdentifier[] elements_) : base()
      {
         elements = elements_;
      }
