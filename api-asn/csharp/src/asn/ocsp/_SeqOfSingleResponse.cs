...
namespace tr.gov.tubitak.uekae.esya.asn.ocsp {
   ...
   public class _SeqOfSingleResponse : Asn1Type {
      public SingleResponse[] elements;

      static _SeqOfSingleResponse ()
      {
         Asn1Type.SetKey2 (_ocspValues._rtkey);
      }

      public _SeqOfSingleResponse () : base()
      {
         elements = null;
      }
      ...
      /// populated.
      /// </summary>
      public _SeqOfSingleResponse (int numRecords) : base()
      {
      ...
      /// given the array.  
      /// </summary>
      public _SeqOfSingleResponse (SingleResponse[] elements_) : base()
      {
         elements = elements_;
      }
         ...
         (Asn1BerDecodeBuffer buffer, bool explicitTagging, int implicitLength)
      {
         ...
         elements = new SingleResponse [llist.Count];
