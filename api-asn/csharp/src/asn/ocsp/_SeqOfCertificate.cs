...
namespace tr.gov.tubitak.uekae.esya.asn.ocsp {
   ...
   public class _SeqOfCertificate : Asn1Type {
      public Certificate[] elements;

      static _SeqOfCertificate ()
      {
         Asn1Type.SetKey2 (_ocspValues._rtkey);
      }

      public _SeqOfCertificate () : base()
      {
         elements = null;
      }
      ...
      /// populated.
      /// </summary>
      public _SeqOfCertificate (int numRecords) : base()
      {
      ...
      /// given the array.  
      /// </summary>
      public _SeqOfCertificate (Certificate[] elements_) : base()
      {
         elements = elements_;
      }
         ...
         (Asn1BerDecodeBuffer buffer, bool explicitTagging, int implicitLength)
      {
         ...
         elements = new Certificate [llist.Count];
