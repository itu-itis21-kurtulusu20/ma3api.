...
namespace tr.gov.tubitak.uekae.esya.asn.ocsp {
   ...
   public class PreferredSignatureAlgorithms : Asn1Type {
      public PreferredSignatureAlgorithm[] elements;

      static PreferredSignatureAlgorithms ()
      {
         Asn1Type.SetKey2 (_ocspValues._rtkey);
      }

      public PreferredSignatureAlgorithms () : base()
      {
         elements = null;
      }
      ...
      /// populated.
      /// </summary>
      public PreferredSignatureAlgorithms (int numRecords) : base()
      {
      ...
      /// given the array.  
      /// </summary>
      public PreferredSignatureAlgorithms (PreferredSignatureAlgorithm[] elements_) : base()
      {
         elements = elements_;
      }
         ...
         (Asn1BerDecodeBuffer buffer, bool explicitTagging, int implicitLength)
      {
         ...
         elements = new PreferredSignatureAlgorithm [llist.Count];
