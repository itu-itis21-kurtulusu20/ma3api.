...
namespace tr.gov.tubitak.uekae.esya.asn.ocsp {
   ...
   public class _SeqOfRequest : Asn1Type {
      public Request[] elements;

      static _SeqOfRequest ()
      {
         Asn1Type.SetKey2 (_ocspValues._rtkey);
      }

      public _SeqOfRequest () : base()
      {
         elements = null;
      }
      ...
      /// populated.
      /// </summary>
      public _SeqOfRequest (int numRecords) : base()
      {
      ...
      /// given the array.  
      /// </summary>
      public _SeqOfRequest (Request[] elements_) : base()
      {
         elements = elements_;
      }
         ...
         (Asn1BerDecodeBuffer buffer, bool explicitTagging, int implicitLength)
      {
         ...
         elements = new Request [llist.Count];
