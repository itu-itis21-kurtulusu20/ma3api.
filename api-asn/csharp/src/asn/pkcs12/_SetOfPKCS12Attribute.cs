...
namespace tr.gov.tubitak.uekae.esya.asn.pkcs12 {
   ...
   public class _SetOfPKCS12Attribute : Asn1Type {
      public PKCS12Attribute[] elements;

      static _SetOfPKCS12Attribute ()
      {
         Asn1Type.SetKey2 (_pkcs12Values._rtkey);
      }

      public _SetOfPKCS12Attribute () : base()
      {
         elements = null;
      }
      ...
      /// populated.
      /// </summary>
      public _SetOfPKCS12Attribute (int numRecords) : base()
      {
      ...
      /// given the array.  
      /// </summary>
      public _SetOfPKCS12Attribute (PKCS12Attribute[] elements_) : base()
      {
         elements = elements_;
      }
         ...
         (Asn1BerDecodeBuffer buffer, bool explicitTagging, int implicitLength)
      {
         ...
         elements = new PKCS12Attribute [llist.Count];
