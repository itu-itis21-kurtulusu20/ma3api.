...
namespace tr.gov.tubitak.uekae.esya.asn.pkcs12 {
   ...
   public class AuthenticatedSafe : Asn1Type {
      ...
      /// populated.
      /// </summary>
      public AuthenticatedSafe (int numRecords) : base()
      {
      ...
      /// given the array.  
      /// </summary>
      public AuthenticatedSafe (ContentInfo[] elements_) : base()
      {
         elements = elements_;
      }
         ...
         (Asn1BerDecodeBuffer buffer, bool explicitTagging, int implicitLength)
      {
         ...
         elements = new ContentInfo [llist.Count];
