...
namespace tr.gov.tubitak.uekae.esya.asn.algorithms {
   ...
   public class KEA_Parms_Id : Asn1OctetString {
      static KEA_Parms_Id ()
      {
         Asn1Type.SetKey2 (_algorithmsValues._rtkey);
      }

      public KEA_Parms_Id () : base()
      {
      }
      ...
      public KEA_Parms_Id (byte[] data) : base (data)
      {
      }
      ...
      public KEA_Parms_Id (byte[] data, int offset, int nbytes) :
      ...
      public KEA_Parms_Id (string value_) : base (value_)
      {
      }
