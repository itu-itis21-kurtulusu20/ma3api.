...
namespace tr.gov.tubitak.uekae.esya.asn.x509 {
   ...
   public class DisplayText : Asn1Choice {
      ...
      public const byte _IA5STRING = 2;
      public const byte _VISIBLESTRING = 3;
      public const byte _BMPSTRING = 4;
         ...
         (Asn1BerDecodeBuffer buffer, bool explicitTagging, int implicitLength)
      {
         ...
         else if (tag.Equals (Asn1Tag.UNIV, Asn1Tag.PRIM, 22))
         {
            ...
            if (!((ia5String.Length >= 1 && ia5String.Length <= 200))) {
               throw new Asn1ConsVioException ("ia5String.Length", ia5String.Length);
            }
