...
namespace tr.gov.tubitak.uekae.esya.asn.x509 {
   ...
   public class PolicyInformation_policyQualifiers : Asn1Type {
      public PolicyQualifierInfo[] elements;

      static PolicyInformation_policyQualifiers ()
      {
         Asn1Type.SetKey2 (_ImplicitValues._rtkey);
      }

      public PolicyInformation_policyQualifiers () : base()
      {
         elements = null;
      }
      ...
      /// populated.
      /// </summary>
      public PolicyInformation_policyQualifiers (int numRecords) : base()
      {
      ...
      /// given the array.  
      /// </summary>
      public PolicyInformation_policyQualifiers (PolicyQualifierInfo[] elements_) : base()
      {
         elements = elements_;
      }
      ...
      public override bool Equals( Object obj ) {
         ...
         if ( !(obj is PolicyInformation_policyQualifiers) ) return false;
         ...
         (Asn1BerDecodeBuffer buffer, bool explicitTagging, int implicitLength)
      {
         ...
         elements = new PolicyQualifierInfo [llist.Count];
