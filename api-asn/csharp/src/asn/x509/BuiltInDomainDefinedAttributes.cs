...
namespace tr.gov.tubitak.uekae.esya.asn.x509 {
   ...
   public class BuiltInDomainDefinedAttributes : Asn1Type {
      public BuiltInDomainDefinedAttribute[] elements;

      static BuiltInDomainDefinedAttributes ()
      {
         Asn1Type.SetKey2 (_ExplicitValues._rtkey);
      }

      public BuiltInDomainDefinedAttributes () : base()
      {
         elements = null;
      }
      ...
      /// populated.
      /// </summary>
      public BuiltInDomainDefinedAttributes (int numRecords) : base()
      {
      ...
      /// given the array.  
      /// </summary>
      public BuiltInDomainDefinedAttributes (BuiltInDomainDefinedAttribute[] elements_) : base()
      {
         elements = elements_;
      }
      ...
      public override bool Equals( Object obj ) {
         ...
         if ( !(obj is BuiltInDomainDefinedAttributes) ) return false;
         ...
         (Asn1BerDecodeBuffer buffer, bool explicitTagging, int implicitLength)
      {
         ...
         elements = new BuiltInDomainDefinedAttribute [llist.Count];
