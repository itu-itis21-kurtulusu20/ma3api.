...
namespace tr.gov.tubitak.uekae.esya.asn.x509 {
   ...
   public class ReasonFlags : Asn1BitString {
      public static readonly int unused = 0;
      public static readonly int keyCompromise = 1;
      public static readonly int cACompromise = 2;
      public static readonly int affiliationChanged = 3;
      public static readonly int superseded = 4;
      public static readonly int cessationOfOperation = 5;
      public static readonly int certificateHold = 6;
      public static readonly int privilegeWithdrawn = 7;
      public static readonly int aACompromise = 8;
      ...
      public ReasonFlags (bool[] bitValues) :
         base (bitValues)
      {
         trimZeroBits = true;
         Asn1Type.SetKey2 (_ImplicitValues._rtkey);
      ...
      public ReasonFlags (string value_) :
         base (value_)
      {
         trimZeroBits = true;
         Asn1Type.SetKey2 (_ImplicitValues._rtkey);
      ...
      public ReasonFlags (System.Collections.BitArray bitArray) :
         base (bitArray)
      {
         trimZeroBits = true;
         Asn1Type.SetKey2 (_ImplicitValues._rtkey);
