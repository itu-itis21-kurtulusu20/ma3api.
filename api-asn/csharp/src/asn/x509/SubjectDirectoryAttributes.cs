...
namespace tr.gov.tubitak.uekae.esya.asn.x509 {
  ...
  // using Attribute = tr.gov.tubitak.uekae.esya.asn.x509.Attribute;
   ...
   public class SubjectDirectoryAttributes : Asn1Type {
      ...
      public SubjectDirectoryAttributes () : base()
      {
         elements = null;
      }
      ...
      /// populated.
      /// </summary>
      public SubjectDirectoryAttributes (int numRecords) : base()
      {
      ...
      /// given the array.  
      /// </summary>
      public SubjectDirectoryAttributes (Attribute[] elements_) : base()
      {
         elements = elements_;
      }
      ...
      public override bool Equals( Object obj ) {
         ...
         if ( !(obj is SubjectDirectoryAttributes) ) return false;
