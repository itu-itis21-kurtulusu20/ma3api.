...
namespace tr.gov.tubitak.uekae.esya.asn.x509 {
   ...
   public class _SeqOfTBSCertList_revokedCertificates_element : Asn1Type {
      public TBSCertList_revokedCertificates_element[] elements;

      static _SeqOfTBSCertList_revokedCertificates_element ()
      {
         Asn1Type.SetKey2 (_ExplicitValues._rtkey);
      }

      public _SeqOfTBSCertList_revokedCertificates_element () : base()
      {
         elements = null;
      }
      ...
      /// populated.
      /// </summary>
      public _SeqOfTBSCertList_revokedCertificates_element (int numRecords) : base()
      {
      ...
      /// given the array.  
      /// </summary>
      public _SeqOfTBSCertList_revokedCertificates_element (TBSCertList_revokedCertificates_element[] elements_) : base()
      {
         elements = elements_;
      }
      ...
      public override bool Equals( Object obj ) {
         ...
         if ( !(obj is _SeqOfTBSCertList_revokedCertificates_element) ) return false;
         ...
         (Asn1BerDecodeBuffer buffer, bool explicitTagging, int implicitLength)
      {
         ...
         elements = new TBSCertList_revokedCertificates_element [llist.Count];
