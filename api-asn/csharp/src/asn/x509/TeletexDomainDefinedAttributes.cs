...
namespace tr.gov.tubitak.uekae.esya.asn.x509 {
   ...
   public class TeletexDomainDefinedAttributes : Asn1Type {
      public TeletexDomainDefinedAttribute[] elements;

      static TeletexDomainDefinedAttributes ()
      {
         Asn1Type.SetKey2 (_ExplicitValues._rtkey);
      }

      public TeletexDomainDefinedAttributes () : base()
      {
         elements = null;
      }
      ...
      /// populated.
      /// </summary>
      public TeletexDomainDefinedAttributes (int numRecords) : base()
      {
      ...
      /// given the array.  
      /// </summary>
      public TeletexDomainDefinedAttributes (TeletexDomainDefinedAttribute[] elements_) : base()
      {
         elements = elements_;
      }
      ...
      public override bool Equals( Object obj ) {
         ...
         if ( !(obj is TeletexDomainDefinedAttributes) ) return false;
         ...
         (Asn1BerDecodeBuffer buffer, bool explicitTagging, int implicitLength)
      {
         ...
         elements = new TeletexDomainDefinedAttribute [llist.Count];
