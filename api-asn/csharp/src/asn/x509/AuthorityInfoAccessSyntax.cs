...
namespace tr.gov.tubitak.uekae.esya.asn.x509 {
   ...
   public class AuthorityInfoAccessSyntax : Asn1Type {
      public AccessDescription[] elements;

      static AuthorityInfoAccessSyntax ()
      {
         Asn1Type.SetKey2 (_ImplicitValues._rtkey);
      }

      public AuthorityInfoAccessSyntax () : base()
      {
         elements = null;
      }
      ...
      /// populated.
      /// </summary>
      public AuthorityInfoAccessSyntax (int numRecords) : base()
      {
      ...
      /// given the array.  
      /// </summary>
      public AuthorityInfoAccessSyntax (AccessDescription[] elements_) : base()
      {
         elements = elements_;
      }
      ...
      public override bool Equals( Object obj ) {
         ...
         if ( !(obj is AuthorityInfoAccessSyntax) ) return false;
         ...
         (Asn1BerDecodeBuffer buffer, bool explicitTagging, int implicitLength)
      {
         ...
         elements = new AccessDescription [llist.Count];
