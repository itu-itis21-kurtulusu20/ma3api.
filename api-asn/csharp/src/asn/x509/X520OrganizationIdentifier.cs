...
{
    public class X520OrganizationIdentifier : Asn1Choice
    {
        ...
        static X520OrganizationIdentifier()
        {
            Asn1Type.SetKey2(_ExplicitValues._rtkey);
        }

        public X520OrganizationIdentifier()
            : base()
        {
        }

        public X520OrganizationIdentifier(byte choiceId_, Asn1Type element_)
            : base()
        {
           ...
           (Asn1BerDecodeBuffer buffer, bool explicitTagging, int implicitLength)
        {
            ...
            if (tag.Equals(Asn1Tag.UNIV, Asn1Tag.PRIM, 12))
            {
                ...
                if (!((utf8String.Length >= 1 && utf8String.Length <= 256)))
                {
            ...
            else if (tag.Equals(Asn1Tag.UNIV, Asn1Tag.PRIM, 19))
            {
                ...
                if (!((printableString.Length >= 1 && printableString.Length <= 256)))
                {
            ...
            else if (tag.Equals(Asn1Tag.UNIV, Asn1Tag.PRIM, 20))
            {
                ...
                if (!((teletexString.Length >= 1 && teletexString.Length <= 256)))
                {
            ...
            else if (tag.Equals(Asn1Tag.UNIV, Asn1Tag.PRIM, 28))
            {
                ...
                if (!((universalString.Length >= 1 && universalString.Length <= 256)))
                {
            ...
            else if (tag.Equals(Asn1Tag.UNIV, Asn1Tag.PRIM, 30))
            {
                ...
                if (!((bmpString.Length >= 1 && bmpString.Length <= 256)))
                {
