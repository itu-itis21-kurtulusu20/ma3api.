...
namespace tr.gov.tubitak.uekae.esya.asn.x509 {
   ...
   public class X520name : Asn1Choice {
      ...
      public X520name () : base()
      {
      }

      public X520name (byte choiceId_, Asn1Type element_) : base()
      {
         ...
         (Asn1BerDecodeBuffer buffer, bool explicitTagging, int implicitLength)
      {
         ...
         if (tag.Equals (Asn1Tag.UNIV, Asn1Tag.PRIM, 12))
         {
            ...
            if (!((utf8String.Length >= 1 && utf8String.Length <= 32768))) {
         ...
         else if (tag.Equals (Asn1Tag.UNIV, Asn1Tag.PRIM, 19))
         {
            ...
            if (!((printableString.Length >= 1 && printableString.Length <= 32768))) {
         ...
         else if (tag.Equals (Asn1Tag.UNIV, Asn1Tag.PRIM, 20))
         {
            ...
            if (!((teletexString.Length >= 1 && teletexString.Length <= 32768))) {
         ...
         else if (tag.Equals (Asn1Tag.UNIV, Asn1Tag.PRIM, 28))
         {
            ...
            if (!((universalString.Length >= 1 && universalString.Length <= 32768))) {
         ...
         else if (tag.Equals (Asn1Tag.UNIV, Asn1Tag.PRIM, 30))
         {
            ...
            if (!((bmpString.Length >= 1 && bmpString.Length <= 32768))) {
