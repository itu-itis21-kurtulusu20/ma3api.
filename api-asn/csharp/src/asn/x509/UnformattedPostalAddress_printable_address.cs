...
namespace tr.gov.tubitak.uekae.esya.asn.x509 {
   ...
   public class UnformattedPostalAddress_printable_address : Asn1Type {
      public Asn1PrintableString[] elements;

      static UnformattedPostalAddress_printable_address ()
      {
         Asn1Type.SetKey2 (_ExplicitValues._rtkey);
      }

      public UnformattedPostalAddress_printable_address () : base()
      {
         elements = null;
      }
      ...
      /// populated.
      /// </summary>
      public UnformattedPostalAddress_printable_address (int numRecords) : base()
      {
      ...
      /// given the array.  
      /// </summary>
      public UnformattedPostalAddress_printable_address (Asn1PrintableString[] elements_) : base()
      {
         elements = elements_;
      }
      ...
      public override bool Equals( Object obj ) {
         ...
         if ( !(obj is UnformattedPostalAddress_printable_address) ) return false;
         ...
         (Asn1BerDecodeBuffer buffer, bool explicitTagging, int implicitLength)
      {
         ...
         elements = new Asn1PrintableString [llist.Count];
      ...
      public override int Encode (Asn1BerEncodeBuffer buffer, bool explicitTagging)
      {
         ...
         for (int i = elements.Length - 1; i >= 0; i--) {
            if (!((elements[i].Length >= 1 && elements[i].Length <= 30))) {
