...
namespace tr.gov.tubitak.uekae.esya.asn.x509 {
   ...
   public class SubjectInfoAccessSyntax : Asn1Type {
      public AccessDescription[] elements;

      static SubjectInfoAccessSyntax ()
      {
         Asn1Type.SetKey2 (_ImplicitValues._rtkey);
      }

      public SubjectInfoAccessSyntax () : base()
      {
         elements = null;
      }
      ...
      /// populated.
      /// </summary>
      public SubjectInfoAccessSyntax (int numRecords) : base()
      {
      ...
      /// given the array.  
      /// </summary>
      public SubjectInfoAccessSyntax (AccessDescription[] elements_) : base()
      {
         elements = elements_;
      }
      ...
      public override bool Equals( Object obj ) {
         ...
         if ( !(obj is SubjectInfoAccessSyntax) ) return false;
