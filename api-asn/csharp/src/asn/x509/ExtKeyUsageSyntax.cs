...
namespace tr.gov.tubitak.uekae.esya.asn.x509 {
   ...
   public class ExtKeyUsageSyntax : Asn1Type {
      public Asn1ObjectIdentifier[] elements;

      static ExtKeyUsageSyntax ()
      {
         Asn1Type.SetKey2 (_ImplicitValues._rtkey);
      }

      public ExtKeyUsageSyntax () : base()
      {
         elements = null;
      }
      ...
      /// populated.
      /// </summary>
      public ExtKeyUsageSyntax (int numRecords) : base()
      {
      ...
      /// given the array.  
      /// </summary>
      public ExtKeyUsageSyntax (Asn1ObjectIdentifier[] elements_) : base()
      {
         elements = elements_;
      }
      ...
      public override bool Equals( Object obj ) {
         ...
         if ( !(obj is ExtKeyUsageSyntax) ) return false;
         ExtKeyUsageSyntax rhs = (ExtKeyUsageSyntax) obj;
         Asn1ObjectIdentifier[] rhsElements = rhs.elements;
