...
namespace tr.gov.tubitak.uekae.esya.asn.x509 {
   ...
   public class Extensions : Asn1Type {
      ...
      /// populated.
      /// </summary>
      public Extensions (int numRecords) : base()
      {
      ...
      /// given the array.  
      /// </summary>
      public Extensions (Extension[] elements_) : base()
      {
         elements = elements_;
      }
      ...
      public override bool Equals( Object obj ) {
         ...
         if ( !(obj is Extensions) ) return false;
         Extensions rhs = (Extensions) obj;
         Extension[] rhsElements = rhs.elements;
         ...
         (Asn1BerDecodeBuffer buffer, bool explicitTagging, int implicitLength)
      {
         ...
         elements = new Extension [llist.Count];
