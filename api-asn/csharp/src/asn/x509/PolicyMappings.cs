...
namespace tr.gov.tubitak.uekae.esya.asn.x509 {
   ...
   public class PolicyMappings : Asn1Type {
      ...
      /// populated.
      /// </summary>
      public PolicyMappings (int numRecords) : base()
      {
      ...
      /// given the array.  
      /// </summary>
      public PolicyMappings (PolicyMappings_element[] elements_) : base()
      {
         elements = elements_;
      }
      ...
      public override bool Equals( Object obj ) {
         ...
         if ( !(obj is PolicyMappings) ) return false;
         ...
         (Asn1BerDecodeBuffer buffer, bool explicitTagging, int implicitLength)
      {
         ...
         elements = new PolicyMappings_element [llist.Count];
