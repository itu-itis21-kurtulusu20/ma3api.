...
namespace tr.gov.tubitak.uekae.esya.asn.x509 {
   ...
   public class PosteRestanteAddress : PDSParameter {
      static PosteRestanteAddress ()
      {
         Asn1Type.SetKey2 (_ExplicitValues._rtkey);
      }

      public PosteRestanteAddress () : base()
      {
      }
      ...
      /// the given objects 
      /// </summary>
      public PosteRestanteAddress (string printable_string_,
