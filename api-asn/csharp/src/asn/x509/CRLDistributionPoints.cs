...
namespace tr.gov.tubitak.uekae.esya.asn.x509 {
   ...
   public class CRLDistributionPoints : Asn1Type {
      ...
      public CRLDistributionPoints () : base()
      {
         elements = null;
      }
      ...
      /// populated.
      /// </summary>
      public CRLDistributionPoints (int numRecords) : base()
      {
      ...
      /// given the array.  
      /// </summary>
      public CRLDistributionPoints (DistributionPoint[] elements_) : base()
      {
         elements = elements_;
      }
      ...
      public override bool Equals( Object obj ) {
         ...
         if ( !(obj is CRLDistributionPoints) ) return false;
         ...
         (Asn1BerDecodeBuffer buffer, bool explicitTagging, int implicitLength)
      {
         ...
         elements = new DistributionPoint [llist.Count];
