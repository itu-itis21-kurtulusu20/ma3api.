...
namespace tr.gov.tubitak.uekae.esya.asn.x509 {
   ...
   public class GeneralSubtree : Asn1Type {
      ...
      public override bool Equals( Object obj ) {
         ...
         if ( !(obj is GeneralSubtree) ) return false;

         GeneralSubtree rhs = (GeneralSubtree) obj;

         if (base_ == null) {
            if (rhs.base_ != null) return false;
         }
         else {
            if (!base_.Equals(rhs.base_)) {
               return false;
            }
         }
      ...
      public override int GetHashCode() {
         ...
         if (base_ != null) __code = 31*__code + base_.GetHashCode();
         if (minimum != null) __code = 31*__code + minimum.GetHashCode();
         if (maximum != null) __code = 31*__code + maximum.GetHashCode();
         ...
         (Asn1BerDecodeBuffer buffer, bool explicitTagging, int implicitLength)
      {
         ...
         if (_context.MatchElemTag (Asn1Tag.CTXT, Asn1Tag.PRIM, 0, elemLen, true)) {
            ...
            minimum.Decode (buffer, false, elemLen.mValue);
            if (!(minimum.mValue >= 0)) {
         ...
         if (_context.MatchElemTag (Asn1Tag.CTXT, Asn1Tag.PRIM, 1, elemLen, true)) {
            ...
            maximum.Decode (buffer, false, elemLen.mValue);
            if (!(maximum.mValue >= 0)) {
