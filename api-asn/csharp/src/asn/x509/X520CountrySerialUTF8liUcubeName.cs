...
namespace tr.gov.tubitak.uekae.esya.asn.x509 {
   ...
   public class X520CountrySerialUTF8liUcubeName : Asn1Choice {
      ...
      static X520CountrySerialUTF8liUcubeName ()
      {
         Asn1Type.SetKey2 (_ExplicitValues._rtkey);
      }

      public X520CountrySerialUTF8liUcubeName () : base()
      {
      }

      public X520CountrySerialUTF8liUcubeName (byte choiceId_, Asn1Type element_) : base()
      {
