...
namespace tr.gov.tubitak.uekae.esya.asn.x509 {
   ...
   public class NoticeReference_noticeNumbers : Asn1Type {
      public Asn1Integer[] elements;

      static NoticeReference_noticeNumbers ()
      {
         Asn1Type.SetKey2 (_ImplicitValues._rtkey);
      }

      public NoticeReference_noticeNumbers () : base()
      {
         elements = null;
      }
      ...
      /// populated.
      /// </summary>
      public NoticeReference_noticeNumbers (int numRecords) : base()
      {
      ...
      /// given the array.  
      /// </summary>
      public NoticeReference_noticeNumbers (Asn1Integer[] elements_) : base()
      {
         elements = elements_;
      }
      ...
      public override bool Equals( Object obj ) {
         ...
         if ( !(obj is NoticeReference_noticeNumbers) ) return false;
         ...
         (Asn1BerDecodeBuffer buffer, bool explicitTagging, int implicitLength)
      {
         ...
         elements = new Asn1Integer [llist.Count];
