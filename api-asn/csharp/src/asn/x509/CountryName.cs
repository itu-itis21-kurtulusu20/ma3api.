...
namespace tr.gov.tubitak.uekae.esya.asn.x509 {
   ...
   public class CountryName : Asn1Choice {
      public new static readonly Asn1Tag _TAG = new Asn1Tag (Asn1Tag.APPL, Asn1Tag.CONS, 1);
      ...
      public CountryName () : base()
      {
      }

      public CountryName (byte choiceId_, Asn1Type element_) : base()
      {
