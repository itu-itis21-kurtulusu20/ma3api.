...
namespace tr.gov.tubitak.uekae.esya.asn.x509 {
   ...
   public class X520StateOrProvinceName : Asn1Choice {
      ...
      static X520StateOrProvinceName ()
      {
         Asn1Type.SetKey2 (_ExplicitValues._rtkey);
      }

      public X520StateOrProvinceName () : base()
      {
      }

      public X520StateOrProvinceName (byte choiceId_, Asn1Type element_) : base()
      {
