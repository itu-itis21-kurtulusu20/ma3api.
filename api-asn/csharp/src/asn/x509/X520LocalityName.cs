...
namespace tr.gov.tubitak.uekae.esya.asn.x509 {
   ...
   public class X520LocalityName : Asn1Choice {
      ...
      static X520LocalityName ()
      {
         Asn1Type.SetKey2 (_ExplicitValues._rtkey);
      }

      public X520LocalityName () : base()
      {
      }

      public X520LocalityName (byte choiceId_, Asn1Type element_) : base()
      {
