...
namespace tr.gov.tubitak.uekae.esya.asn.x509 {
   ...
   public class DirectoryString : Asn1Choice {
      ...
      public DirectoryString () : base()
      {
      }

      public DirectoryString (byte choiceId_, Asn1Type element_) : base()
      {
