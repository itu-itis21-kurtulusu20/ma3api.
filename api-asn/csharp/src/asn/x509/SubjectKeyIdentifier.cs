...
namespace tr.gov.tubitak.uekae.esya.asn.x509 {
   ...
   public class SubjectKeyIdentifier : Asn1OctetString {
      static SubjectKeyIdentifier ()
      {
         Asn1Type.SetKey2 (_ImplicitValues._rtkey);
      }

      public SubjectKeyIdentifier () : base()
      {
      }
      ...
      public SubjectKeyIdentifier (byte[] data) : base (data)
      {
      }
      ...
      public SubjectKeyIdentifier (byte[] data, int offset, int nbytes) :
      ...
      public SubjectKeyIdentifier (string value_) : base (value_)
      {
      }
