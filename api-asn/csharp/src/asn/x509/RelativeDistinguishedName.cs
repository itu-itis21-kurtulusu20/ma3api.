...
namespace tr.gov.tubitak.uekae.esya.asn.x509 {
   ...
   public class RelativeDistinguishedName : Asn1Type {
      ...
      public RelativeDistinguishedName () : base()
      {
         elements = null;
      }
      ...
      /// populated.
      /// </summary>
      public RelativeDistinguishedName (int numRecords) : base()
      {
      ...
      /// given the array.  
      /// </summary>
      public RelativeDistinguishedName (AttributeTypeAndValue[] elements_) : base()
      {
         elements = elements_;
      }
      ...
      public override bool Equals( Object obj ) {
         ...
         if ( !(obj is RelativeDistinguishedName) ) return false;
         RelativeDistinguishedName rhs = (RelativeDistinguishedName) obj;
         AttributeTypeAndValue[] rhsElements = rhs.elements;
