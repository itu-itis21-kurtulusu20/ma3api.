...
namespace tr.gov.tubitak.uekae.esya.asn.x509 {
   ...
   public class _SeqOfKerberosString : Asn1Type {
      ...
      /// given the array.  
      /// </summary>
      public _SeqOfKerberosString (Asn1GeneralString[] elements_) : base()
      {
         elements = elements_;
      }
      ...
      public override bool Equals( Object obj ) {
         ...
         if ( !(obj is _SeqOfKerberosString) ) return false;
         ...
         (Asn1BerDecodeBuffer buffer, bool explicitTagging, int implicitLength)
      {
         ...
         elements = new Asn1GeneralString [llist.Count];
