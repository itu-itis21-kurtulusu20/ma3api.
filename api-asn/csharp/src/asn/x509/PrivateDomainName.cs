...
namespace tr.gov.tubitak.uekae.esya.asn.x509 {
   ...
   public class PrivateDomainName : Asn1Choice {
      // Choice element identifier constants
      public const byte _NUMERIC = 1;
      public const byte _PRINTABLE = 2;

      static PrivateDomainName ()
      {
         Asn1Type.SetKey2 (_ExplicitValues._rtkey);
      }

      public PrivateDomainName () : base()
      {
      }

      public PrivateDomainName (byte choiceId_, Asn1Type element_) : base()
      {
         ...
         (Asn1BerDecodeBuffer buffer, bool explicitTagging, int implicitLength)
      {
         ...
         if (tag.Equals (Asn1Tag.UNIV, Asn1Tag.PRIM, 18))
         {
            ...
            if (!((numeric.Length >= 1 && numeric.Length <= 16))) {
         ...
         else if (tag.Equals (Asn1Tag.UNIV, Asn1Tag.PRIM, 19))
         {
            ...
            if (!((printable.Length >= 1 && printable.Length <= 16))) {
