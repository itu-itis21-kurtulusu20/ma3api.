...
namespace tr.gov.tubitak.uekae.esya.asn.x509 {
   ...
   public class CertificatePolicies : Asn1Type {
      ...
      public CertificatePolicies () : base()
      {
         elements = null;
      }
      ...
      /// populated.
      /// </summary>
      public CertificatePolicies (int numRecords) : base()
      {
      ...
      /// given the array.  
      /// </summary>
      public CertificatePolicies (PolicyInformation[] elements_) : base()
      {
         elements = elements_;
      }
      ...
      public override bool Equals( Object obj ) {
         ...
         if ( !(obj is CertificatePolicies) ) return false;
         ...
         (Asn1BerDecodeBuffer buffer, bool explicitTagging, int implicitLength)
      {
         ...
         elements = new PolicyInformation [llist.Count];
