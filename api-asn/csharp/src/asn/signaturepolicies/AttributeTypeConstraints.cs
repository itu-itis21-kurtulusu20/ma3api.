...
namespace tr.gov.tubitak.uekae.esya.asn.signaturepolicies {
   ...
   public class AttributeTypeConstraints : Asn1Type {
      public Asn1ObjectIdentifier[] elements;

      static AttributeTypeConstraints ()
      {
         Asn1Type.SetKey2 (_signaturepoliciesValues._rtkey);
      }

      public AttributeTypeConstraints () : base()
      {
         elements = null;
      }
      ...
      /// populated.
      /// </summary>
      public AttributeTypeConstraints (int numRecords) : base()
      {
      ...
      /// given the array.  
      /// </summary>
      public AttributeTypeConstraints (Asn1ObjectIdentifier[] elements_) : base()
      {
         elements = elements_;
      }
