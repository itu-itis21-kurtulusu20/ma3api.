...
namespace tr.gov.tubitak.uekae.esya.asn.signaturepolicies {
   ...
   public class AttributeValueConstraints : Asn1Type {
      public AttributeTypeAndValue[] elements;

      static AttributeValueConstraints ()
      {
         Asn1Type.SetKey2 (_signaturepoliciesValues._rtkey);
      }

      public AttributeValueConstraints () : base()
      {
         elements = null;
      }
      ...
      /// populated.
      /// </summary>
      public AttributeValueConstraints (int numRecords) : base()
      {
      ...
      /// given the array.  
      /// </summary>
      public AttributeValueConstraints (AttributeTypeAndValue[] elements_) : base()
      {
         elements = elements_;
      }
