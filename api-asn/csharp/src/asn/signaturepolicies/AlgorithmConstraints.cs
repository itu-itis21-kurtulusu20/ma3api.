...
namespace tr.gov.tubitak.uekae.esya.asn.signaturepolicies {
   ...
   public class AlgorithmConstraints : Asn1Type {
      ...
      /// populated.
      /// </summary>
      public AlgorithmConstraints (int numRecords) : base()
      {
      ...
      /// given the array.  
      /// </summary>
      public AlgorithmConstraints (AlgAndLength[] elements_) : base()
      {
         elements = elements_;
      }
         ...
         (Asn1BerDecodeBuffer buffer, bool explicitTagging, int implicitLength)
      {
         ...
         elements = new AlgAndLength [llist.Count];
