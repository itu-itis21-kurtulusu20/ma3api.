...
namespace tr.gov.tubitak.uekae.esya.asn.signaturepolicies {
   ...
   public class GeneralSubtrees : Asn1Type {
      public tr.gov.tubitak.uekae.esya.asn.signaturepolicies.GeneralSubtree[] elements;
      ...
      /// populated.
      /// </summary>
      public GeneralSubtrees (int numRecords) : base()
      {
         elements = new tr.gov.tubitak.uekae.esya.asn.signaturepolicies.GeneralSubtree [numRecords];
      }
      ...
      /// given the array.  
      /// </summary>
      public GeneralSubtrees (tr.gov.tubitak.uekae.esya.asn.signaturepolicies.GeneralSubtree[] elements_) : base()
      {
         elements = elements_;
      }
         ...
         (Asn1BerDecodeBuffer buffer, bool explicitTagging, int implicitLength)
      {
         ...
         elements = new GeneralSubtree [llist.Count];
