...
namespace tr.gov.tubitak.uekae.esya.asn.signaturepolicies {
   ...
   public class CertificateTrustTrees : Asn1Type {
      public CertificateTrustPoint[] elements;

      static CertificateTrustTrees ()
      {
         Asn1Type.SetKey2 (_signaturepoliciesValues._rtkey);
      }

      public CertificateTrustTrees () : base()
      {
         elements = null;
      }
      ...
      /// populated.
      /// </summary>
      public CertificateTrustTrees (int numRecords) : base()
      {
      ...
      /// given the array.  
      /// </summary>
      public CertificateTrustTrees (CertificateTrustPoint[] elements_) : base()
      {
         elements = elements_;
      }
         ...
         (Asn1BerDecodeBuffer buffer, bool explicitTagging, int implicitLength)
      {
         ...
         elements = new CertificateTrustPoint [llist.Count];
