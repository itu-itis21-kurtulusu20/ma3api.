...
namespace tr.gov.tubitak.uekae.esya.asn.signaturepolicies {
   ...
   public class SignPolExtensions : Asn1Type {
      public SignPolExtn[] elements;

      static SignPolExtensions ()
      {
         Asn1Type.SetKey2 (_signaturepoliciesValues._rtkey);
      }

      public SignPolExtensions () : base()
      {
         elements = null;
      }
      ...
      /// populated.
      /// </summary>
      public SignPolExtensions (int numRecords) : base()
      {
      ...
      /// given the array.  
      /// </summary>
      public SignPolExtensions (SignPolExtn[] elements_) : base()
      {
         elements = elements_;
      }
         ...
         (Asn1BerDecodeBuffer buffer, bool explicitTagging, int implicitLength)
      {
         ...
         elements = new SignPolExtn [llist.Count];
