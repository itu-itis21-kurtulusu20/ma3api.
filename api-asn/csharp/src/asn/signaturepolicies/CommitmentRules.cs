...
namespace tr.gov.tubitak.uekae.esya.asn.signaturepolicies {
   ...
   public class CommitmentRules : Asn1Type {
      public CommitmentRule[] elements;

      static CommitmentRules ()
      {
         Asn1Type.SetKey2 (_signaturepoliciesValues._rtkey);
      }

      public CommitmentRules () : base()
      {
         elements = null;
      }
      ...
      /// populated.
      /// </summary>
      public CommitmentRules (int numRecords) : base()
      {
      ...
      /// given the array.  
      /// </summary>
      public CommitmentRules (CommitmentRule[] elements_) : base()
      {
         elements = elements_;
      }
         ...
         (Asn1BerDecodeBuffer buffer, bool explicitTagging, int implicitLength)
      {
         ...
         elements = new CommitmentRule [llist.Count];
