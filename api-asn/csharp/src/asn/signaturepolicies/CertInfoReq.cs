...
namespace tr.gov.tubitak.uekae.esya.asn.signaturepolicies {
   ...
   public class CertInfoReq : Asn1Enumerated {
      private static CertInfoReq _none = null;
      private static CertInfoReq _signerOnly = null;
      private static CertInfoReq _fullPath = null;
      ...
      ///   2
      /// </summary>
      protected CertInfoReq (int value_) : base (value_)
      {
      }
      ...
      public static CertInfoReq none() {
         if (_none == null) _none = new CertInfoReq (0);
      ...
      public static CertInfoReq signerOnly() {
         if (_signerOnly == null) _signerOnly = new CertInfoReq (1);
      ...
      public static CertInfoReq fullPath() {
         if (_fullPath == null) _fullPath = new CertInfoReq (2);
