...
namespace tr.gov.tubitak.uekae.esya.asn.signaturepolicies {
   ...
   public class SelectedCommitmentTypes : Asn1Type {
      public SelectedCommitmentTypes_element[] elements;

      static SelectedCommitmentTypes ()
      {
         Asn1Type.SetKey2 (_signaturepoliciesValues._rtkey);
      }

      public SelectedCommitmentTypes () : base()
      {
         elements = null;
      }
      ...
      /// populated.
      /// </summary>
      public SelectedCommitmentTypes (int numRecords) : base()
      {
      ...
      /// given the array.  
      /// </summary>
      public SelectedCommitmentTypes (SelectedCommitmentTypes_element[] elements_) : base()
      {
         elements = elements_;
      }
         ...
         (Asn1BerDecodeBuffer buffer, bool explicitTagging, int implicitLength)
      {
         ...
         elements = new SelectedCommitmentTypes_element [llist.Count];
