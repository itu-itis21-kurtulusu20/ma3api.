...
namespace tr.gov.tubitak.uekae.esya.asn.cms {
   ...
   public class _SeqOfOcspResponsesID : Asn1Type {
      public OcspResponsesID[] elements;

      static _SeqOfOcspResponsesID ()
      {
         Asn1Type.SetKey2 (_etsi101733Values._rtkey);
      }

      public _SeqOfOcspResponsesID () : base()
      {
         elements = null;
      }
      ...
      /// populated.
      /// </summary>
      public _SeqOfOcspResponsesID (int numRecords) : base()
      {
      ...
      /// given the array.  
      /// </summary>
      public _SeqOfOcspResponsesID (OcspResponsesID[] elements_) : base()
      {
         elements = elements_;
      }
         ...
         (Asn1BerDecodeBuffer buffer, bool explicitTagging, int implicitLength)
      {
         ...
         elements = new OcspResponsesID [llist.Count];
