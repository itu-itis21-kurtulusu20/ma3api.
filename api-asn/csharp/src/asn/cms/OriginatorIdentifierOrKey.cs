...
namespace tr.gov.tubitak.uekae.esya.asn.cms {
   ...
   public class OriginatorIdentifierOrKey : Asn1Choice {
      ...
      public OriginatorIdentifierOrKey () : base()
      {
      }

      public OriginatorIdentifierOrKey (byte choiceId_, Asn1Type element_) : base()
      {
      ...
      public override string ElemName {
         get {
            ...
            case _ORIGINATORKEY: return "originatorKey";
      ...
      public void Set_originatorKey (OriginatorPublicKey value) {
         SetElement (_ORIGINATORKEY, value);
      }
         ...
         (Asn1BerDecodeBuffer buffer, bool explicitTagging, int implicitLength)
      {
         ...
         else if (tag.Equals (Asn1Tag.CTXT, Asn1Tag.CONS, 1))
         {
            ...
            originatorKey.Decode (buffer, false, len);
            SetElement (_ORIGINATORKEY, originatorKey);
      ...
      public override int Encode (Asn1BerEncodeBuffer buffer, bool explicitTagging)
      {
         ...
         // encode originatorKey
         case _ORIGINATORKEY:
            OriginatorPublicKey originatorKey = (OriginatorPublicKey) GetElement();
            len = originatorKey.Encode (buffer, false);
