...
namespace tr.gov.tubitak.uekae.esya.asn.cms {
   ...
   public class UnauthAttributes : Asn1Type {
      public Attribute[] elements;

      static UnauthAttributes ()
      {
         Asn1Type.SetKey2 (_cmsValues._rtkey);
      }

      public UnauthAttributes () : base()
      {
         elements = null;
      }
      ...
      /// populated.
      /// </summary>
      public UnauthAttributes (int numRecords) : base()
      {
      ...
      /// given the array.  
      /// </summary>
      public UnauthAttributes (Attribute[] elements_) : base()
      {
         elements = elements_;
      }
