...
namespace tr.gov.tubitak.uekae.esya.asn.cms {
   ...
   public class CommitmentTypeIndication_commitmentTypeQualifier : Asn1Type {
      public CommitmentTypeQualifier[] elements;

      static CommitmentTypeIndication_commitmentTypeQualifier ()
      {
         Asn1Type.SetKey2 (_etsi101733Values._rtkey);
      }

      public CommitmentTypeIndication_commitmentTypeQualifier () : base()
      {
         elements = null;
      }
      ...
      /// populated.
      /// </summary>
      public CommitmentTypeIndication_commitmentTypeQualifier (int numRecords) : base()
      {
         elements = new CommitmentTypeQualifier [numRecords];
      }
      ...
      /// given the array.  
      /// </summary>
      public CommitmentTypeIndication_commitmentTypeQualifier (CommitmentTypeQualifier[] elements_) : base()
      {
         elements = elements_;
      }
         ...
         (Asn1BerDecodeBuffer buffer, bool explicitTagging, int implicitLength)
      {
         ...
         CommitmentTypeQualifier element;
         int elemLen = 0;

         while (!_context.Expired()) {
            element = new CommitmentTypeQualifier();
            element.Decode (buffer, true, elemLen);
            llist.Add (element);
         }

         elements = new CommitmentTypeQualifier [llist.Count];
