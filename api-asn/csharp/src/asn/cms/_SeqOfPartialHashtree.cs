...
namespace tr.gov.tubitak.uekae.esya.asn.cms {
   ...
   public class _SeqOfPartialHashtree : Asn1Type {
      public PartialHashtree[] elements;

      static _SeqOfPartialHashtree ()
      {
         Asn1Type.SetKey2 (_etsi101733Values._rtkey);
      }

      public _SeqOfPartialHashtree () : base()
      {
         elements = null;
      }
      ...
      /// populated.
      /// </summary>
      public _SeqOfPartialHashtree (int numRecords) : base()
      {
      ...
      /// given the array.  
      /// </summary>
      public _SeqOfPartialHashtree (PartialHashtree[] elements_) : base()
      {
         elements = elements_;
      }
         ...
         (Asn1BerDecodeBuffer buffer, bool explicitTagging, int implicitLength)
      {
         ...
         elements = new PartialHashtree [llist.Count];
