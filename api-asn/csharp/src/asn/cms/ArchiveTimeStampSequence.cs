...
namespace tr.gov.tubitak.uekae.esya.asn.cms {
   ...
   public class ArchiveTimeStampSequence : Asn1Type {
      ...
      public ArchiveTimeStampSequence () : base()
      {
         elements = null;
      }
      ...
      /// populated.
      /// </summary>
      public ArchiveTimeStampSequence (int numRecords) : base()
      {
      ...
      /// given the array.  
      /// </summary>
      public ArchiveTimeStampSequence (ArchiveTimeStampChain[] elements_) : base()
      {
         elements = elements_;
      }
         ...
         (Asn1BerDecodeBuffer buffer, bool explicitTagging, int implicitLength)
      {
         ...
         elements = new ArchiveTimeStampChain [llist.Count];
