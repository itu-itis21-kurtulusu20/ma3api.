...
namespace tr.gov.tubitak.uekae.esya.asn.cms {
   ...
   public class CompleteRevocationRefs : Asn1Type {
      ...
      public CompleteRevocationRefs () : base()
      {
         elements = null;
      }
      ...
      /// populated.
      /// </summary>
      public CompleteRevocationRefs (int numRecords) : base()
      {
      ...
      /// given the array.  
      /// </summary>
      public CompleteRevocationRefs (CrlOcspRef[] elements_) : base()
      {
         elements = elements_;
      }
