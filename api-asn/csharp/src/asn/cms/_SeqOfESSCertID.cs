...
namespace tr.gov.tubitak.uekae.esya.asn.cms {
   ...
   public class _SeqOfESSCertID : Asn1Type {
      public ESSCertID[] elements;

      static _SeqOfESSCertID ()
      {
         Asn1Type.SetKey2 (_cmsValues._rtkey);
      }

      public _SeqOfESSCertID () : base()
      {
         elements = null;
      }
      ...
      /// populated.
      /// </summary>
      public _SeqOfESSCertID (int numRecords) : base()
      {
      ...
      /// given the array.  
      /// </summary>
      public _SeqOfESSCertID (ESSCertID[] elements_) : base()
      {
         elements = elements_;
      }
         ...
         (Asn1BerDecodeBuffer buffer, bool explicitTagging, int implicitLength)
      {
         ...
         elements = new ESSCertID [llist.Count];
