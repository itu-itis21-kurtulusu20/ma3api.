...
namespace tr.gov.tubitak.uekae.esya.asn.cms {
   ...
   public class OtherRevVals_otherRevVals : Asn1Type {
      public Asn1OpenType[] elements;

      static OtherRevVals_otherRevVals ()
      {
         Asn1Type.SetKey2 (_etsi101733Values._rtkey);
      }

      public OtherRevVals_otherRevVals () : base()
      {
         elements = null;
      }
      ...
      /// populated.
      /// </summary>
      public OtherRevVals_otherRevVals (int numRecords) : base()
      {
      ...
      /// given the array.  
      /// </summary>
      public OtherRevVals_otherRevVals (Asn1OpenType[] elements_) : base()
      {
         elements = elements_;
      }
