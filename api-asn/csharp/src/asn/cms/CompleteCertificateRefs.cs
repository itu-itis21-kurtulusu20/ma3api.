...
namespace tr.gov.tubitak.uekae.esya.asn.cms {
   ...
   public class CompleteCertificateRefs : Asn1Type {
      public OtherCertID[] elements;

      static CompleteCertificateRefs ()
      {
         Asn1Type.SetKey2 (_etsi101733Values._rtkey);
      }

      public CompleteCertificateRefs () : base()
      {
         elements = null;
      }
      ...
      /// populated.
      /// </summary>
      public CompleteCertificateRefs (int numRecords) : base()
      {
      ...
      /// given the array.  
      /// </summary>
      public CompleteCertificateRefs (OtherCertID[] elements_) : base()
      {
         elements = elements_;
      }
