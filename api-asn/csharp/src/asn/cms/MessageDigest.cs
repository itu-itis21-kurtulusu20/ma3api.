...
namespace tr.gov.tubitak.uekae.esya.asn.cms {
   ...
   public class MessageDigest : Asn1OctetString {
      static MessageDigest ()
      {
         Asn1Type.SetKey2 (_cmsValues._rtkey);
      }

      public MessageDigest () : base()
      {
      }
      ...
      public MessageDigest (byte[] data) : base (data)
      {
      }
      ...
      public MessageDigest (byte[] data, int offset, int nbytes) :
      ...
      public MessageDigest (string value_) : base (value_)
      {
      }
