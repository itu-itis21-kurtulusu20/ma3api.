...
namespace tr.gov.tubitak.uekae.esya.asn.cms {
   ...
   public class UnprotectedAttributes : Asn1Type {
      public Attribute[] elements;

      static UnprotectedAttributes ()
      {
         Asn1Type.SetKey2 (_cmsValues._rtkey);
      }

      public UnprotectedAttributes () : base()
      {
         elements = null;
      }
      ...
      /// populated.
      /// </summary>
      public UnprotectedAttributes (int numRecords) : base()
      {
      ...
      /// given the array.  
      /// </summary>
      public UnprotectedAttributes (Attribute[] elements_) : base()
      {
         elements = elements_;
      }
