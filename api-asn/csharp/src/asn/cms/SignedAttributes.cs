...
namespace tr.gov.tubitak.uekae.esya.asn.cms {
   ...
   public class SignedAttributes : Asn1Type {
      public Attribute[] elements;

      static SignedAttributes ()
      {
         Asn1Type.SetKey2 (_dercmsValues._rtkey);
      }

      public SignedAttributes () : base()
      {
         elements = null;
      }
      ...
      /// populated.
      /// </summary>
      public SignedAttributes (int numRecords) : base()
      {
      ...
      /// given the array.  
      /// </summary>
      public SignedAttributes (Attribute[] elements_) : base()
      {
         elements = elements_;
      }
