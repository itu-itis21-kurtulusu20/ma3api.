...
namespace tr.gov.tubitak.uekae.esya.asn.cms {
   ...
   public class CertificateValues : Asn1Type {
      public Certificate[] elements;

      static CertificateValues ()
      {
         Asn1Type.SetKey2 (_etsi101733Values._rtkey);
      }

      public CertificateValues () : base()
      {
         elements = null;
      }
      ...
      /// populated.
      /// </summary>
      public CertificateValues (int numRecords) : base()
      {
      ...
      /// given the array.  
      /// </summary>
      public CertificateValues (Certificate[] elements_) : base()
      {
         elements = elements_;
      }
