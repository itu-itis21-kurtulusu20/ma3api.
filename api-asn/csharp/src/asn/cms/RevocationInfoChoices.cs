...
namespace tr.gov.tubitak.uekae.esya.asn.cms {
   ...
   public class RevocationInfoChoices : Asn1Type {
      public RevocationInfoChoice[] elements;

      static RevocationInfoChoices ()
      {
         Asn1Type.SetKey2 (_cmsValues._rtkey);
      }

      public RevocationInfoChoices () : base()
      {
         elements = null;
      }
      ...
      /// populated.
      /// </summary>
      public RevocationInfoChoices (int numRecords) : base()
      {
      ...
      /// given the array.  
      /// </summary>
      public RevocationInfoChoices (RevocationInfoChoice[] elements_) : base()
      {
         elements = elements_;
      }
         ...
         (Asn1BerDecodeBuffer buffer, bool explicitTagging, int implicitLength)
      {
         ...
         elements = new RevocationInfoChoice [llist.Count];
