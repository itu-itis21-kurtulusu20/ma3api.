...
namespace tr.gov.tubitak.uekae.esya.asn.cms {
   ...
   public class AttributeRevocationRefs : Asn1Type {
      public CrlOcspRef[] elements;

      static AttributeRevocationRefs ()
      {
         Asn1Type.SetKey2 (_etsi101733Values._rtkey);
      }

      public AttributeRevocationRefs () : base()
      {
         elements = null;
      }
      ...
      /// populated.
      /// </summary>
      public AttributeRevocationRefs (int numRecords) : base()
      {
      ...
      /// given the array.  
      /// </summary>
      public AttributeRevocationRefs (CrlOcspRef[] elements_) : base()
      {
         elements = elements_;
      }
         ...
         (Asn1BerDecodeBuffer buffer, bool explicitTagging, int implicitLength)
      {
         ...
         elements = new CrlOcspRef [llist.Count];
