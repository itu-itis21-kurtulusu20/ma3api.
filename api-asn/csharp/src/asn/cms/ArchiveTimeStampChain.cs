...
namespace tr.gov.tubitak.uekae.esya.asn.cms {
   ...
   public class ArchiveTimeStampChain : Asn1Type {
      public ArchiveTimeStamp[] elements;

      static ArchiveTimeStampChain ()
      {
         Asn1Type.SetKey2 (_etsi101733Values._rtkey);
      }

      public ArchiveTimeStampChain () : base()
      {
         elements = null;
      }
      ...
      /// populated.
      /// </summary>
      public ArchiveTimeStampChain (int numRecords) : base()
      {
      ...
      /// given the array.  
      /// </summary>
      public ArchiveTimeStampChain (ArchiveTimeStamp[] elements_) : base()
      {
         elements = elements_;
      }
         ...
         (Asn1BerDecodeBuffer buffer, bool explicitTagging, int implicitLength)
      {
         ...
         elements = new ArchiveTimeStamp [llist.Count];
