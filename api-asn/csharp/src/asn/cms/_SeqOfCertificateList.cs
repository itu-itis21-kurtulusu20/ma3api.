...
namespace tr.gov.tubitak.uekae.esya.asn.cms {
   ...
   public class _SeqOfCertificateList : Asn1Type {
      public CertificateList[] elements;

      static _SeqOfCertificateList ()
      {
         Asn1Type.SetKey2 (_etsi101733Values._rtkey);
      }

      public _SeqOfCertificateList () : base()
      {
         elements = null;
      }
      ...
      /// populated.
      /// </summary>
      public _SeqOfCertificateList (int numRecords) : base()
      {
      ...
      /// given the array.  
      /// </summary>
      public _SeqOfCertificateList (CertificateList[] elements_) : base()
      {
         elements = elements_;
      }
