...
namespace tr.gov.tubitak.uekae.esya.asn.cms {
   ...
   public class SignerInfos : Asn1Type {
      ...
      /// populated.
      /// </summary>
      public SignerInfos (int numRecords) : base()
      {
      ...
      /// given the array.  
      /// </summary>
      public SignerInfos (SignerInfo[] elements_) : base()
      {
         elements = elements_;
      }
         ...
         (Asn1BerDecodeBuffer buffer, bool explicitTagging, int implicitLength)
      {
         ...
         elements = new SignerInfo [llist.Count];
