...
namespace tr.gov.tubitak.uekae.esya.asn.cms {
   ...
   public class OtherRevRefs_otherRevRefs : Asn1Type {
      public Asn1OpenType[] elements;

      static OtherRevRefs_otherRevRefs ()
      {
         Asn1Type.SetKey2 (_etsi101733Values._rtkey);
      }

      public OtherRevRefs_otherRevRefs () : base()
      {
         elements = null;
      }
      ...
      /// populated.
      /// </summary>
      public OtherRevRefs_otherRevRefs (int numRecords) : base()
      {
      ...
      /// given the array.  
      /// </summary>
      public OtherRevRefs_otherRevRefs (Asn1OpenType[] elements_) : base()
      {
         elements = elements_;
      }
