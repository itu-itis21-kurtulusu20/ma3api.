...
namespace tr.gov.tubitak.uekae.esya.asn.cms {
   ...
   public class SMIMECapabilities : Asn1Type {
      ...
      /// populated.
      /// </summary>
      public SMIMECapabilities (int numRecords) : base()
      {
      ...
      /// given the array.  
      /// </summary>
      public SMIMECapabilities (SMIMECapability[] elements_) : base()
      {
         elements = elements_;
      }
         ...
         (Asn1BerDecodeBuffer buffer, bool explicitTagging, int implicitLength)
      {
         ...
         elements = new SMIMECapability [llist.Count];
