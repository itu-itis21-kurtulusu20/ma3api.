...
namespace tr.gov.tubitak.uekae.esya.asn.cms {
   ...
   public class CertificateSet : Asn1Type {
      ...
      /// populated.
      /// </summary>
      public CertificateSet (int numRecords) : base()
      {
      ...
      /// given the array.  
      /// </summary>
      public CertificateSet (CertificateChoices[] elements_) : base()
      {
         elements = elements_;
      }
         ...
         (Asn1BerDecodeBuffer buffer, bool explicitTagging, int implicitLength)
      {
         ...
         elements = new CertificateChoices [llist.Count];
