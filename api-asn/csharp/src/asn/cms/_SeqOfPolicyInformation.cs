...
namespace tr.gov.tubitak.uekae.esya.asn.cms {
   ...
   using PolicyInformation = tr.gov.tubitak.uekae.esya.asn.x509.PolicyInformation;

   public class _SeqOfPolicyInformation : Asn1Type {
      public PolicyInformation[] elements;

      static _SeqOfPolicyInformation ()
      {
         Asn1Type.SetKey2 (_etsi101733Values._rtkey);
      }

      public _SeqOfPolicyInformation () : base()
      {
         elements = null;
      }
      ...
      /// populated.
      /// </summary>
      public _SeqOfPolicyInformation (int numRecords) : base()
      {
      ...
      /// given the array.  
      /// </summary>
      public _SeqOfPolicyInformation (PolicyInformation[] elements_) : base()
      {
         elements = elements_;
      }
