...
namespace tr.gov.tubitak.uekae.esya.asn.cms {
   ...
   public class ClaimedAttributes : Asn1Type {
      public Attribute[] elements;

      static ClaimedAttributes ()
      {
         Asn1Type.SetKey2 (_etsi101733Values._rtkey);
      }

      public ClaimedAttributes () : base()
      {
         elements = null;
      }
      ...
      /// populated.
      /// </summary>
      public ClaimedAttributes (int numRecords) : base()
      {
      ...
      /// given the array.  
      /// </summary>
      public ClaimedAttributes (Attribute[] elements_) : base()
      {
         elements = elements_;
      }
