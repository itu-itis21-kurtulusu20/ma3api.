...
namespace tr.gov.tubitak.uekae.esya.asn.cms {
   ...
   public class SignerAttribute : Asn1Type {
      ...
      /// populated.
      /// </summary>
      public SignerAttribute (int numRecords) : base()
      {
      ...
      /// given the array.  
      /// </summary>
      public SignerAttribute (SignerAttribute_element[] elements_) : base()
      {
         elements = elements_;
      }
         ...
         (Asn1BerDecodeBuffer buffer, bool explicitTagging, int implicitLength)
      {
         ...
         elements = new SignerAttribute_element [llist.Count];
