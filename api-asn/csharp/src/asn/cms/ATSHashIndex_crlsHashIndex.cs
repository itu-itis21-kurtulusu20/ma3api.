...
namespace tr.gov.tubitak.uekae.esya.asn.cms {
   ...
   public class ATSHashIndex_crlsHashIndex : Asn1Type {
      public Asn1OctetString[] elements;

      static ATSHashIndex_crlsHashIndex ()
      {
         Asn1Type.SetKey2 (_etsi101733Values._rtkey);
      }

      public ATSHashIndex_crlsHashIndex () : base()
      {
         elements = null;
      }
      ...
      /// populated.
      /// </summary>
      public ATSHashIndex_crlsHashIndex (int numRecords) : base()
      {
      ...
      /// given the array.  
      /// </summary>
      public ATSHashIndex_crlsHashIndex (Asn1OctetString[] elements_) : base()
      {
         elements = elements_;
      }
