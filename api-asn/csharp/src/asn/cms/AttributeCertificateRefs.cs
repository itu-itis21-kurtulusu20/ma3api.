...
namespace tr.gov.tubitak.uekae.esya.asn.cms {
   ...
   public class AttributeCertificateRefs : Asn1Type {
      public OtherCertID[] elements;

      static AttributeCertificateRefs ()
      {
         Asn1Type.SetKey2 (_etsi101733Values._rtkey);
      }

      public AttributeCertificateRefs () : base()
      {
         elements = null;
      }
      ...
      /// populated.
      /// </summary>
      public AttributeCertificateRefs (int numRecords) : base()
      {
      ...
      /// given the array.  
      /// </summary>
      public AttributeCertificateRefs (OtherCertID[] elements_) : base()
      {
         elements = elements_;
      }
         ...
         (Asn1BerDecodeBuffer buffer, bool explicitTagging, int implicitLength)
      {
         ...
         elements = new OtherCertID [llist.Count];
