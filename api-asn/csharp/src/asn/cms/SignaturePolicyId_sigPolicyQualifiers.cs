...
namespace tr.gov.tubitak.uekae.esya.asn.cms {
   ...
   public class SignaturePolicyId_sigPolicyQualifiers : Asn1Type {
      public SigPolicyQualifierInfo[] elements;

      static SignaturePolicyId_sigPolicyQualifiers ()
      {
         Asn1Type.SetKey2 (_etsi101733Values._rtkey);
      }

      public SignaturePolicyId_sigPolicyQualifiers () : base()
      {
         elements = null;
      }
      ...
      /// populated.
      /// </summary>
      public SignaturePolicyId_sigPolicyQualifiers (int numRecords) : base()
      {
      ...
      /// given the array.  
      /// </summary>
      public SignaturePolicyId_sigPolicyQualifiers (SigPolicyQualifierInfo[] elements_) : base()
      {
         elements = elements_;
      }
         ...
         (Asn1BerDecodeBuffer buffer, bool explicitTagging, int implicitLength)
      {
         ...
         elements = new SigPolicyQualifierInfo [llist.Count];
