...
namespace tr.gov.tubitak.uekae.esya.asn.cms {
   ...
   public class UnsignedAttributes : Asn1Type {
      public Attribute[] elements;

      static UnsignedAttributes ()
      {
         Asn1Type.SetKey2 (_cmsValues._rtkey);
      }

      public UnsignedAttributes () : base()
      {
         elements = null;
      }
      ...
      /// populated.
      /// </summary>
      public UnsignedAttributes (int numRecords) : base()
      {
      ...
      /// given the array.  
      /// </summary>
      public UnsignedAttributes (Attribute[] elements_) : base()
      {
         elements = elements_;
      }
