...
namespace tr.gov.tubitak.uekae.esya.asn.cms {
   ...
   public class ATSHashIndex_unsignedAttrsHashIndex : Asn1Type {
      public Asn1OctetString[] elements;

      static ATSHashIndex_unsignedAttrsHashIndex ()
      {
         Asn1Type.SetKey2 (_etsi101733Values._rtkey);
      }

      public ATSHashIndex_unsignedAttrsHashIndex () : base()
      {
         elements = null;
      }
      ...
      /// populated.
      /// </summary>
      public ATSHashIndex_unsignedAttrsHashIndex (int numRecords) : base()
      {
      ...
      /// given the array.  
      /// </summary>
      public ATSHashIndex_unsignedAttrsHashIndex (Asn1OctetString[] elements_) : base()
      {
         elements = elements_;
      }
