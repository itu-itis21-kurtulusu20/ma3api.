...
namespace tr.gov.tubitak.uekae.esya.asn.cms {
   ...
   public class _SeqOfCrlValidatedID : Asn1Type {
      public CrlValidatedID[] elements;

      static _SeqOfCrlValidatedID ()
      {
         Asn1Type.SetKey2 (_etsi101733Values._rtkey);
      }

      public _SeqOfCrlValidatedID () : base()
      {
         elements = null;
      }
      ...
      /// populated.
      /// </summary>
      public _SeqOfCrlValidatedID (int numRecords) : base()
      {
      ...
      /// given the array.  
      /// </summary>
      public _SeqOfCrlValidatedID (CrlValidatedID[] elements_) : base()
      {
         elements = elements_;
      }
         ...
         (Asn1BerDecodeBuffer buffer, bool explicitTagging, int implicitLength)
      {
         ...
         elements = new CrlValidatedID [llist.Count];
