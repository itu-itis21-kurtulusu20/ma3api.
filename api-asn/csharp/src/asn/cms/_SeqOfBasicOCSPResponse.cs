...
namespace tr.gov.tubitak.uekae.esya.asn.cms {
   ...
   using BasicOCSPResponse = tr.gov.tubitak.uekae.esya.asn.ocsp.BasicOCSPResponse;

   public class _SeqOfBasicOCSPResponse : Asn1Type {
      public BasicOCSPResponse[] elements;

      static _SeqOfBasicOCSPResponse ()
      {
         Asn1Type.SetKey2 (_etsi101733Values._rtkey);
      }

      public _SeqOfBasicOCSPResponse () : base()
      {
         elements = null;
      }
      ...
      /// populated.
      /// </summary>
      public _SeqOfBasicOCSPResponse (int numRecords) : base()
      {
         elements = new BasicOCSPResponse [numRecords];
      }
      ...
      /// given the array.  
      /// </summary>
      public _SeqOfBasicOCSPResponse (BasicOCSPResponse[] elements_) : base()
      {
         elements = elements_;
      }
         ...
         (Asn1BerDecodeBuffer buffer, bool explicitTagging, int implicitLength)
      {
         ...
         while (!_context.Expired()) {
            element = new BasicOCSPResponse();
            element.Decode (buffer, true, elemLen);
            llist.Add (element);
         }

         elements = new BasicOCSPResponse [llist.Count];
