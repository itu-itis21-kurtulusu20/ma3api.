...
namespace tr.gov.tubitak.uekae.esya.asn.cms {
   ...
   public class PartialHashtree : Asn1Type {
      ...
      /// populated.
      /// </summary>
      public PartialHashtree (int numRecords) : base()
      {
      ...
      /// given the array.  
      /// </summary>
      public PartialHashtree (Asn1OctetString[] elements_) : base()
      {
         elements = elements_;
      }
