...
namespace tr.gov.tubitak.uekae.esya.asn.cms {
   ...
   public class _SeqOfOtherCertID : Asn1Type {
      public OtherCertID[] elements;

      static _SeqOfOtherCertID ()
      {
         Asn1Type.SetKey2 (_etsi101733Values._rtkey);
      }

      public _SeqOfOtherCertID () : base()
      {
         elements = null;
      }
      ...
      /// populated.
      /// </summary>
      public _SeqOfOtherCertID (int numRecords) : base()
      {
      ...
      /// given the array.  
      /// </summary>
      public _SeqOfOtherCertID (OtherCertID[] elements_) : base()
      {
         elements = elements_;
      }
