...
namespace tr.gov.tubitak.uekae.esya.asn.PKIXqualified {
   ...
   public class CountryOfResidence : Asn1PrintableString {
      static CountryOfResidence ()
      {
         Asn1Type.SetKey2 (_PKIXqualifiedValues._rtkey);
      }

      public CountryOfResidence () : base()
      {
      }

      public CountryOfResidence (string value_) : base (value_)
      {
      }
