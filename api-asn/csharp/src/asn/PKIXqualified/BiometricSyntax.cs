...
namespace tr.gov.tubitak.uekae.esya.asn.PKIXqualified {
   ...
   public class BiometricSyntax : Asn1Type {
      public BiometricData[] elements;

      static BiometricSyntax ()
      {
         Asn1Type.SetKey2 (_PKIXqualifiedValues._rtkey);
      }

      public BiometricSyntax () : base()
      {
         elements = null;
      }
      ...
      /// populated.
      /// </summary>
      public BiometricSyntax (int numRecords) : base()
      {
      ...
      /// given the array.  
      /// </summary>
      public BiometricSyntax (BiometricData[] elements_) : base()
      {
         elements = elements_;
      }
         ...
         (Asn1BerDecodeBuffer buffer, bool explicitTagging, int implicitLength)
      {
         ...
         elements = new BiometricData [llist.Count];
