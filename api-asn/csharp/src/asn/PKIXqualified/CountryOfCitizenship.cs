...
namespace tr.gov.tubitak.uekae.esya.asn.PKIXqualified {
   ...
   public class CountryOfCitizenship : Asn1PrintableString {
      static CountryOfCitizenship ()
      {
         Asn1Type.SetKey2 (_PKIXqualifiedValues._rtkey);
      }

      public CountryOfCitizenship () : base()
      {
      }

      public CountryOfCitizenship (string value_) : base (value_)
      {
      }
