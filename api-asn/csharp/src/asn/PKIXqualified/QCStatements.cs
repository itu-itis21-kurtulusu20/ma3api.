...
namespace tr.gov.tubitak.uekae.esya.asn.PKIXqualified {
   ...
   public class QCStatements : Asn1Type {
      ...
      /// populated.
      /// </summary>
      public QCStatements (int numRecords) : base()
      {
      ...
      /// given the array.  
      /// </summary>
      public QCStatements (QCStatement[] elements_) : base()
      {
         elements = elements_;
      }
         ...
         (Asn1BerDecodeBuffer buffer, bool explicitTagging, int implicitLength)
      {
         ...
         elements = new QCStatement [llist.Count];
