...
namespace tr.gov.tubitak.uekae.esya.asn.PKIXqualified {
   ...
   public class NameRegistrationAuthorities : Asn1Type {
      public GeneralName[] elements;

      static NameRegistrationAuthorities ()
      {
         Asn1Type.SetKey2 (_PKIXqualifiedValues._rtkey);
      }

      public NameRegistrationAuthorities () : base()
      {
         elements = null;
      }
      ...
      /// populated.
      /// </summary>
      public NameRegistrationAuthorities (int numRecords) : base()
      {
      ...
      /// given the array.  
      /// </summary>
      public NameRegistrationAuthorities (GeneralName[] elements_) : base()
      {
         elements = elements_;
      }
