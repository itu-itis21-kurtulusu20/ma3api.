...
namespace tr.gov.tubitak.uekae.esya.asn.esya {
   ...
   public class ESYASimAnahtarlari : Asn1Type {
      public ESYASimAnahtari[] elements;

      static ESYASimAnahtarlari ()
      {
         Asn1Type.SetKey2 (_esyaValues._rtkey);
      }

      public ESYASimAnahtarlari () : base()
      {
         elements = null;
      }
      ...
      /// populated.
      /// </summary>
      public ESYASimAnahtarlari (int numRecords) : base()
      {
      ...
      /// given the array.  
      /// </summary>
      public ESYASimAnahtarlari (ESYASimAnahtari[] elements_) : base()
      {
         elements = elements_;
      }
         ...
         (Asn1BerDecodeBuffer buffer, bool explicitTagging, int implicitLength)
      {
         ...
         elements = new ESYASimAnahtari [llist.Count];
