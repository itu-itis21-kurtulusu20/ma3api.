...
namespace tr.gov.tubitak.uekae.esya.asn.esya.crlfinder {
   ...
   public class CRLResponse_responseBytes : Asn1Type {
      public Asn1OctetString[] elements;

      static CRLResponse_responseBytes ()
      {
         Asn1Type.SetKey2 (_crlfinderValues._rtkey);
      }

      public CRLResponse_responseBytes () : base()
      {
         elements = null;
      }
      ...
      /// populated.
      /// </summary>
      public CRLResponse_responseBytes (int numRecords) : base()
      {
      ...
      /// given the array.  
      /// </summary>
      public CRLResponse_responseBytes (Asn1OctetString[] elements_) : base()
      {
         elements = elements_;
      }
