...
namespace tr.gov.tubitak.uekae.esya.asn.esya {
   ...
   public class ESYASertifikaIptalTalep_kartSeriNo : Asn1Type {
      public Asn1OctetString[] elements;

      static ESYASertifikaIptalTalep_kartSeriNo ()
      {
         Asn1Type.SetKey2 (_esyaValues._rtkey);
      }

      public ESYASertifikaIptalTalep_kartSeriNo () : base()
      {
         elements = null;
      }
      ...
      /// populated.
      /// </summary>
      public ESYASertifikaIptalTalep_kartSeriNo (int numRecords) : base()
      {
      ...
      /// given the array.  
      /// </summary>
      public ESYASertifikaIptalTalep_kartSeriNo (Asn1OctetString[] elements_) : base()
      {
         elements = elements_;
      }
