...
namespace tr.gov.tubitak.uekae.esya.asn.esya {
   ...
   public class ESYAKartAnahtarlari : Asn1Type {
      public ESYAKartAnahtar[] elements;

      static ESYAKartAnahtarlari ()
      {
         Asn1Type.SetKey2 (_esyaValues._rtkey);
      }

      public ESYAKartAnahtarlari () : base()
      {
         elements = null;
      }
      ...
      /// populated.
      /// </summary>
      public ESYAKartAnahtarlari (int numRecords) : base()
      {
      ...
      /// given the array.  
      /// </summary>
      public ESYAKartAnahtarlari (ESYAKartAnahtar[] elements_) : base()
      {
         elements = elements_;
      }
         ...
         (Asn1BerDecodeBuffer buffer, bool explicitTagging, int implicitLength)
      {
         ...
         elements = new ESYAKartAnahtar [llist.Count];
