...
namespace tr.gov.tubitak.uekae.esya.asn.esya {
   ...
   public class ESYACardSerialNumber : Asn1OctetString {
      static ESYACardSerialNumber ()
      {
         Asn1Type.SetKey2 (_esyaValues._rtkey);
      }

      public ESYACardSerialNumber () : base()
      {
      }
      ...
      public ESYACardSerialNumber (byte[] data) : base (data)
      {
      }
      ...
      public ESYACardSerialNumber (string value_) : base (value_)
      {
      }
