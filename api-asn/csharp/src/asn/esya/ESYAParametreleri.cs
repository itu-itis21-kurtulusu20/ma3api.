...
namespace tr.gov.tubitak.uekae.esya.asn.esya {
   ...
   public class ESYAParametreleri : Asn1Type {
      public ESYAParametre[] elements;

      static ESYAParametreleri ()
      {
         Asn1Type.SetKey2 (_esyaValues._rtkey);
      }

      public ESYAParametreleri () : base()
      {
         elements = null;
      }
      ...
      /// populated.
      /// </summary>
      public ESYAParametreleri (int numRecords) : base()
      {
      ...
      /// given the array.  
      /// </summary>
      public ESYAParametreleri (ESYAParametre[] elements_) : base()
      {
         elements = elements_;
      }
         ...
         (Asn1BerDecodeBuffer buffer, bool explicitTagging, int implicitLength)
      {
         ...
         elements = new ESYAParametre [llist.Count];
