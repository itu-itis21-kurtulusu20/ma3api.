...
namespace tr.gov.tubitak.uekae.esya.asn.etsiqc {
   ...
   public class _etsiqcValues {
      public static readonly int[] id_etsi_qcs = { 0, 4, 0, 1862, 1 };
      public static readonly int[] id_etsi_qcs_QcCompliance = { 0, 4, 0, 1862, 1, 1 };
      public static readonly int[] id_etsi_qcs_QcLimitValue = { 0, 4, 0, 1862, 1, 2 };
      public static readonly int[] id_etsi_qcs_QcRetentionPeriod = { 0, 4, 0, 1862, 1, 3 };
