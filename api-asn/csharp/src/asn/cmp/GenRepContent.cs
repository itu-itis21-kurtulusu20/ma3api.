...
namespace tr.gov.tubitak.uekae.esya.asn.cmp {
   ...
   public class GenRepContent : Asn1Type {
      ...
      /// populated.
      /// </summary>
      public GenRepContent (int numRecords) : base()
      {
      ...
      /// given the array.  
      /// </summary>
      public GenRepContent (InfoTypeAndValue[] elements_) : base()
      {
         elements = elements_;
      }
