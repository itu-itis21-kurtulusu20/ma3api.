...
namespace tr.gov.tubitak.uekae.esya.asn.cmp {
   ...
   public class GenMsgContent : Asn1Type {
      ...
      /// populated.
      /// </summary>
      public GenMsgContent (int numRecords) : base()
      {
      ...
      /// given the array.  
      /// </summary>
      public GenMsgContent (InfoTypeAndValue[] elements_) : base()
      {
         elements = elements_;
      }
