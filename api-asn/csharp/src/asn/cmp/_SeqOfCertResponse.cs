...
namespace tr.gov.tubitak.uekae.esya.asn.cmp {
   ...
   public class _SeqOfCertResponse : Asn1Type {
      public CertResponse[] elements;

      static _SeqOfCertResponse ()
      {
         Asn1Type.SetKey2 (_cmpValues._rtkey);
      }

      public _SeqOfCertResponse () : base()
      {
         elements = null;
      }
      ...
      /// populated.
      /// </summary>
      public _SeqOfCertResponse (int numRecords) : base()
      {
      ...
      /// given the array.  
      /// </summary>
      public _SeqOfCertResponse (CertResponse[] elements_) : base()
      {
         elements = elements_;
      }
         ...
         (Asn1BerDecodeBuffer buffer, bool explicitTagging, int implicitLength)
      {
         ...
         elements = new CertResponse [llist.Count];
