...
namespace tr.gov.tubitak.uekae.esya.asn.cmp {
   ...
   public class PollRepContent : Asn1Type {
      ...
      /// populated.
      /// </summary>
      public PollRepContent (int numRecords) : base()
      {
      ...
      /// given the array.  
      /// </summary>
      public PollRepContent (PollRepContent_element[] elements_) : base()
      {
         elements = elements_;
      }
         ...
         (Asn1BerDecodeBuffer buffer, bool explicitTagging, int implicitLength)
      {
         ...
         elements = new PollRepContent_element [llist.Count];
