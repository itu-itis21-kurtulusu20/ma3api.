...
namespace tr.gov.tubitak.uekae.esya.asn.cmp {
   ...
   public class KeyRecRepContent_caCerts : Asn1Type {
      ...
      /// populated.
      /// </summary>
      public KeyRecRepContent_caCerts (int numRecords) : base()
      {
      ...
      /// given the array.  
      /// </summary>
      public KeyRecRepContent_caCerts (CMPCertificate[] elements_) : base()
      {
         elements = elements_;
      }
         ...
         (Asn1BerDecodeBuffer buffer, bool explicitTagging, int implicitLength)
      {
         ...
         elements = new CMPCertificate [llist.Count];
