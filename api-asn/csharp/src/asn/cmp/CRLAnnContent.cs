...
namespace tr.gov.tubitak.uekae.esya.asn.cmp {
   ...
   public class CRLAnnContent : Asn1Type {
      ...
      /// populated.
      /// </summary>
      public CRLAnnContent (int numRecords) : base()
      {
      ...
      /// given the array.  
      /// </summary>
      public CRLAnnContent (CertificateList[] elements_) : base()
      {
         elements = elements_;
      }
