...
namespace tr.gov.tubitak.uekae.esya.asn.cmp {
   ...
   public class SuppLangTagsValue : Asn1Type {
      public Asn1UTF8String[] elements;

      static SuppLangTagsValue ()
      {
         Asn1Type.SetKey2 (_cmpValues._rtkey);
      }

      public SuppLangTagsValue () : base()
      {
         elements = null;
      }
      ...
      /// populated.
      /// </summary>
      public SuppLangTagsValue (int numRecords) : base()
      {
      ...
      /// given the array.  
      /// </summary>
      public SuppLangTagsValue (Asn1UTF8String[] elements_) : base()
      {
         elements = elements_;
      }
         ...
         (Asn1BerDecodeBuffer buffer, bool explicitTagging, int implicitLength)
      {
         ...
         elements = new Asn1UTF8String [llist.Count];
