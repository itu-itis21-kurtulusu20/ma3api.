...
namespace tr.gov.tubitak.uekae.esya.asn.cmp {
   ...
   public class RevRepContent_crls : Asn1Type {
      public new static readonly Asn1Tag _TAG = new Asn1Tag (Asn1Tag.CTXT, Asn1Tag.CONS, 1);

      public CertificateList[] elements;

      static RevRepContent_crls ()
      {
         Asn1Type.SetKey2 (_cmpValues._rtkey);
      }

      public RevRepContent_crls () : base()
      {
         elements = null;
      }
      ...
      /// populated.
      /// </summary>
      public RevRepContent_crls (int numRecords) : base()
      {
         elements = new CertificateList [numRecords];
      }
      ...
      /// given the array.  
      /// </summary>
      public RevRepContent_crls (CertificateList[] elements_) : base()
      {
         elements = elements_;
      }
         ...
         (Asn1BerDecodeBuffer buffer, bool explicitTagging, int implicitLength)
      {
         ...
         CertificateList element;
         int elemLen = 0;

         while (!_context.Expired()) {
            element = new CertificateList();
            element.Decode (buffer, true, elemLen);
            llist.Add (element);
         }

         elements = new CertificateList [llist.Count];
