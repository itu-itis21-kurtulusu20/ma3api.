...
namespace tr.gov.tubitak.uekae.esya.asn.cmp {
   ...
   public class PKIMessage_extraCerts : Asn1Type {
      ...
      /// populated.
      /// </summary>
      public PKIMessage_extraCerts (int numRecords) : base()
      {
      ...
      /// given the array.  
      /// </summary>
      public PKIMessage_extraCerts (CMPCertificate[] elements_) : base()
      {
         elements = elements_;
      }
