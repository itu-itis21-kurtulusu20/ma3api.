...
namespace tr.gov.tubitak.uekae.esya.asn.cmp {
   ...
   public class CertConfirmContent : Asn1Type {
      public tr.gov.tubitak.uekae.esya.asn.cmp.CertStatus[] elements;

      static CertConfirmContent ()
      {
         Asn1Type.SetKey2 (_cmpValues._rtkey);
      }

      public CertConfirmContent () : base()
      {
         elements = null;
      }
      ...
      /// populated.
      /// </summary>
      public CertConfirmContent (int numRecords) : base()
      {
         elements = new tr.gov.tubitak.uekae.esya.asn.cmp.CertStatus [numRecords];
      }
      ...
      /// given the array.  
      /// </summary>
      public CertConfirmContent (tr.gov.tubitak.uekae.esya.asn.cmp.CertStatus[] elements_) : base()
      {
         elements = elements_;
      }
         ...
         (Asn1BerDecodeBuffer buffer, bool explicitTagging, int implicitLength)
      {
         ...
         while (!_context.Expired()) {
            element = new CertStatus();
            element.Decode (buffer, true, elemLen);
            llist.Add (element);
         }

         elements = new CertStatus [llist.Count];
