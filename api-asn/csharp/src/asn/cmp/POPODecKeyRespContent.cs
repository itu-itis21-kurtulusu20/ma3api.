...
namespace tr.gov.tubitak.uekae.esya.asn.cmp {
   ...
   public class POPODecKeyRespContent : Asn1Type {
      ...
      public POPODecKeyRespContent () : base()
      {
         elements = null;
      }
      ...
      /// populated.
      /// </summary>
      public POPODecKeyRespContent (int numRecords) : base()
      {
      ...
      /// given the array.  
      /// </summary>
      public POPODecKeyRespContent (Asn1Integer[] elements_) : base()
      {
         elements = elements_;
      }
