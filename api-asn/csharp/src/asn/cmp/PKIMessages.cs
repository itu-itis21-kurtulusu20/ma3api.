...
namespace tr.gov.tubitak.uekae.esya.asn.cmp {
   ...
   public class PKIMessages : Asn1Type {
      ...
      /// populated.
      /// </summary>
      public PKIMessages (int numRecords) : base()
      {
      ...
      /// given the array.  
      /// </summary>
      public PKIMessages (PKIMessage[] elements_) : base()
      {
         elements = elements_;
      }
         ...
         (Asn1BerDecodeBuffer buffer, bool explicitTagging, int implicitLength)
      {
         ...
         elements = new PKIMessage [llist.Count];
