...
namespace tr.gov.tubitak.uekae.esya.asn.cmp {
   ...
   public class PKIFailureInfo : Asn1BitString {
      ...
      public static readonly int badMessageCheck = 1;
      public static readonly int badRequest = 2;
      public static readonly int badTime = 3;
      public static readonly int badCertId = 4;
      public static readonly int badDataFormat = 5;
      public static readonly int wrongAuthority = 6;
      public static readonly int incorrectData = 7;
      public static readonly int missingTimeStamp = 8;
      public static readonly int badPOP = 9;
      public static readonly int certRevoked = 10;
      public static readonly int certConfirmed = 11;
      public static readonly int wrongIntegrity = 12;
      public static readonly int badRecipientNonce = 13;
      ...
      public static readonly int badSenderNonce = 18;
      public static readonly int badCertTemplate = 19;
      public static readonly int signerNotTrusted = 20;
      public static readonly int transactionIdInUse = 21;
      public static readonly int unsupportedVersion = 22;
      public static readonly int notAuthorized = 23;
      public static readonly int systemUnavail = 24;
      public static readonly int systemFailure = 25;
      public static readonly int duplicateCertReq = 26;
