...
namespace tr.gov.tubitak.uekae.esya.asn.cmp {
   ...
   public class PollReqContent : Asn1Type {
      ...
      /// populated.
      /// </summary>
      public PollReqContent (int numRecords) : base()
      {
      ...
      /// given the array.  
      /// </summary>
      public PollReqContent (PollReqContent_element[] elements_) : base()
      {
         elements = elements_;
      }
         ...
         (Asn1BerDecodeBuffer buffer, bool explicitTagging, int implicitLength)
      {
         ...
         elements = new PollReqContent_element [llist.Count];
