...
namespace tr.gov.tubitak.uekae.esya.asn.cmp {
   ...
   public class CertRepMessage_caPubs : Asn1Type {
      ...
      /// populated.
      /// </summary>
      public CertRepMessage_caPubs (int numRecords) : base()
      {
      ...
      /// given the array.  
      /// </summary>
      public CertRepMessage_caPubs (CMPCertificate[] elements_) : base()
      {
         elements = elements_;
      }
