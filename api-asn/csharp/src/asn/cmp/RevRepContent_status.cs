...
namespace tr.gov.tubitak.uekae.esya.asn.cmp {
   ...
   public class RevRepContent_status : Asn1Type {
      public tr.gov.tubitak.uekae.esya.asn.cmp.PKIStatusInfo[] elements;

      static RevRepContent_status ()
      {
         Asn1Type.SetKey2 (_cmpValues._rtkey);
      }

      public RevRepContent_status () : base()
      {
         elements = null;
      }
      ...
      /// populated.
      /// </summary>
      public RevRepContent_status (int numRecords) : base()
      {
         elements = new tr.gov.tubitak.uekae.esya.asn.cmp.PKIStatusInfo [numRecords];
      }
      ...
      /// given the array.  
      /// </summary>
      public RevRepContent_status (tr.gov.tubitak.uekae.esya.asn.cmp.PKIStatusInfo[] elements_) : base()
      {
         elements = elements_;
      }
         ...
         (Asn1BerDecodeBuffer buffer, bool explicitTagging, int implicitLength)
      {
         ...
         elements = new PKIStatusInfo [llist.Count];
