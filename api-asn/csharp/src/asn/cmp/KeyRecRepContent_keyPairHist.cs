...
namespace tr.gov.tubitak.uekae.esya.asn.cmp {
   ...
   public class KeyRecRepContent_keyPairHist : Asn1Type {
      public new static readonly Asn1Tag _TAG = new Asn1Tag (Asn1Tag.CTXT, Asn1Tag.CONS, 2);

      public CertifiedKeyPair[] elements;

      static KeyRecRepContent_keyPairHist ()
      {
         Asn1Type.SetKey2 (_cmpValues._rtkey);
      }

      public KeyRecRepContent_keyPairHist () : base()
      {
         elements = null;
      }
      ...
      /// populated.
      /// </summary>
      public KeyRecRepContent_keyPairHist (int numRecords) : base()
      {
      ...
      /// given the array.  
      /// </summary>
      public KeyRecRepContent_keyPairHist (CertifiedKeyPair[] elements_) : base()
      {
         elements = elements_;
      }
         ...
         (Asn1BerDecodeBuffer buffer, bool explicitTagging, int implicitLength)
      {
         ...
         elements = new CertifiedKeyPair [llist.Count];
