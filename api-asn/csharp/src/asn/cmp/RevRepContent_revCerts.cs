...
namespace tr.gov.tubitak.uekae.esya.asn.cmp {
   ...
   public class RevRepContent_revCerts : Asn1Type {
      public new static readonly Asn1Tag _TAG = new Asn1Tag (Asn1Tag.CTXT, Asn1Tag.CONS, 0);

      public CertId[] elements;

      static RevRepContent_revCerts ()
      {
         Asn1Type.SetKey2 (_cmpValues._rtkey);
      }

      public RevRepContent_revCerts () : base()
      {
         elements = null;
      }
      ...
      /// populated.
      /// </summary>
      public RevRepContent_revCerts (int numRecords) : base()
      {
      ...
      /// given the array.  
      /// </summary>
      public RevRepContent_revCerts (CertId[] elements_) : base()
      {
         elements = elements_;
      }
         ...
         (Asn1BerDecodeBuffer buffer, bool explicitTagging, int implicitLength)
      {
         ...
         elements = new CertId [llist.Count];
