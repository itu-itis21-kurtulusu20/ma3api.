...
namespace tr.gov.tubitak.uekae.esya.asn.cmp {
   ...
   public class POPODecKeyChallContent : Asn1Type {
      ...
      public POPODecKeyChallContent () : base()
      {
         elements = null;
      }
      ...
      /// populated.
      /// </summary>
      public POPODecKeyChallContent (int numRecords) : base()
      {
      ...
      /// given the array.  
      /// </summary>
      public POPODecKeyChallContent (Challenge[] elements_) : base()
      {
         elements = elements_;
      }
         ...
         (Asn1BerDecodeBuffer buffer, bool explicitTagging, int implicitLength)
      {
         ...
         elements = new Challenge [llist.Count];
