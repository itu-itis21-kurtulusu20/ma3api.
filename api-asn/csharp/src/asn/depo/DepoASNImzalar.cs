...
namespace tr.gov.tubitak.uekae.esya.asn.depo {
   ...
   public class DepoASNImzalar : Asn1Type {
      public DepoASNImza[] elements;

      static DepoASNImzalar ()
      {
         Asn1Type.SetKey2 (_depoValues._rtkey);
      }

      public DepoASNImzalar () : base()
      {
         elements = null;
      }
      ...
      /// populated.
      /// </summary>
      public DepoASNImzalar (int numRecords) : base()
      {
      ...
      /// given the array.  
      /// </summary>
      public DepoASNImzalar (DepoASNImza[] elements_) : base()
      {
         elements = elements_;
      }
         ...
         (Asn1BerDecodeBuffer buffer, bool explicitTagging, int implicitLength)
      {
         ...
         elements = new DepoASNImza [llist.Count];
