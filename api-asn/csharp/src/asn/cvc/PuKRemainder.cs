...
namespace tr.gov.tubitak.uekae.esya.asn.cvc {
   ...
   public class PuKRemainder : Asn1OctetString {
      public new static readonly Asn1Tag _TAG = new Asn1Tag (Asn1Tag.APPL, Asn1Tag.PRIM, 56);
      ...
      public PuKRemainder (byte[] data) : base (data)
      {
      }
      ...
      public PuKRemainder (string value_) : base (value_)
      {
      }
