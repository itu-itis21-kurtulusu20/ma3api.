...
namespace tr.gov.tubitak.uekae.esya.asn.cvc {
   ...
   public class Car : Asn1OctetString {
      public new static readonly Asn1Tag _TAG = new Asn1Tag (Asn1Tag.APPL, Asn1Tag.PRIM, 2);
      ...
      public Car (byte[] data) : base (data)
      {
      }
      ...
      public Car (byte[] data, int offset, int nbytes) :
      ...
      public Car (string value_) : base (value_)
      {
      }
