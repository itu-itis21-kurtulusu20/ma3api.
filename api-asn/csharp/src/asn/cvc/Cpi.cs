...
namespace tr.gov.tubitak.uekae.esya.asn.cvc {
   ...
   public class Cpi : Asn1OctetString {
      public new static readonly Asn1Tag _TAG = new Asn1Tag (Asn1Tag.APPL, Asn1Tag.PRIM, 41);
      ...
      public Cpi (byte[] data) : base (data)
      {
      }
      ...
      public Cpi (string value_) : base (value_)
      {
      }
