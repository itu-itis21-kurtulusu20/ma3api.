...
namespace tr.gov.tubitak.uekae.esya.asn.cvc {
   ...
   public class Exponent : Asn1OctetString {
      public new static readonly Asn1Tag _TAG = new Asn1Tag (Asn1Tag.CTXT, Asn1Tag.PRIM, 2);
      ...
      public Exponent (byte[] data) : base (data)
      {
      }
      ...
      public Exponent (string value_) : base (value_)
      {
      }
