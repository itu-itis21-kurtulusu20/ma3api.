...
namespace tr.gov.tubitak.uekae.esya.asn.cvc {
   ...
   public class AlgId : Asn1OctetString {
      public new static readonly Asn1Tag _TAG = new Asn1Tag (Asn1Tag.UNIV, Asn1Tag.PRIM, 6);
      ...
      public AlgId (byte[] data) : base (data)
      {
      }
      ...
      public AlgId (string value_) : base (value_)
      {
      }
