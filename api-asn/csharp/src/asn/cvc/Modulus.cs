...
namespace tr.gov.tubitak.uekae.esya.asn.cvc {
   ...
   public class Modulus : Asn1OctetString {
      public new static readonly Asn1Tag _TAG = new Asn1Tag (Asn1Tag.CTXT, Asn1Tag.PRIM, 1);
      ...
      public Modulus (byte[] data) : base (data)
      {
      }
      ...
      public Modulus (byte[] data, int offset, int nbytes) :
      ...
      public Modulus (string value_) : base (value_)
      {
      }
