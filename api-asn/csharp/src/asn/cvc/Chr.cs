...
namespace tr.gov.tubitak.uekae.esya.asn.cvc {
   ...
   public class Chr : Asn1OctetString {
      public new static readonly Asn1Tag _TAG = new Asn1Tag (Asn1Tag.APPL, Asn1Tag.PRIM, 32);
      ...
      public Chr (byte[] data) : base (data)
      {
      }
      ...
      public Chr (string value_) : base (value_)
      {
      }
