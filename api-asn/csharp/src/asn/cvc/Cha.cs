...
namespace tr.gov.tubitak.uekae.esya.asn.cvc {
   ...
   public class Cha : Asn1OctetString {
      public new static readonly Asn1Tag _TAG = new Asn1Tag (Asn1Tag.APPL, Asn1Tag.PRIM, 76);
      ...
      public Cha (byte[] data) : base (data)
      {
      }
      ...
      public Cha (string value_) : base (value_)
      {
      }
