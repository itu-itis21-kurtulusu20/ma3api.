...
namespace tr.gov.tubitak.uekae.esya.asn.cvc {
   ...
   public class Ced : Asn1OctetString {
      public new static readonly Asn1Tag _TAG = new Asn1Tag (Asn1Tag.APPL, Asn1Tag.PRIM, 37);
      ...
      public Ced (byte[] data) : base (data)
      {
      }
      ...
      public Ced (string value_) : base (value_)
      {
      }
