...
namespace tr.gov.tubitak.uekae.esya.asn.cvc {
   ...
   public class Cxd : Asn1OctetString {
      public new static readonly Asn1Tag _TAG = new Asn1Tag (Asn1Tag.APPL, Asn1Tag.PRIM, 36);
      ...
      public Cxd (byte[] data) : base (data)
      {
      }
      ...
      public Cxd (string value_) : base (value_)
      {
      }
