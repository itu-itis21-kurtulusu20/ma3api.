...
namespace tr.gov.tubitak.uekae.esya.asn.crmf {
   ...
   public class CertReqMessages : Asn1Type {
      ...
      /// populated.
      /// </summary>
      public CertReqMessages (int numRecords) : base()
      {
      ...
      /// given the array.  
      /// </summary>
      public CertReqMessages (CertReqMsg[] elements_) : base()
      {
         elements = elements_;
      }
         ...
         (Asn1BerDecodeBuffer buffer, bool explicitTagging, int implicitLength)
      {
         ...
         elements = new CertReqMsg [llist.Count];
