...
namespace tr.gov.tubitak.uekae.esya.asn.crmf {
   ...
   public class PKIPublicationInfo_pubInfos : Asn1Type {
      public SinglePubInfo[] elements;

      static PKIPublicationInfo_pubInfos ()
      {
         Asn1Type.SetKey2 (_crmfValues._rtkey);
      }

      public PKIPublicationInfo_pubInfos () : base()
      {
         elements = null;
      }
      ...
      /// populated.
      /// </summary>
      public PKIPublicationInfo_pubInfos (int numRecords) : base()
      {
      ...
      /// given the array.  
      /// </summary>
      public PKIPublicationInfo_pubInfos (SinglePubInfo[] elements_) : base()
      {
         elements = elements_;
      }
         ...
         (Asn1BerDecodeBuffer buffer, bool explicitTagging, int implicitLength)
      {
         ...
         elements = new SinglePubInfo [llist.Count];
