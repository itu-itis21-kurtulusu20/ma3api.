...
int asn1PrtToStrm_CMS_ESSCertIDv2 (OSCTXT *pctxt, 
   const char* name, const ASN1T_CMS_ESSCertIDv2* pvalue)
{
   ...
   if (pvalue->m.issuerSerialPresent) {
      asn1PrtToStrm_PKCS7_IssuerAndSerialNumber (pctxt, "issuerSerial", &pvalue->issuerSerial);
   }
...
int ASN1C_CMS_ESSCertIDv2::toStream (const char* name)

{
   asn1PrtToStrm_CMS_ESSCertIDv2 (getCtxtPtr(), name, &msgData);
   return 0;
}

int ASN1C_CMS_ESSCertIDv2::setPrintStream
(rtxPrintCallback strmCallback, void * pStrmInfo)
