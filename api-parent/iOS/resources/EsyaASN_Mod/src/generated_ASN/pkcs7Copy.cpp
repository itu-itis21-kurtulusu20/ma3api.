...
void asn1Copy_PKCS7_ESSCertIDv2 (OSCTXT* pctxt, 
...
ASN1C_PKCS7_ESSCertIDv2::ASN1C_PKCS7_ESSCertIDv2 (ASN1C_PKCS7_ESSCertIDv2& original) :
   ASN1CType(original), msgData(original.getCopy())
{
}

ASN1T_PKCS7_ESSCertIDv2::ASN1T_PKCS7_ESSCertIDv2 (ASN1C_PKCS7_ESSCertIDv2& original)
{
   original.getCopy (this);
}

ASN1T_PKCS7_ESSCertIDv2& ASN1C_PKCS7_ESSCertIDv2::getCopy (ASN1T_PKCS7_ESSCertIDv2* pDstData)
{
   if (&msgData == pDstData) return *pDstData;
   ...
   if (pDstData == 0) {
      pDstData = rtxMemAllocType (pctxt, ASN1T_PKCS7_ESSCertIDv2);
      new (pDstData) ASN1T_PKCS7_ESSCertIDv2;
   }

   asn1Copy_PKCS7_ESSCertIDv2 (pctxt, &msgData, pDstData);
...
ASN1T_PKCS7_ESSCertIDv2* ASN1C_PKCS7_ESSCertIDv2::newCopy ()
{
   OSCTXT* pctxt = getCtxtPtr();
   ASN1T_PKCS7_ESSCertIDv2* pDstData = new ASN1T_PKCS7_ESSCertIDv2;
...
void asn1Copy_PKCS7__SeqOfPKCS7_ESSCertIDv2 (OSCTXT* pctxt, 
   ...
   ASN1T_PKCS7__SeqOfPKCS7_ESSCertIDv2* pDstValue)
{
   ...
   {
      OSUINT32 xx1;
      ASN1T_PKCS7_ESSCertIDv2* pSrcData;
      OSRTDListNode* pnode;

      rtxDListInit (pDstValue);
      pnode = pSrcValue->head;
      for (xx1 = 0; xx1 < pSrcValue->count; xx1++) {
         ASN1T_PKCS7_ESSCertIDv2* pDstData = rtxMemAllocTypeZ (pctxt, ASN1T_PKCS7_ESSCertIDv2);
         pSrcData = (ASN1T_PKCS7_ESSCertIDv2*) pnode->data;

         asn1Copy_PKCS7_ESSCertIDv2 (pctxt, pSrcData, pDstData);
...
ASN1C_PKCS7__SeqOfPKCS7_ESSCertIDv2::ASN1C_PKCS7__SeqOfPKCS7_ESSCertIDv2 (ASN1C_PKCS7__SeqOfPKCS7_ESSCertIDv2& original) :
   ASN1CSeqOfList(*original.mpContext, original.getCopy()), msgData (*(ASN1T_PKCS7__SeqOfPKCS7_ESSCertIDv2*)pList)
{
}

ASN1C_PKCS7__SeqOfPKCS7_ESSCertIDv2& ASN1C_PKCS7__SeqOfPKCS7_ESSCertIDv2::operator= (ASN1C_PKCS7__SeqOfPKCS7_ESSCertIDv2& srcData)
{
   clear ();
   asn1Copy_PKCS7__SeqOfPKCS7_ESSCertIDv2 (getCtxtPtr(), &srcData.msgData, &msgData);
   return *this;
}

ASN1T_PKCS7__SeqOfPKCS7_ESSCertIDv2& ASN1C_PKCS7__SeqOfPKCS7_ESSCertIDv2::getCopy (ASN1T_PKCS7__SeqOfPKCS7_ESSCertIDv2* pDstData)
{
   if (&msgData == pDstData) return *pDstData;
   ...
   if (pDstData == 0) {
      pDstData = rtxMemAllocType (pctxt, ASN1T_PKCS7__SeqOfPKCS7_ESSCertIDv2);
      new (pDstData) ASN1T_PKCS7__SeqOfPKCS7_ESSCertIDv2;
   }

   asn1Copy_PKCS7__SeqOfPKCS7_ESSCertIDv2 (pctxt, &msgData, pDstData);
...
ASN1T_PKCS7__SeqOfPKCS7_ESSCertIDv2* ASN1C_PKCS7__SeqOfPKCS7_ESSCertIDv2::newCopy ()
{
   OSCTXT* pctxt = getCtxtPtr();
   ASN1T_PKCS7__SeqOfPKCS7_ESSCertIDv2* pDstData = new ASN1T_PKCS7__SeqOfPKCS7_ESSCertIDv2;
...
void asn1Copy_PKCS7_SigningCertificateV2 (OSCTXT* pctxt, 
   ...
   ASN1T_PKCS7_SigningCertificateV2* pDstValue)
{
   ...
   OSCRTLMEMCPY (&pDstValue->m, &pSrcValue->m, sizeof (pDstValue->m));
   asn1Copy_PKCS7__SeqOfPKCS7_ESSCertIDv2 (pctxt, &pSrcValue->certs, &pDstValue->certs);
...
ASN1C_PKCS7_SigningCertificateV2::ASN1C_PKCS7_SigningCertificateV2 (ASN1C_PKCS7_SigningCertificateV2& original) :
   ASN1CType(original), msgData(original.getCopy())
{
}

ASN1T_PKCS7_SigningCertificateV2::ASN1T_PKCS7_SigningCertificateV2 (ASN1C_PKCS7_SigningCertificateV2& original)
{
   original.getCopy (this);
}

ASN1T_PKCS7_SigningCertificateV2& ASN1C_PKCS7_SigningCertificateV2::getCopy (ASN1T_PKCS7_SigningCertificateV2* pDstData)
{
   if (&msgData == pDstData) return *pDstData;
   ...
   if (pDstData == 0) {
      pDstData = rtxMemAllocType (pctxt, ASN1T_PKCS7_SigningCertificateV2);
      new (pDstData) ASN1T_PKCS7_SigningCertificateV2;
   }

   asn1Copy_PKCS7_SigningCertificateV2 (pctxt, &msgData, pDstData);
...
ASN1T_PKCS7_SigningCertificateV2* ASN1C_PKCS7_SigningCertificateV2::newCopy ()
{
   OSCTXT* pctxt = getCtxtPtr();
   ASN1T_PKCS7_SigningCertificateV2* pDstData = new ASN1T_PKCS7_SigningCertificateV2;
