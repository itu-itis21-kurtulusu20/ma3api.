...
void asn1Print_PKCS7_ESSCertIDv2 
...
void ASN1C_PKCS7_ESSCertIDv2::Print (const char* name)
{
   asn1Print_PKCS7_ESSCertIDv2 (name, &msgData);
}

void asn1Print_PKCS7__SeqOfPKCS7_ESSCertIDv2 
   (const char* name, const ASN1T_PKCS7__SeqOfPKCS7_ESSCertIDv2* pvalue)
{
   ...
   for (xx1 = 0; xx1 < pvalue->count; xx1++) {
      ...
      rtxUIntToCharStr (xx1, numbuf, sizeof(numbuf), 0);
      rtxStrJoin (namebuf, sizeof(namebuf), name, "[", numbuf, "]", 0);
      asn1Print_PKCS7_ESSCertIDv2 (namebuf, pdata0);
      pnode = pnode->next;
   }
}

void ASN1C_PKCS7__SeqOfPKCS7_ESSCertIDv2::Print (const char* name)
{
   asn1Print_PKCS7__SeqOfPKCS7_ESSCertIDv2 (name, &msgData);
}

void asn1Print_PKCS7_SigningCertificateV2 
   (const char* name, const ASN1T_PKCS7_SigningCertificateV2* pvalue)
{
   rtxPrintOpenBrace (name);

   asn1Print_PKCS7__SeqOfPKCS7_ESSCertIDv2 ("certs", &pvalue->certs);
...
void ASN1C_PKCS7_SigningCertificateV2::Print (const char* name)
{
   asn1Print_PKCS7_SigningCertificateV2 (name, &msgData);
}
