...
ASN1OBJID PKCS7_id_aa_signingCertificateV2 = {
   9,
...
ASN1T_PKCS7_ESSCertIDv2* new_ASN1T_PKCS7_ESSCertIDv2 (ASN1CType& ccobj)
{
   void* pdata = ccobj.memAlloc (sizeof(ASN1T_PKCS7_ESSCertIDv2));
   if (0 == pdata) return 0;
   else return new (pdata) ASN1T_PKCS7_ESSCertIDv2;
}

ASN1C_PKCS7_ESSCertIDv2::ASN1C_PKCS7_ESSCertIDv2
    (ASN1T_PKCS7_ESSCertIDv2& data) : ASN1CType(), msgData(data)
{
   setRunTimeKey (_rtkey, sizeof(_rtkey));
}

ASN1C_PKCS7_ESSCertIDv2::ASN1C_PKCS7_ESSCertIDv2 (OSRTMessageBufferIF& msgBuf
   , ASN1T_PKCS7_ESSCertIDv2& data) : ASN1CType(msgBuf), msgData(data)
{
   setRunTimeKey (_rtkey, sizeof(_rtkey));
}
ASN1C_PKCS7_ESSCertIDv2::ASN1C_PKCS7_ESSCertIDv2 (OSRTContext &context
   , ASN1T_PKCS7_ESSCertIDv2& data) : ASN1CType(context), msgData(data)
{
   setRunTimeKey (_rtkey, sizeof(_rtkey));
}


ASN1T_PKCS7_ESSCertIDv2::ASN1T_PKCS7_ESSCertIDv2 ()
{
...
ASN1T_PKCS7_ESSCertIDv2::~ASN1T_PKCS7_ESSCertIDv2 ()
{
   OSCTXT* pctxt = mpContext.getCtxtPtr();
   if (pctxt != 0 && !rtxMemHeapIsEmpty (pctxt)) {
      asn1Free_PKCS7_ESSCertIDv2 (pctxt, this);
   }
}

int ASN1C_PKCS7_ESSCertIDv2::EncodeTo (OSRTMessageBufferIF& msgBuf)
{
   int stat = setMsgBuf (msgBuf, TRUE);
   if (stat != 0) return (stat);

   return asn1E_PKCS7_ESSCertIDv2 (msgBuf.getCtxtPtr(), &msgData, ASN1EXPL);
}

int ASN1C_PKCS7_ESSCertIDv2::DecodeFrom (OSRTMessageBufferIF& msgBuf)
{
   int stat = setMsgBuf (msgBuf, TRUE);
   if (stat != 0) return (stat);

   new (&msgData) ASN1T_PKCS7_ESSCertIDv2;
   msgData.setContext (msgBuf.getContext());
   return asn1D_PKCS7_ESSCertIDv2 (msgBuf.getCtxtPtr(), &msgData, ASN1EXPL, 0);
}

void asn1Init_PKCS7_ESSCertIDv2 (ASN1T_PKCS7_ESSCertIDv2* pvalue)
{
   if (0 == pvalue) return;
   new (pvalue) ASN1T_PKCS7_ESSCertIDv2;
}

void asn1Free_PKCS7_ESSCertIDv2 (OSCTXT *pctxt, 
...
void ASN1C_PKCS7_ESSCertIDv2::MemFree ()
{
   asn1Free_PKCS7_ESSCertIDv2 (getCtxtPtr(), &msgData);
}

ASN1C_PKCS7__SeqOfPKCS7_ESSCertIDv2::ASN1C_PKCS7__SeqOfPKCS7_ESSCertIDv2
    (ASN1T_PKCS7__SeqOfPKCS7_ESSCertIDv2& data) : ASN1CSeqOfList(data)
   , msgData(data)
{
   setRunTimeKey (_rtkey, sizeof(_rtkey));
}
...
ASN1C_PKCS7__SeqOfPKCS7_ESSCertIDv2::ASN1C_PKCS7__SeqOfPKCS7_ESSCertIDv2 (
   OSRTMessageBufferIF& msgBuf, ASN1T_PKCS7__SeqOfPKCS7_ESSCertIDv2& data) : 
   ASN1CSeqOfList(msgBuf, data), msgData(data)
{
   setRunTimeKey (_rtkey, sizeof(_rtkey));
}
ASN1C_PKCS7__SeqOfPKCS7_ESSCertIDv2::ASN1C_PKCS7__SeqOfPKCS7_ESSCertIDv2 (
   OSRTContext &context, ASN1T_PKCS7__SeqOfPKCS7_ESSCertIDv2& data) : 
   ASN1CSeqOfList(context, data), msgData(data)
{
   setRunTimeKey (_rtkey, sizeof(_rtkey));
}
...
void ASN1C_PKCS7__SeqOfPKCS7_ESSCertIDv2::Append (ASN1T_PKCS7_ESSCertIDv2* elem)
{
   append ((void*)elem);
}

ASN1T_PKCS7_ESSCertIDv2* ASN1C_PKCS7__SeqOfPKCS7_ESSCertIDv2::NewElement ()
{
   void* pdata = memAlloc (sizeof(ASN1T_PKCS7_ESSCertIDv2));

   if (0 == pdata) return 0;
   else return new (pdata) ASN1T_PKCS7_ESSCertIDv2;
}

ASN1T_PKCS7_ESSCertIDv2* ASN1C_PKCS7__SeqOfPKCS7_ESSCertIDv2::AppendNewElement ()
{
   ASN1T_PKCS7_ESSCertIDv2* pdata = NewElement();
   if (0 != pdata) {
      Append (pdata);
   }
   return pdata;
...
ASN1T_PKCS7__SeqOfPKCS7_ESSCertIDv2::~ASN1T_PKCS7__SeqOfPKCS7_ESSCertIDv2 ()
{
   OSCTXT* pctxt = mpContext.getCtxtPtr();
   if (pctxt != 0 && !rtxMemHeapIsEmpty (pctxt)) {
      asn1Free_PKCS7__SeqOfPKCS7_ESSCertIDv2 (pctxt, this);
   }
}

int ASN1C_PKCS7__SeqOfPKCS7_ESSCertIDv2::EncodeTo (OSRTMessageBufferIF& msgBuf)
{
   int stat = setMsgBuf (msgBuf, TRUE);
   if (stat != 0) return (stat);

   return asn1E_PKCS7__SeqOfPKCS7_ESSCertIDv2 (msgBuf.getCtxtPtr(), &msgData, ASN1EXPL);
}

int ASN1C_PKCS7__SeqOfPKCS7_ESSCertIDv2::DecodeFrom (OSRTMessageBufferIF& msgBuf)
{
   int stat = setMsgBuf (msgBuf, TRUE);
   if (stat != 0) return (stat);

   new (&msgData) ASN1T_PKCS7__SeqOfPKCS7_ESSCertIDv2;
   msgData.setContext (msgBuf.getContext());
   return asn1D_PKCS7__SeqOfPKCS7_ESSCertIDv2 (msgBuf.getCtxtPtr(), &msgData, ASN1EXPL, 0);
}

void asn1Init_PKCS7__SeqOfPKCS7_ESSCertIDv2 (
   ASN1T_PKCS7__SeqOfPKCS7_ESSCertIDv2* pvalue)
{
   if (0 == pvalue) return;
   new (pvalue) ASN1T_PKCS7__SeqOfPKCS7_ESSCertIDv2;
   rtxDListFastInit (pvalue);
}

void asn1Free_PKCS7__SeqOfPKCS7_ESSCertIDv2 (OSCTXT *pctxt, 
   ASN1T_PKCS7__SeqOfPKCS7_ESSCertIDv2* pvalue)
{
   if (0 == pvalue) return;
   ...
   while (0 != pnode) {
      ...
      asn1Free_PKCS7_ESSCertIDv2 (pctxt, pdata);
      pnode = pnode->next;
   }
   rtxDListFreeAll (pctxt, pvalue);
   }
...
void ASN1C_PKCS7__SeqOfPKCS7_ESSCertIDv2::MemFree ()
{
   asn1Free_PKCS7__SeqOfPKCS7_ESSCertIDv2 (getCtxtPtr(), &msgData);
}

ASN1T_PKCS7_SigningCertificateV2* 
   new_ASN1T_PKCS7_SigningCertificateV2 (ASN1CType& ccobj)
{
   void* pdata = ccobj.memAlloc (sizeof(ASN1T_PKCS7_SigningCertificateV2));
   if (0 == pdata) return 0;
   else return new (pdata) ASN1T_PKCS7_SigningCertificateV2;
}

ASN1C_PKCS7_SigningCertificateV2::ASN1C_PKCS7_SigningCertificateV2
    (ASN1T_PKCS7_SigningCertificateV2& data) : ASN1CType(), msgData(data)
{
   setRunTimeKey (_rtkey, sizeof(_rtkey));
}

ASN1C_PKCS7_SigningCertificateV2::ASN1C_PKCS7_SigningCertificateV2 (
   OSRTMessageBufferIF& msgBuf, ASN1T_PKCS7_SigningCertificateV2& data) : 
   ASN1CType(msgBuf), msgData(data)
{
   setRunTimeKey (_rtkey, sizeof(_rtkey));
}
ASN1C_PKCS7_SigningCertificateV2::ASN1C_PKCS7_SigningCertificateV2 (
   OSRTContext &context, ASN1T_PKCS7_SigningCertificateV2& data) : 
   ASN1CType(context), msgData(data)
{
   setRunTimeKey (_rtkey, sizeof(_rtkey));
}
...
ASN1T_PKCS7_SigningCertificateV2::ASN1T_PKCS7_SigningCertificateV2 ()
{
   m.policiesPresent = 0;
}
...
ASN1T_PKCS7_SigningCertificateV2::~ASN1T_PKCS7_SigningCertificateV2 ()
{
   OSCTXT* pctxt = mpContext.getCtxtPtr();
   if (pctxt != 0 && !rtxMemHeapIsEmpty (pctxt)) {
      asn1Free_PKCS7_SigningCertificateV2 (pctxt, this);
   }
}

int ASN1C_PKCS7_SigningCertificateV2::EncodeTo (OSRTMessageBufferIF& msgBuf)
{
   int stat = setMsgBuf (msgBuf, TRUE);
   if (stat != 0) return (stat);

   return asn1E_PKCS7_SigningCertificateV2 (msgBuf.getCtxtPtr(), &msgData, ASN1EXPL);
}

int ASN1C_PKCS7_SigningCertificateV2::DecodeFrom (OSRTMessageBufferIF& msgBuf)
{
   int stat = setMsgBuf (msgBuf, TRUE);
   if (stat != 0) return (stat);

   new (&msgData) ASN1T_PKCS7_SigningCertificateV2;
   msgData.setContext (msgBuf.getContext());
   return asn1D_PKCS7_SigningCertificateV2 (msgBuf.getCtxtPtr(), &msgData, ASN1EXPL, 0);
}

void asn1Init_PKCS7_SigningCertificateV2 (
   ASN1T_PKCS7_SigningCertificateV2* pvalue)
{
   if (0 == pvalue) return;
   new (pvalue) ASN1T_PKCS7_SigningCertificateV2;
}

void asn1Free_PKCS7_SigningCertificateV2 (OSCTXT *pctxt, 
   ASN1T_PKCS7_SigningCertificateV2* pvalue)
{
   if (0 == pvalue) return;
   asn1Free_PKCS7__SeqOfPKCS7_ESSCertIDv2 (pctxt, &pvalue->certs);
   if (pvalue->m.policiesPresent) {
      asn1Free_PKCS7__SeqOfPKCS7_PolicyInformation (pctxt, &pvalue->policies);
   }
}

void ASN1C_PKCS7_SigningCertificateV2::MemFree ()
{
   asn1Free_PKCS7_SigningCertificateV2 (getCtxtPtr(), &msgData);
}
