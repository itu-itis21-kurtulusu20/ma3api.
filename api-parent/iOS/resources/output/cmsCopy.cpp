...
void asn1Copy_CMS_ESSCertIDv2 (OSCTXT* pctxt, 
   ASN1T_CMS_ESSCertIDv2* pSrcValue, ASN1T_CMS_ESSCertIDv2* pDstValue)
{
   ...
   if (pSrcValue->m.issuerSerialPresent) {
      asn1Copy_PKCS7_IssuerAndSerialNumber (pctxt, &pSrcValue->issuerSerial, &pDstValue->issuerSerial);
   }

}

ASN1C_CMS_ESSCertIDv2::ASN1C_CMS_ESSCertIDv2 (ASN1C_CMS_ESSCertIDv2& original) :
   ASN1CType(original), msgData(original.getCopy())
{
}

ASN1T_CMS_ESSCertIDv2::ASN1T_CMS_ESSCertIDv2 (ASN1C_CMS_ESSCertIDv2& original)
{
   original.getCopy (this);
}

ASN1T_CMS_ESSCertIDv2& ASN1C_CMS_ESSCertIDv2::getCopy (ASN1T_CMS_ESSCertIDv2* pDstData)
{
   if (&msgData == pDstData) return *pDstData;
   ...
   if (pDstData == 0) {
      pDstData = rtxMemAllocType (pctxt, ASN1T_CMS_ESSCertIDv2);
      new (pDstData) ASN1T_CMS_ESSCertIDv2;
   }

   asn1Copy_CMS_ESSCertIDv2 (pctxt, &msgData, pDstData);
...
ASN1T_CMS_ESSCertIDv2* ASN1C_CMS_ESSCertIDv2::newCopy ()
{
   OSCTXT* pctxt = getCtxtPtr();
   ASN1T_CMS_ESSCertIDv2* pDstData = new ASN1T_CMS_ESSCertIDv2;
