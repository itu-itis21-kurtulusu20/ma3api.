...
*/
#define TV_CMS_ESSCertIDv2	(TM_UNIV|TM_CONS|16)

class EXTERN ASN1C_CMS_ESSCertIDv2;

struct EXTERN ASN1T_CMS_ESSCertIDv2 : public ASN1TPDU {
   struct {
   ...
   ASN1T_PKCS7_IssuerAndSerialNumber issuerSerial;
   ASN1T_CMS_ESSCertIDv2 ();
   ASN1T_CMS_ESSCertIDv2 (ASN1C_CMS_ESSCertIDv2& srcData);
   ~ASN1T_CMS_ESSCertIDv2 ();
} ;
...
{
protected:
   ASN1T_CMS_ESSCertIDv2& msgData;
public:
   ASN1C_CMS_ESSCertIDv2 (ASN1T_CMS_ESSCertIDv2& data);
   ASN1C_CMS_ESSCertIDv2 (OSRTMessageBufferIF& msgBuf
      , ASN1T_CMS_ESSCertIDv2& data);
   ASN1C_CMS_ESSCertIDv2 (OSRTContext &context, ASN1T_CMS_ESSCertIDv2& data);
   ASN1C_CMS_ESSCertIDv2 (ASN1C_CMS_ESSCertIDv2& original);
   virtual ~ASN1C_CMS_ESSCertIDv2 () {}
   inline ASN1T_CMS_ESSCertIDv2& getData () { return msgData; }
   inline const ASN1T_CMS_ESSCertIDv2& getData () const { return msgData; }
   ...
   int setPrintStream (rtxPrintCallback strmCallback, void* pStrmInfo);
   OSBOOL Equals (ASN1T_CMS_ESSCertIDv2* pCmpValue, 
      char* errBuff, OSSIZE errBuffSize);
   ASN1T_CMS_ESSCertIDv2& getCopy (ASN1T_CMS_ESSCertIDv2* pDstData = 0);
   ASN1T_CMS_ESSCertIDv2* newCopy ();

   inline ASN1C_CMS_ESSCertIDv2& operator= (ASN1C_CMS_ESSCertIDv2& srcData) {
      srcData.getCopy (&msgData);
      return *this;
   }
} ;
...
EXTERN int asn1D_CMS_ESSCertIDv2 (OSCTXT* pctxt, 
   ASN1T_CMS_ESSCertIDv2* pvalue, ASN1TagType tagging, int length);

EXTERN void asn1Print_CMS_ESSCertIDv2 
   (const char* name, const ASN1T_CMS_ESSCertIDv2* pvalue);

EXTERN int asn1PrtToStrm_CMS_ESSCertIDv2 (OSCTXT *pctxt, 
   const char* name, const ASN1T_CMS_ESSCertIDv2* pvalue);

EXTERN ASN1T_CMS_ESSCertIDv2* new_ASN1T_CMS_ESSCertIDv2 (ASN1CType& ccobj);

EXTERN OSBOOL asn1Compare_CMS_ESSCertIDv2 (const char* name, 
   ASN1T_CMS_ESSCertIDv2* pValue, ASN1T_CMS_ESSCertIDv2* pCmpValue, 
   char* errBuff, OSSIZE errBuffSize);

EXTERN void asn1Copy_CMS_ESSCertIDv2 (OSCTXT* pctxt, 
   ASN1T_CMS_ESSCertIDv2* pSrcValue, ASN1T_CMS_ESSCertIDv2* pDstValue);

EXTERN void asn1Init_CMS_ESSCertIDv2 (ASN1T_CMS_ESSCertIDv2* pvalue);

EXTERN void asn1Free_CMS_ESSCertIDv2 (OSCTXT *pctxt, ASN1T_CMS_ESSCertIDv2* pvalue);
