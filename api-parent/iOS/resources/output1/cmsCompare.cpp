...
OSBOOL asn1Compare_CMS_ESSCertIDv2 (const char* name, 
   ...
   char* errBuff, OSSIZE errBuffSize)
{
   ...
   {
      if (! asn1Compare_PKCS7_IssuerAndSerialNumber (namebuf, &pValue->issuerSerial, &pCmpValue->issuerSerial, errBuff, errBuffSize)) 
      {
         retval = FALSE;
      }
   }
...
OSBOOL ASN1C_CMS_ESSCertIDv2::Equals (ASN1T_CMS_ESSCertIDv2* pCmpValue, char* errBuff, OSSIZE errBuffSize)
{
   if (asn1Compare_CMS_ESSCertIDv2 ("ESSCertIDv2", &msgData, pCmpValue, errBuff, errBuffSize))
   {
      return TRUE;
   }
   return FALSE;
