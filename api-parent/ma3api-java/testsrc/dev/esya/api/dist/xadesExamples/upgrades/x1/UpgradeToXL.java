package tr.gov.tubitak.uekae.esya.api.xades.example.upgrades.x1;
...
public class UpgradeToXL extends XadesSampleBase {
    ...
    public void upgradeX1ToXL() throws Exception {
        ...
        XMLSignature signature = XMLSignature.parse(new FileDocument(new File(getTestDataFolder() + "x1.xml")), context);
