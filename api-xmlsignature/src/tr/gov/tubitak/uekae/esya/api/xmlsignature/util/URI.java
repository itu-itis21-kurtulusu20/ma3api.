...
// todo convert these message specific classes
...
public class URI implements Serializable
{
          ...
          throws MalformedURIException
  {
    ...
    if (p_base != null)
    {
      ...
      {
        tempString = path.substring(0, index);
  ...
  @Override
  public int hashCode() {
    int result = m_scheme != null ? m_scheme.hashCode() : 0;
    result = 31 * result + (m_userinfo != null ? m_userinfo.hashCode() : 0);
    result = 31 * result + (m_host != null ? m_host.hashCode() : 0);
    result = 31 * result + m_port;
    result = 31 * result + (m_path != null ? m_path.hashCode() : 0);
    result = 31 * result + (m_queryString != null ? m_queryString.hashCode() : 0);
   ...
   * {@literal &} by a '.'. See RFC 2396 Section 3.2.2.
   *
   *
  ...
  private static boolean isURIString(String p_uric)
  {
    ...
    {
        URI uri =new URI("../../Data/ts_101903v010302p.txt");
