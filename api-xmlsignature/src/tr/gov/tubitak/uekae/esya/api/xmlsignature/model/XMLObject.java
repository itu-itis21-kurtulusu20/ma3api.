 ...
 * <dl>
 * <dt>Identifier</dt>
 * <dd><code>Type=<a href="http://www.w3.org/2000/09/xmldsig#Object"
...
public class XMLObject extends Any
{
    ...
    public XMLObject(Context aBaglam)
    {
        super(aBaglam);
    }
     ...
     */
    public XMLObject(Element aElement, Context aContext)
    ...
    {
        mElement.setAttributeNS(null, Constants.ATTR_MIMETYPE, aMIMEType);
        mMIMEType = aMIMEType;
    }
    ...
    {
        mElement.setAttributeNS(null, Constants.ATTR_ENCODING, aEncoding);
        mEncoding = aEncoding;
    }
    ...
    {
        super.addContentBase64(aBytes);
        setEncoding("http://www.w3.org/2000/09/xmldsig#base64");
    }
