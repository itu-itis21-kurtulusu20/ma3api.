...
import tr.gov.tubitak.uekae.esya.api.xmlsignature.c14n.InvalidCanonicalizerException;
...
public class XMLUtils {
   ...
   static {
      try {
	    ...
	    ("org.apache.xml.security.ignoreLineBreaks");
         ...
         // ignore exceptions
          logger.warn("Warning in XMLUtils", e);
      }
   }
   ...
   public static void outputDOM(Node contextNode, OutputStream os,
      ...
      try {
         ...
         os.write(
          ...
          logger.error("Error in XMLUtils", e);
   ...
   public static Element createElementInSignatureSpace(Document doc,
      ...
      if (doc == null) {
         throw new ESYARuntimeException("Document is null");
      }
   ...
   public static boolean elementIsInSignatureSpace(Element element,
           String localName) {
      return isNamespaceElement(element, localName, Constants.SignatureSpecNS);
   }
   ...
   public static boolean elementIsInEncryptionSpace(Element element,
           String localName) {
	   return isNamespaceElement(element, localName, EncryptionConstants.EncryptionSpecNS);
   }  */
   ...
   public static Element selectDsNode(Node sibling, String nodeName, int number) {
	while (sibling!=null) {
		if (isNamespaceElement(sibling, nodeName, Constants.SignatureSpecNS )) {
			if (number==0){
   ...
   public static Element selectXencNode(Node sibling, String nodeName, int number) {
	while (sibling!=null) {
		if (isNamespaceElement(sibling, nodeName, EncryptionConstants.EncryptionSpecNS )) {
			if (number==0){
				return (Element)sibling;
			}
			number--;
   ...
   public static Element selectNode(Node sibling, String uri,String nodeName, int number) {
	while (sibling!=null) {
		if (isNamespaceElement(sibling, nodeName, uri)) {
			if (number==0){
				return (Element)sibling;
			}
			number--;
