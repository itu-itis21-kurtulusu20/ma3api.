 ...
 * todo
 */
public class CertificatesValues extends CertificateValuesType implements UnsignedSignaturePropertyElement
{

    public CertificatesValues(Context aContext, ECertificate[] aCertificates)
     ...
     */
    public CertificatesValues(Element aElement, Context aContext)
            throws XMLSignatureException
    {
