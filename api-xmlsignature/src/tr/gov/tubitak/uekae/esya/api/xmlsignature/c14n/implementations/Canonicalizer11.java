...
public abstract class Canonicalizer11 extends CanonicalizerBase {
    ...
    static Logger log = LoggerFactory.getLogger(Canonicalizer11.class);
		...
		Attr baseAttr = null;
			...
			baseAttr = n;
		        ...
		        try {
					...
					log.error("Error in Canonicalizer11", ex);
		        }
		    }
		}
     ...
     * {@link tr.gov.tubitak.uekae.esya.api.xmlsignature.c14n.core.utils.XMLUtils#circumventBug2650(
