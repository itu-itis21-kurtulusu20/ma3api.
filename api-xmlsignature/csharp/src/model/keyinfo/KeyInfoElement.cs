namespace tr.gov.tubitak.uekae.esya.api.xmlsignature.model.keyinfo
{
	...
	/// id="rawX509Certificate" >binary (ASN.1 DER) X.509 Certificate</a>.</p>
	/// 
	///  <ul>
	///    <li><a href="http://www.w3.org/2000/09/xmldsig#rawX509Certificate" shape="rect">http://www.w3.org/2000/09/xmldsig#rawX509Certificate</a></li>
	///  </ul>
	/// 
	/// </summary>
	/// <seealso cref= KeyName </seealso>
	/// <seealso cref= KeyValue </seealso>
	/// <seealso cref= MgmtData </seealso>
	/// <seealso cref= PGPData </seealso>
	/// <seealso cref= RetrievalMethod </seealso>
	/// <seealso cref= SPKIData </seealso>
	/// <seealso cref= X509Data
	/// 
	/// @author ahmety
