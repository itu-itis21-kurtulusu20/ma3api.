...
namespace tr.gov.tubitak.uekae.esya.api.xmlsignature.model.xades.vrefs
{
	...
	/// date: Nov 9, 2009
	/// </summary>
	public class AttributeCertificateRefs : CompleteCertificateRefs
	{

		public AttributeCertificateRefs(Context aContext) : base(aContext)
		{
		}
...
//ORIGINAL LINE: public AttributeCertificateRefs(XmlElement aElement, tr.gov.tubitak.uekae.esya.api.xmlsignature.Context aContext) throws tr.gov.tubitak.uekae.esya.api.xmlsignature.XMLSignatureException
		public AttributeCertificateRefs(Element aElement, Context aContext) : base(aElement, aContext)
		{
		}
