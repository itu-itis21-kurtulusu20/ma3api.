...
namespace tr.gov.tubitak.uekae.esya.api.xmlsignature.model.xades
{
	...
	/// date: Nov 4, 2009
	/// </summary>
	public class SignatureTimeStamp : tr.gov.tubitak.uekae.esya.api.xmlsignature.model.xades.timestamp.XAdESTimeStamp, UnsignedSignaturePropertyElement
	{
            ...
            : base(aContext)
		{
			...
			if (aSignature.SignatureValue == null)
			{
		...
		public SignatureTimeStamp(Element aElement, Context aContext) : base(aElement, aContext)
		{
        ...
        public override byte[] getContentForTimeStamp(XMLSignature aSignature)
		{
			...
			*/
			Element e = aSignature.SignatureValueElement;

			return XmlUtil.outputDOM(e, CanonicalizationMethod);
		}
