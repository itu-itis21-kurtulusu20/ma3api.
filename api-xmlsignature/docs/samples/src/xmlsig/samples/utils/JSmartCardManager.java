...
public class JSmartCardManager {
    ...
    private JSmartCardManager() throws SmartCardException
    {
        try
        {
            ...
            {
                LOGGER.error("APDU Smartcard can not created. Propably AkisCIF.jar is missing");
                apduSupport = false;
            }
     ...
     * @return
     * @throws tr.gov.tubitak.uekae.esya.api.smartcard.pkcs11.SmartCardException
     * @throws tr.gov.tubitak.uekae.esya.api.smartcard.pkcs11.LoginException
     */
    ...
    private X509Certificate selectCertificate(boolean checkIsQualified, boolean checkBeingNonQualified,List<byte []> aCerts) throws SmartCardException, ESYAException
    {
        ...
        if(checkIsQualified && checkBeingNonQualified)
            throw new ESYAException("Bir sertifika ya nitelikli sertifikadır, ya niteliksiz sertifikasıdır. Hem nitelikli hem niteliksiz olamaz");
        ...
        else
        {
            ...
            int result = askOption(null, null, optionList,"Sertifika Listesi",new String[]{"Tamam"});
