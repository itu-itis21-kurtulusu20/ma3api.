...
{
    public class TSLSchemeOperatorAddress : BaseElement
    {
        private readonly TSLPostalAddresses postalAddresses;
        private readonly TSLElectronicAddress electronicAddress;

        public TSLSchemeOperatorAddress(XmlDocument document, TSLPostalAddresses iPostalAddresses, TSLElectronicAddress iElectronicAddress) : base(document)
        {
        ...
        public TSLSchemeOperatorAddress(XmlElement aElement) : base(aElement)
        {
        ...
        public TSLElectronicAddress Electronic
        {
        ...
        {
            get { return Constants.TAG_SCHEMEOPERATORADDRESS; }
        }
