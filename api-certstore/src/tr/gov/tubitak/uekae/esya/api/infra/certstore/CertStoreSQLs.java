...
class CertStoreSQLs
{
    /*
      * SQL ler
      */
    public static final String SERTIFIKA_TABLE_CREATE = "CREATE TABLE SERTIFIKA"+
    ...
    public static final String KOKSERTIFIKA_TABLE_CREATE = "CREATE TABLE KOKSERTIFIKA"+
    ...
    public static final String DIZIN_TABLE_CREATE = "CREATE TABLE DIZIN"+
            "(DizinNo INTEGER PRIMARY KEY,"+
            "EklenmeTarihi DATETIME NOT NULL,"+
            "DizinAdi VARCHAR(100) UNIQUE NOT NULL)";

    public static final String SIL_TABLE_CREATE = "CREATE TABLE SIL"+
    ...
    public static final String DIZINSERTIFIKA_TABLE_CREATE = "CREATE TABLE DIZINSERTIFIKA"+
            "(DizinNo INTEGER NOT NULL,SertifikaNo INTEGER NOT NULL,"+
            "PRIMARY KEY(DizinNo,SertifikaNo))";

    public static final String DIZINSIL_TABLE_CREATE = "CREATE TABLE DIZINSIL"+
            "(DizinNo INTEGER NOT NULL,SILNo INTEGER NOT NULL,"+
            "PRIMARY KEY(DizinNo,SILNo))";

    public static final String SILINECEKKOKSERTIFIKA_TABLE_CREATE = "CREATE TABLE SILINECEKKOKSERTIFIKA"+
            "(KOKSertifikaNo INTEGER PRIMARY KEY,"+
            "KOKEklenmeTarihi DATETIME NOT NULL,"+
    ...
    public static final String SISTEMPARAMETRELERI_TABLE_CREATE = "CREATE TABLE SISTEMPARAMETRELERI"+
            "(ParametreAdi VARCHAR(40) NOT NULL PRIMARY KEY,ParametreDegeri BLOB)";

	public static final String HASH_TABLE_CREATE = "CREATE TABLE HASH"+
	...
	public static final String OCSP_TABLE_CREATE = "CREATE TABLE OCSP"+
	"(OCSPNo INTEGER PRIMARY KEY,OCSPResponderID BLOB  NOT NULL," +
	"OCSPProducedAt DATETIME NOT NULL,OCSPValue BLOB  NOT NULL)";
	
	public static final String SERTIFIKAOCSPS_TABLE_CREATE = "CREATE TABLE SERTIFIKAOCSPS"+
	...
	public static final String NITELIK_SERTIFIKASI_TABLE_CREATE = "CREATE TABLE NITELIKSERTIFIKASI"+
    ...
    public static final String SERTIFIKA_INDEX_CREATE = "CREATE UNIQUE INDEX SERTIFIKA_1IND ON SERTIFIKA(SerialNumber,IssuerName)";
    
    public static final String NITELIK_SERTIFIKASI_INDEX_CREATE = "CREATE UNIQUE INDEX NITELIK_SERTIFIKASI_1IND ON NITELIKSERTIFIKASI(NitelikSertifikasiValue)";

    public static final String KOKSERTIFIKA_INDEX_CREATE = "CREATE UNIQUE INDEX KOKSERTIFIKA_1IND ON KOKSERTIFIKA(KOKSerialNumber,KOKIssuerName)";

    public static final String SILINECEKKOKSERTIFIKA_INDEX_CREATE = "CREATE UNIQUE INDEX SILINECEKKOKSERTIFIKA_1IND ON SILINECEKKOKSERTIFIKA(KOKSerialNumber,KOKIssuerName)";

    public static final String HASH_INDEX_CREATE = "CREATE UNIQUE INDEX HASH_1ND ON HASH (ObjectType,ObjectNo,HashType)";
	
    public static final String DEPO_PAROLA_SP_INSERT = "INSERT INTO SISTEMPARAMETRELERI VALUES ('DepoParolasiDogrulama',NULL)";

    public static final String VERSIYON_SP_INSERT = "INSERT INTO SISTEMPARAMETRELERI VALUES ('Versiyon',1.0)";
    
    public static final String LAST_RUN_SQL_SP_INSERT = "INSERT INTO SISTEMPARAMETRELERI VALUES ('LastRunSQL',0)";
