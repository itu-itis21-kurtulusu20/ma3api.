...
public class PAdES_Signing_Tests {

    static PAdESContext context = null;
    static SignatureContainer signatureContainer = null;
    ...
    public static class PAdES_Signing_Positive {
        ...
        public PAdES_Signing_Positive(String pfx){
            this.pfx = pfx;
        }
    ...
    @RunWith(Parameterized.class)
    public static class PAdES_Signing_Negative_Due_To_Failure_Of_Certificate_Checker{
        ...
        public PAdES_Signing_Negative_Due_To_Failure_Of_Certificate_Checker(String pfx, String checker, String error){
            this.pfx = pfx;
    ...
    @RunWith(Parameterized.class)
    public static class PAdES_Signing_Negative_Due_To_Failure_Of_OCSP_Certificate_Checker{
        ...
        public PAdES_Signing_Negative_Due_To_Failure_Of_OCSP_Certificate_Checker(String pfx, String checker, String error){
            this.pfx = pfx;
            this.checker = checker;
            this.error = error;
        }
    ...
    @RunWith(Parameterized.class)
    public static class PAdES_Signing_Negative_Due_To_Certificate_Revocation_Checker {
        ...
        public PAdES_Signing_Negative_Due_To_Certificate_Revocation_Checker(String pfx, String checker, String error){
            this.pfx = pfx;
            this.checker = checker;
            this.error = error;
        }
    ...
    @RunWith(Parameterized.class)
    public static class PAdES_Signing_Negative_Due_To_Subroot_Failure {
        ...
        public PAdES_Signing_Negative_Due_To_Subroot_Failure(String pfx, String error){
            this.pfx = pfx;
            this.error = error;
        }
    ...
    public static void signWithPfx(String pfx) throws Throwable {
        ...
        Signature signature = signatureContainer.createSignature(TestSuiteCommonMethods.certificate);
    ...
    public static void checkIfValidationResultIsValid() throws Throwable {
        ...
        InputStream signatureStream = new ByteArrayInputStream(signatureBytes.toByteArray());
        SignatureContainer readContainer = SignatureFactory.readContainer(SignatureFormat.PAdES, signatureStream, context);
        ...
        Assert.assertEquals(validationResult.toString(), ContainerValidationResultType.ALL_VALID,validationResult.getResultType());
    }
    ...
    public static void checkIfValidationResultIsInvalidDueToFailureOfCertificateChecker(String checkerName, String errorMessage) throws Throwable {
        ...
        Signature signature = (Signature)validationResult.getSignatureValidationResults().keySet().toArray()[0];
        SignatureValidationResult signatureValidationResult = validationResult.getSignatureValidationResults().get(signature);

        List<CheckResult> selfCheckResultList = signatureValidationResult.getCertificateStatusInfo().getDetails();
    ...
    public static void checkIfValidationResultIsInvalidDueToFailureOfOCSPCertificateChecker(String checkerName, String errorMessage) throws Throwable {
        ...
        CertificateStatusInfo signingCertficateInfo = signatureValidationResult.getCertificateStatusInfo().getOCSPResponseInfoList().get(0).getSigningCertficateInfo();
    ...
    public static void checkIfValidationResultIsInvalidDueToFailureOfCertificateRevocationChecker(String checkerName, String errorMessage) throws Throwable {
        ...
        List<RevocationCheckResult> revocationCheckResultList = signatureValidationResult.getCertificateStatusInfo().getRevocationCheckDetails();
    ...
    public static void checkIfValidationResultIsInvalidDueToFailureOfSubroot(String errorMessage) throws Throwable {
        ...
        PathValidationRecord pathValidationRecord = signatureValidationResult.getCertificateStatusInfo().getValidationHistory().get(0);
    ...
    private static void prepareValidationPolicy() throws Exception {
        ...
        String pdfConfig = "esya-signature-config.xml";

        context = new PAdESContext(new File(directory).toURI());
        context.setConfig(new Config(TestSuiteCommonMethods.FOLDER + "config\\" + pdfConfig));
        signatureContainer = SignatureFactory.readContainer(SignatureFormat.PAdES, new FileInputStream(TestSuiteCommonMethods.PLAINPDFFILENAME), context);
    }
}
