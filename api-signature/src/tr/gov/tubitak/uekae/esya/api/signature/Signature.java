...
public interface Signature
{
     ...
     */
    void setSigningTime(Calendar aTime);
     ...
     *
    Calendar getSignatureTimestampTime();*/
     ...
     */
    void addContent(Signable aData, boolean includeContent) throws SignatureException;
     ...
     * @throws SignatureException if anything goes wrong!
     */
    void sign(BaseSigner cryptoSigner) throws SignatureException;
     ...
     *      failure etc.
     */
    void upgrade(SignatureType type) throws SignatureException;
