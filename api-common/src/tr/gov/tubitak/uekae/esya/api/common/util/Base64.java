...
// ----------------------------------------------------------------------------
// $Id: Base64.java,v 1.3 2005/12/22 11:10:13 serdar Exp $
//
 ...
 * code (version 1.4.1 available from {@literal <http://iharder.net/xmlizable>}).
 *
...
public class Base64
{
    ...
    public static final byte[] decode(final String s)
    {
        ...
        try {
            ...
            // not expected
            logger.warn("Unsupported encoding", x);
            throw new ESYARuntimeException("Unsupported encoding", x);
        }
                                        ...
                                        final byte[] dest, final int dOffset)
    {
        ...
        try { // Example: DkLE
            ...
            logger.warn("Problem in decoding", x);
            return -1;
        }
    }
}