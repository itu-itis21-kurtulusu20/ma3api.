...
public class PKCS10Builder {
    ...
    public PKCS10Builder(ProtocolType protocolType) {
        ...
        if (protocolType != ProtocolType.PKCS10PROTOCOL)
            throw new ESYARuntimeException("PKCS10Builder cannot be created for protocol:" + protocolType.getProtocolName());
    }
    ...
    public PKIBody createPKCS10Body(IPKCS10Param pkcs10Param) {
        ...
        if (pkcs10Request == null)
            throw new ESYARuntimeException("PKCS10Request is null");
        byte[] decoded;
        ...
        try {
            ...
            throw new ESYARuntimeException("Error while creating PKCS10Request:" + e.getMessage(), e);
        }
    ...
    public ECertificate extractResponse(PKIBody responseBody) throws CMPProtocolException {
        ...
        if (pkiMessageType != protocolType.getResType())
            throw new CMPProtocolException(PKIFailureInfo.incorrectData, "Invalid PKI Body, must be " + protocolType.getResType() + ", But it is:" + pkiMessageType);
