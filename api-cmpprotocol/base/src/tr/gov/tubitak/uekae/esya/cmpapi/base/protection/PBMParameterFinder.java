...
public class PBMParameterFinder implements IPBMParameterFinder {
    protected static Logger logger = LoggerFactory.getLogger(PBMParameterFinder.class);
    ...
    public EPBMParameter getPbmParameter(PKIMessage message) {
        if (incomingPbmParameter == null) {
            ...
            try {
                ...
                logger.warn("Warning in PBMParameterFinder", e);
                throw new ESYARuntimeException("No PBMParameter is presented in PKIMessage.header.protectionAlg.parameters");
            }
        }
    ...
    public EPBMParameter getPBMParameter() {
        if(existingPbmParameter == null)
            try {
                ...
                logger.warn("Warning in PBMParameterFinder", e);
                throw new ESYARuntimeException("Error while creating CMPPBMac");
            }
