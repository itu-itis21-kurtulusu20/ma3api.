...
public class POPSigner implements IPOPSigner {
    ...
    public ProofOfPossession popOlustur(CertRequest certRequest) {
        ...
        try {
            ...
            throw new RuntimeException("Error While encoding CertRequest:"+e.getMessage(),e);
        }
        ...
        try {
            ...
            throw new RuntimeException("Error while signing POP:"+e.getMessage(),e);
        } 
        if (imza == null) {
            logger.error("Signed POP result is null");
            throw new RuntimeException("Signed POP result is null");
        }
        ...
        try {
            ...
            throw new RuntimeException("Error while creating POPOSigningKey: "+e.getMessage(), e);
        }
