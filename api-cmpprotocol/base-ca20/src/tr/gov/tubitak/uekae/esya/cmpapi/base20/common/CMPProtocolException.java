...
/*    public CMPProtocolException(String message) {
    ...
    public CMPProtocolException(EPKIFailureInfo failInfoID, String errorInfo) {
        super(errorInfo);
        this.exceptionInfo = new ExceptionInfo(failInfoID, errorInfo);
    }

    public CMPProtocolException(PKIFailureInfo failInfoID, String errorInfo) {
        super(errorInfo);
        this.exceptionInfo = new ExceptionInfo(new EPKIFailureInfo(failInfoID), errorInfo);
    }
    ...
    public ExceptionInfo getExceptionInfo() {
        if( exceptionInfo == null )
            exceptionInfo = new ExceptionInfo(EPKIFailureInfo.addInfoNotAvailable,"" );
