...
public class InitializationProtocol extends BaseCertificationProtocol {
    public InitializationProtocol(IConnection connection,
        ...
        super(  connection,
                new MsgBuilder(ProtocolType.INITIALIZATIONPROTOCOL, sender, recipient, senderKID, protectionTrustProvider),
