...
public abstract class PKIMessageType implements IPKIMessageType {
    ...
    public static class PollReqType extends PKIMessageType implements IRequestType, ICertificationType {
        PollReqType(byte choice) {
            super(choice);
        }
    }

    public static class PollResType extends PKIMessageType implements IResponseType, ICertificationType {
        PollResType(byte choice) {
            super(choice);
        }
    }
    ...
    public static class GenMsgType extends PKIMessageType implements IResponseType, IRequestType {
        GenMsgType(byte choice) {
            super(choice);
        }
    }

    public static class GenPType extends PKIMessageType implements IResponseType, IRequestType {
        GenPType(byte choice) {
            super(choice);
        }
    }
    ...
    public final static PollReqType POLLREQ = new PollReqType(PKIBody._POLLREQ);
    public final static PollResType POLLREP = new PollResType(PKIBody._POLLREP);
    ...
    public final static GenMsgType GENM = new GenMsgType(PKIBody._GENM);
    public final static GenPType GENP = new GenPType(PKIBody._GENP);
