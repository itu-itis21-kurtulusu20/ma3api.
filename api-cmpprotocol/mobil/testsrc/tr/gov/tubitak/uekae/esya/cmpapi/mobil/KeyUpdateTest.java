...
public class KeyUpdateTest {
    private static Logger logger = LoggerFactory.getLogger(KeyUpdateTest.class);
...
/*        KeyPair proKeyPair = KeyUtil.generateKeyPair(AsymmetricAlg.RSA, 1024);
        ...
        KeyUpdateProtocol certificationProtocol = new KeyUpdateProtocol(
        ...
        AsnIO.dosyayaz(param.getCertificate().getEncoded(), "MobilCertU" + time + ".cer");
        System.out.println(param.getCertificate().toString());
    }
