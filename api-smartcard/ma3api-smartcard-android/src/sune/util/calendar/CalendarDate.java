...
public abstract class CalendarDate implements Cloneable {
    ...
    private sune.util.calendar.Era era;
    private int year;
    private int month;
     ...
     */
    public CalendarDate setEra(sune.util.calendar.Era era) {
        if (this.era == era) {
            return this;
        }
        this.era = era;
    ...
    public String toString() {
        ...
        sune.util.calendar.CalendarUtils.sprintf0d(sb, year, 4).append('-');
        sune.util.calendar.CalendarUtils.sprintf0d(sb, month, 2).append('-');
        sune.util.calendar.CalendarUtils.sprintf0d(sb, dayOfMonth, 2).append('T');
        sune.util.calendar.CalendarUtils.sprintf0d(sb, hours, 2).append(':');
        sune.util.calendar.CalendarUtils.sprintf0d(sb, minutes, 2).append(':');
        sune.util.calendar.CalendarUtils.sprintf0d(sb, seconds, 2).append('.');
        sune.util.calendar.CalendarUtils.sprintf0d(sb, millis, 3);
        if (zoneOffset == 0) {
            sb.append('Z');
            ...
            offset /= 60000;
            sb.append(sign);
            sune.util.calendar.CalendarUtils.sprintf0d(sb, offset / 60, 2);
