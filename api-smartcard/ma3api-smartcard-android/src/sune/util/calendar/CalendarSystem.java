 ...
 * </pre>
 *
 * @see sune.util.calendar.CalendarDate
...
public abstract class CalendarSystem {
    ...
    private final static sune.util.calendar.Gregorian GREGORIAN_INSTANCE = new sune.util.calendar.Gregorian();
    ...
    public abstract sune.util.calendar.CalendarDate getCalendarDate();
     ...
     */
    public abstract sune.util.calendar.CalendarDate getCalendarDate(long millis);

    public abstract sune.util.calendar.CalendarDate getCalendarDate(long millis, sune.util.calendar.CalendarDate date);

    public abstract sune.util.calendar.CalendarDate getCalendarDate(long millis, TimeZone zone);
     ...
     */
    public abstract sune.util.calendar.CalendarDate newCalendarDate();

    public abstract sune.util.calendar.CalendarDate newCalendarDate(TimeZone zone);
     ...
     */
    public abstract long getTime(sune.util.calendar.CalendarDate date);
     ...
     * value.
     */
    public abstract int getYearLength(sune.util.calendar.CalendarDate date);
     ...
     */
    public abstract int getYearLengthInMonths(sune.util.calendar.CalendarDate date);
     ...
     */
    public abstract int getMonthLength(sune.util.calendar.CalendarDate date); // no setter
     ...
     */
    public abstract sune.util.calendar.Era getEra(String eraName);
     ...
     * system.
     */
    public abstract sune.util.calendar.Era[] getEras();
     ...
     * @see Era
     */
    public abstract void setEra(sune.util.calendar.CalendarDate date, String eraName);
     ...
     */
    public abstract sune.util.calendar.CalendarDate getNthDayOfWeek(int nth, int dayOfWeek,
                                                                    sune.util.calendar.CalendarDate date);

    public abstract sune.util.calendar.CalendarDate setTimeOfDay(sune.util.calendar.CalendarDate date, int timeOfDay);
     ...
     */
    public abstract boolean validate(sune.util.calendar.CalendarDate date);

    /**
     * Normalizes calendar fields in the specified
     * <code>date</code>. Also all {@link sune.util.calendar.CalendarDate#FIELD_UNDEFINED
