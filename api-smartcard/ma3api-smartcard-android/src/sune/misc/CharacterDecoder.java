 ...
 * @see         sune.misc.CEFormatException
...
public abstract class CharacterDecoder {
    ...
    protected void decodeAtom(PushbackInputStream aStream, OutputStream bStream, int l) throws IOException {
        throw new sune.misc.CEStreamExhausted();
    }
     ...
     * is exhausted.
     * @exception sune.misc.CEFormatException An error has occurred while decoding
     * @exception sune.misc.CEStreamExhausted The input stream is unexpectedly out of data
     */
