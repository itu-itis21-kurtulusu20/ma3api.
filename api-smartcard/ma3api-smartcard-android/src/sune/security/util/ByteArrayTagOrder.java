...
public class ByteArrayTagOrder implements Comparator<byte[]> {
     ...
     * @return negative number if bytes1 {@literal <} bytes2, 0 if bytes1 == bytes2,
     * positive number if bytes1 {@literal >} bytes2.
     *
     * @throws ClassCastException if either argument is not a byte array.
     */
