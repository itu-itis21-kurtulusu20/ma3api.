...
public class DerInputStream {
     ...
     */
    sune.security.util.DerInputBuffer buffer;
    ...
    private void init(byte[] data, int offset, int len) throws IOException {
        ...
        if (sune.security.util.DerIndefLenConverter.isIndefinite(data[offset+1])) {
            byte[] inData = new byte[len];
            System.arraycopy(data, offset, inData, 0, len);

            sune.security.util.DerIndefLenConverter derIn = new sune.security.util.DerIndefLenConverter();
            buffer = new sune.security.util.DerInputBuffer(derIn.convert(inData));
        } else
            buffer = new sune.security.util.DerInputBuffer(data, offset, len);
        buffer.mark(Integer.MAX_VALUE);
    }

    DerInputStream(sune.security.util.DerInputBuffer buf) {
        buffer = buf;
        buffer.mark(Integer.MAX_VALUE);
    }
    ...
    throws IOException {
        sune.security.util.DerInputBuffer newbuf = buffer.dup();
    ...
    public int getInteger() throws IOException {
        if (buffer.read() != sune.security.util.DerValue.tag_Integer) {
    ...
    public int getEnumerated() throws IOException {
        if (buffer.read() != sune.security.util.DerValue.tag_Enumerated) {
    ...
    public byte[] getBitString() throws IOException {
        if (buffer.read() != sune.security.util.DerValue.tag_BitString)
     ...
     * not be byte-aligned.
     */
    public sune.security.util.BitArray getUnalignedBitString() throws IOException {
        if (buffer.read() != sune.security.util.DerValue.tag_BitString)
    ...
    public byte[] getOctetString() throws IOException {
        if (buffer.read() != sune.security.util.DerValue.tag_OctetString)
    ...
    public void getNull() throws IOException {
        if (buffer.read() != sune.security.util.DerValue.tag_Null || buffer.read() != 0)
     ...
     */
    public sune.security.util.ObjectIdentifier getOID() throws IOException {
     ...
     */
    public sune.security.util.DerValue[] getSequence(int startLen) throws IOException {
        tag = (byte)buffer.read();
        if (tag != sune.security.util.DerValue.tag_Sequence)
     ...
     * @return array of the values in the sequence
     */
    public sune.security.util.DerValue[] getSet(int startLen) throws IOException {
        tag = (byte)buffer.read();
        if (tag != sune.security.util.DerValue.tag_Set)
     ...
     * @return array of the values in the sequence
     */
    public sune.security.util.DerValue[] getSet(int startLen, boolean implicit)
        throws IOException {
        tag = (byte)buffer.read();
        if (!implicit) {
            if (tag != sune.security.util.DerValue.tag_Set) {
     ...
     */
    protected sune.security.util.DerValue[] readVector(int startLen) throws IOException {
        ...
        if (len == -1) {
           ...
           dis.close();
           sune.security.util.DerIndefLenConverter derIn = new sune.security.util.DerIndefLenConverter();
           buffer = new sune.security.util.DerInputBuffer(derIn.convert(indefData));
           if (tag != buffer.read())
        ...
        if (len == 0)
            ...
            return new sune.security.util.DerValue[0];
         ...
         */
        Vector<sune.security.util.DerValue> vec = new Vector<sune.security.util.DerValue>(startLen);
        sune.security.util.DerValue value;

        do {
            value = new sune.security.util.DerValue(newstr.buffer);
         ...
         */
        int             i, max = vec.size();
        sune.security.util.DerValue[]      retval = new sune.security.util.DerValue[max];
     ...
     */
    public sune.security.util.DerValue getDerValue() throws IOException {
        return new sune.security.util.DerValue(buffer);
    }
    ...
    public String getUTF8String() throws IOException {
        return readString(sune.security.util.DerValue.tag_UTF8String, "UTF-8", "UTF8");
    }
    ...
    public String getPrintableString() throws IOException {
        return readString(sune.security.util.DerValue.tag_PrintableString, "Printable",
                          "ASCII");
    }
    ...
    public String getT61String() throws IOException {
         ...
         */
        return readString(sune.security.util.DerValue.tag_T61String, "T61", "ISO-8859-1");
    }
    ...
    public String getIA5String() throws IOException {
        return readString(sune.security.util.DerValue.tag_IA5String, "IA5", "ASCII");
    }
    ...
    public String getBMPString() throws IOException {
        return readString(sune.security.util.DerValue.tag_BMPString, "BMP",
                          "UnicodeBigUnmarked");
    }
    ...
    public String getGeneralString() throws IOException {
        return readString(sune.security.util.DerValue.tag_GeneralString, "General",
                          "ASCII");
    }
    ...
    public Date getUTCTime() throws IOException {
        if (buffer.read() != sune.security.util.DerValue.tag_UtcTime)
