...
class ObjectIdentifier implements Serializable
{
     ...
     */
    public ObjectIdentifier (sune.security.util.DerInputStream in)
        throws IOException
    {
        byte    type_id;
        int     bufferEnd;
        ...
        if (type_id != sune.security.util.DerValue.tag_ObjectId)
     ...
     */
    ObjectIdentifier (sune.security.util.DerInputBuffer buf) throws IOException
    {
        initFromEncoding (new sune.security.util.DerInputStream(buf), 0);
    }
     ...
     * length are verified.
     */
    private void initFromEncoding (sune.security.util.DerInputStream in, int bufferEnd)
        throws IOException
    {
    ...
    {
        sune.security.util.DerOutputStream bytes = new sune.security.util.DerOutputStream();
        int i;
