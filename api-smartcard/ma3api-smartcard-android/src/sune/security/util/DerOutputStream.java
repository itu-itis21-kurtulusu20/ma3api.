...
extends ByteArrayOutputStream implements sune.security.util.DerEncoder {
    /**
     ...
     */
    public void putDerValue(sune.security.util.DerValue val) throws IOException {
        val.encode(this);
    }
    ...
    public void putBoolean(boolean val) throws IOException {
        write(sune.security.util.DerValue.tag_Boolean);
        putLength(1);
        if (val) {
            write(0xff);
        } else {
    ...
    public void putEnumerated(int i) throws IOException {
        write(sune.security.util.DerValue.tag_Enumerated);
    ...
    public void putInteger(BigInteger i) throws IOException {
        write(sune.security.util.DerValue.tag_Integer);
    ...
    public void putBitString(byte[] bits) throws IOException {
        write(sune.security.util.DerValue.tag_BitString);
     ...
     */
    public void putUnalignedBitString(sune.security.util.BitArray ba) throws IOException {
    ...
    public void putOctetString(byte[] octets) throws IOException {
        write(sune.security.util.DerValue.tag_OctetString, octets);
    }
    ...
    public void putNull() throws IOException {
        write(sune.security.util.DerValue.tag_Null);
        putLength(0);
    }
     ...
     */
    public void putSequence(sune.security.util.DerValue[] seq) throws IOException {
        ...
        write(sune.security.util.DerValue.tag_Sequence, bytes);
    }
     ...
     */
    public void putSet(sune.security.util.DerValue[] set) throws IOException {
        DerOutputStream bytes = new DerOutputStream();
        int i;
        ...
        write(sune.security.util.DerValue.tag_Set, bytes);
    }
     ...
     */
    public void putOrderedSetOf(byte tag, sune.security.util.DerEncoder[] set) throws IOException {
     ...
     */
    public void putOrderedSet(byte tag, sune.security.util.DerEncoder[] set) throws IOException {
     ...
     */
    private static sune.security.util.ByteArrayLexOrder lexOrder = new ByteArrayLexOrder();

    /**
     *  Tag order comparison on byte arrays, for ordering elements of
     *  SET objects in DER encoding.
     */
    private static sune.security.util.ByteArrayTagOrder tagOrder = new ByteArrayTagOrder();
    ...
    public void putUTF8String(String s) throws IOException {
        writeString(s, sune.security.util.DerValue.tag_UTF8String, "UTF8");
    }
    ...
    public void putPrintableString(String s) throws IOException {
        writeString(s, sune.security.util.DerValue.tag_PrintableString, "ASCII");
    }
    ...
    public void putT61String(String s) throws IOException {
         ...
         * T61.
         */
        writeString(s, sune.security.util.DerValue.tag_T61String, "ISO-8859-1");
    }
    ...
    public void putIA5String(String s) throws IOException {
        writeString(s, sune.security.util.DerValue.tag_IA5String, "ASCII");
    }
    ...
    public void putBMPString(String s) throws IOException {
        writeString(s, sune.security.util.DerValue.tag_BMPString, "UnicodeBigUnmarked");
    }
    ...
    public void putGeneralString(String s) throws IOException {
        writeString(s, sune.security.util.DerValue.tag_GeneralString, "ASCII");
    }
    ...
    public void putUTCTime(Date d) throws IOException {
        putTime(d, sune.security.util.DerValue.tag_UtcTime);
    }
    ...
    public void putGeneralizedTime(Date d) throws IOException {
        putTime(d, sune.security.util.DerValue.tag_GeneralizedTime);
    }
    ...
    private void putTime(Date d, byte tag) throws IOException {
        ...
        if (tag == sune.security.util.DerValue.tag_UtcTime) {
