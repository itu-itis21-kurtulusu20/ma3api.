 ...
 */
public class PKCS10Attribute implements sune.security.util.DerEncoder {

    protected sune.security.util.ObjectIdentifier attributeId = null;
     ...
     */
    public PKCS10Attribute(sune.security.util.DerValue derVal) throws IOException {
        sune.security.pkcs.PKCS9Attribute attr = new sune.security.pkcs.PKCS9Attribute(derVal);
     ...
     */
    public PKCS10Attribute(sune.security.pkcs.PKCS9Attribute attr) {
        this.attributeId = attr.getOID();
        this.attributeValue = attr.getValue();
    }
    ...
    public void derEncode(OutputStream out) throws IOException {
        sune.security.pkcs.PKCS9Attribute attr = new PKCS9Attribute(attributeId, attributeValue);
        attr.derEncode(out);
    }
     ...
     */
    public sune.security.util.ObjectIdentifier getAttributeId() {
        return (attributeId);
    }
