...
public class PKCS7 {
    ...
    protected static Logger logger = LoggerFactory.getLogger(PKCS7.class);
        ...
        throws ParsingException
    {
        try {
            ...
            logger.debug("Debug in PKCS7", ioe);
            try {
                derin.reset();
    ...
    throws ParsingException, IOException {
        ...
        try {
            ...
            logger.warn("Warning in PKCS7", e);
            // do nothing
        }
    ...
    private void parseSignedData(DerValue val)
        ...
        try {
            ...
            ParsingException pe =
                new ParsingException("Error parsing digest AlgorithmId IDs: " + e.getMessage());
            pe.initCause(e);
            throw pe;
        }
        // contentInfo
