...
public class GetInstance {
    ...
    public static Service getService(String type, String algorithm)
        ...
        sune.security.jca.ProviderList list = sune.security.jca.Providers.getProviderList();
    ...
    public static Service getService(String type, String algorithm,
        ...
        Provider p = sune.security.jca.Providers.getProviderList().getProvider(provider);
        if (p == null) {
