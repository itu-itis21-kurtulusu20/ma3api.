...
public class HttpTimestamper implements Timestamper {
     ...
     *
     * @param tsaUrl The location of the TSA. It must be an HTTP URL.
     */
     ...
     */
    public sune.security.timestamp.TSResponse generateTimestamp(TSRequest tsQuery) throws IOException {
