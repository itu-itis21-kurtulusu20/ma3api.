 ...
 */
public class RFC822Name implements sune.security.x509.GeneralNameInterface
{
    private String name;
     ...
     */
    public RFC822Name(sune.security.util.DerValue derValue) throws IOException {
     ...
     */
    public int getType() {
        return (sune.security.x509.GeneralNameInterface.NAME_RFC822);
    }
     ...
     */
    public int constrains(sune.security.x509.GeneralNameInterface inputName) throws UnsupportedOperationException {
        int constraintType;
        if (inputName == null)
