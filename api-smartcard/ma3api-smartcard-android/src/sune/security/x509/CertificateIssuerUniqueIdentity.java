...
public class CertificateIssuerUniqueIdentity implements CertAttrSet<String> {
    private sune.security.x509.UniqueIdentity id;
     ...
     */
    public CertificateIssuerUniqueIdentity(sune.security.x509.UniqueIdentity id) {
        this.id = id;
    }
     ...
     */
    public CertificateIssuerUniqueIdentity(sune.security.util.DerInputStream in)
    throws IOException {
        id = new sune.security.x509.UniqueIdentity(in);
    }
    ...
    throws IOException {
        sune.security.util.DerValue val = new DerValue(in);
        id = new sune.security.x509.UniqueIdentity(val);
    }
     ...
     * @exception IOException on decoding errors.
     */
    public CertificateIssuerUniqueIdentity(sune.security.util.DerValue val)
    throws IOException {
        id = new sune.security.x509.UniqueIdentity(val);
    }
    ...
    public void encode(OutputStream out) throws IOException {
        ...
        id.encode(tmp, sune.security.util.DerValue.createTag(sune.security.util.DerValue.TAG_CONTEXT,false,(byte)1));
    ...
    public void set(String name, Object obj) throws IOException {
        if (!(obj instanceof sune.security.x509.UniqueIdentity)) {
