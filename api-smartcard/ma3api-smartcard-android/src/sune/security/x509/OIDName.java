 ...
 */
public class OIDName implements sune.security.x509.GeneralNameInterface {
     ...
     */
    public OIDName(sune.security.util.DerValue derValue) throws IOException {
        oid = derValue.getOID();
    }
     ...
     */
    public OIDName(sune.security.util.ObjectIdentifier oid) {
        this.oid = oid;
    }
    ...
    public OIDName(String name) throws IOException {
        try {
            oid = new sune.security.util.ObjectIdentifier(name);
        } catch (Exception e) {
     ...
     */
    public int getType() {
        return (sune.security.x509.GeneralNameInterface.NAME_OID);
    }
