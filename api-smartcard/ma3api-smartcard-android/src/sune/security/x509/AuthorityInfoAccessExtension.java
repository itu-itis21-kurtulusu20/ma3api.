...
public class AuthorityInfoAccessExtension extends Extension
     ...
     */
    private List<sune.security.x509.AccessDescription> accessDescriptions;
    ...
    public AuthorityInfoAccessExtension(
            List<sune.security.x509.AccessDescription> accessDescriptions) throws IOException {
        this.extensionId = sune.security.x509.PKIXExtensions.AuthInfoAccess_Id;
        this.critical = false;
    ...
    public AuthorityInfoAccessExtension(Boolean critical, Object value)
        ...
        accessDescriptions = new ArrayList<sune.security.x509.AccessDescription>();
        while (val.data.available() != 0) {
            DerValue seq = val.data.getDerValue();
            sune.security.x509.AccessDescription accessDescription = new sune.security.x509.AccessDescription(seq);
     ...
     */
    public List<sune.security.x509.AccessDescription> getAccessDescriptions() {
    ...
    public void set(String name, Object obj) throws IOException {
        if (name.equalsIgnoreCase(DESCRIPTIONS)) {
            ...
            accessDescriptions = (List<sune.security.x509.AccessDescription>)obj;
        } else {
