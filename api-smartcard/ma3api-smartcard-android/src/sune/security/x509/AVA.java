...
import sune.security.action.GetBooleanAction;
 ...
 *
 * @see sune.security.x509.X500Name
 * @see RDN
 *
 *
...
public class AVA implements DerEncoder {
    ...
    protected static Logger logger = LoggerFactory.getLogger(AVA.class);
    ...
    private DerValue parseQuotedString
        ...
        if (this.oid.equals(PKCS9Attribute.EMAIL_ADDRESS_OID) ||
            (this.oid.equals(sune.security.x509.X500Name.DOMAIN_COMPONENT_OID) &&
    ...
    public String toRFC2253String(Map<String, String> oidMap) {
            ...
            !isDerString(value, false))
        {
            ...
            try {
                ...
                throw new IllegalArgumentException("DER Value conversion", e);
            }
            typeAndValue.append('#');
...
class AVAKeyword {
    ...
    static {
        ...
        new AVAKeyword("CN",           sune.security.x509.X500Name.commonName_oid,   true,  true);
        new AVAKeyword("C",            sune.security.x509.X500Name.countryName_oid,  true,  true);
        new AVAKeyword("L",            sune.security.x509.X500Name.localityName_oid, true,  true);
        new AVAKeyword("S",            sune.security.x509.X500Name.stateName_oid,    false, false);
        new AVAKeyword("ST",           sune.security.x509.X500Name.stateName_oid,    true,  true);
        new AVAKeyword("O",            sune.security.x509.X500Name.orgName_oid,      true,  true);
        new AVAKeyword("OU",           sune.security.x509.X500Name.orgUnitName_oid,  true,  true);
        new AVAKeyword("T",            sune.security.x509.X500Name.title_oid,        false, false);
        new AVAKeyword("IP",           sune.security.x509.X500Name.ipAddress_oid,    false, false);
        new AVAKeyword("STREET",       sune.security.x509.X500Name.streetAddress_oid,true,  true);
        new AVAKeyword("DC",           sune.security.x509.X500Name.DOMAIN_COMPONENT_OID,
                                                                  false, true);
        new AVAKeyword("DNQUALIFIER",  sune.security.x509.X500Name.DNQUALIFIER_OID,  false, false);
        new AVAKeyword("DNQ",          sune.security.x509.X500Name.DNQUALIFIER_OID,  false, false);
        new AVAKeyword("SURNAME",      sune.security.x509.X500Name.SURNAME_OID,      false, false);
        new AVAKeyword("GIVENNAME",    sune.security.x509.X500Name.GIVENNAME_OID,    false, false);
        new AVAKeyword("INITIALS",     sune.security.x509.X500Name.INITIALS_OID,     false, false);
        new AVAKeyword("GENERATION",   sune.security.x509.X500Name.GENERATIONQUALIFIER_OID,
                                                                  false, false);
        ...
        new AVAKeyword("EMAILADDRESS", PKCS9Attribute.EMAIL_ADDRESS_OID,
                                                                  false, false);
        new AVAKeyword("UID",          sune.security.x509.X500Name.userid_oid,       false, true);
        new AVAKeyword("SERIALNUMBER", sune.security.x509.X500Name.SERIALNUMBER_OID, false, false);
    }
}
