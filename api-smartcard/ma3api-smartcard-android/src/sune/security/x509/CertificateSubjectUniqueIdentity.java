...
public class CertificateSubjectUniqueIdentity implements CertAttrSet<String> {
     ...
     */
    public CertificateSubjectUniqueIdentity(sune.security.x509.UniqueIdentity id) {
        this.id = id;
    }
     ...
     */
    public CertificateSubjectUniqueIdentity(sune.security.util.DerInputStream in)
    throws IOException {
     ...
     * @exception IOException on decoding errors.
     */
    public CertificateSubjectUniqueIdentity(sune.security.util.DerValue val)
    throws IOException {
        id = new sune.security.x509.UniqueIdentity(val);
    }
    ...
    public void encode(OutputStream out) throws IOException {
        ...
        id.encode(tmp, sune.security.util.DerValue.createTag(DerValue.TAG_CONTEXT,false,(byte)2));
