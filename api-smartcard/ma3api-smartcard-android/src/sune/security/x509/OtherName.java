 ...
 */
public class OtherName implements sune.security.x509.GeneralNameInterface {

    private String name;
    private sune.security.util.ObjectIdentifier oid;
    private byte[] nameValue = null;
    private sune.security.x509.GeneralNameInterface gni = null;
     ...
     */
    public OtherName(sune.security.util.ObjectIdentifier oid, byte[] value) throws IOException {
     ...
     */
    public OtherName(sune.security.util.DerValue derValue) throws IOException {
        sune.security.util.DerInputStream in = derValue.toDerInputStream();
     ...
     */
    private sune.security.x509.GeneralNameInterface getGNI(sune.security.util.ObjectIdentifier oid, byte[] nameValue)
            throws IOException {
        try {
            ...
            sune.security.x509.GeneralNameInterface gni =
                       (sune.security.x509.GeneralNameInterface)cons.newInstance(passed);
            return gni;
        } catch (Exception e) {
     ...
     */
    public int getType() {
        return sune.security.x509.GeneralNameInterface.NAME_ANY;
    }
    ...
    public void encode(sune.security.util.DerOutputStream out) throws IOException {
        if (gni != null) {
            ...
            tmp.putOID(oid);
            tmp.write(sune.security.util.DerValue.createTag(sune.security.util.DerValue.TAG_CONTEXT, true, TAG_VALUE), nameValue);
    ...
    public boolean equals(Object other) {
        ...
        sune.security.x509.GeneralNameInterface otherGNI = null;
        try {
