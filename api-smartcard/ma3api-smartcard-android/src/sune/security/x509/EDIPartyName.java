 ...
 */
public class EDIPartyName implements sune.security.x509.GeneralNameInterface {
     ...
     */
    public EDIPartyName(sune.security.util.DerValue derValue) throws IOException {
        sune.security.util.DerInputStream in = new sune.security.util.DerInputStream(derValue.toByteArray());
        sune.security.util.DerValue[] seq = in.getSequence(2);
     ...
     */
    public int getType() {
        return (sune.security.x509.GeneralNameInterface.NAME_EDI);
    }
    ...
    public void encode(sune.security.util.DerOutputStream out) throws IOException {
        ...
        if (assigner != null) {
            DerOutputStream tmp2 = new sune.security.util.DerOutputStream();
            // XXX - shd check is chars fit into PrintableString
            tmp2.putPrintableString(assigner);
            tagged.write(sune.security.util.DerValue.createTag(sune.security.util.DerValue.TAG_CONTEXT,
        ...
        out.write(sune.security.util.DerValue.tag_Sequence, tagged);
    }
