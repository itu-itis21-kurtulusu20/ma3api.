 ...
 */
public class DNSName implements sune.security.x509.GeneralNameInterface {
    private String name;
     ...
     */
    public DNSName(sune.security.util.DerValue derValue) throws IOException {
     ...
     */
    public int getType() {
        return (sune.security.x509.GeneralNameInterface.NAME_DNS);
    }
