...
public class CertificateSerialNumber implements CertAttrSet<String> {
    ...
    private sune.security.x509.SerialNumber serial;
    ...
    public CertificateSerialNumber(BigInteger num) {
      this.serial = new sune.security.x509.SerialNumber(num);
    }
     ...
     */
    public CertificateSerialNumber(sune.security.util.DerInputStream in) throws IOException {
        serial = new sune.security.x509.SerialNumber(in);
    }
     ...
     * @exception IOException on decoding errors.
     */
    public CertificateSerialNumber(sune.security.util.DerValue val) throws IOException {
        serial = new sune.security.x509.SerialNumber(val);
    }
