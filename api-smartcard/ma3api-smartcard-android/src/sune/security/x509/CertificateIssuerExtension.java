...
public class CertificateIssuerExtension extends Extension
    ...
    private sune.security.x509.GeneralNames names;
     ...
     */
    public CertificateIssuerExtension(sune.security.x509.GeneralNames issuer) throws IOException {
        this.extensionId = sune.security.x509.PKIXExtensions.CertificateIssuer_Id;
        this.critical = true;
        this.names = issuer;
        encodeThis();
    }
    ...
    public CertificateIssuerExtension(Boolean critical, Object value)
        ...
        this.names = new sune.security.x509.GeneralNames(val);
    }
