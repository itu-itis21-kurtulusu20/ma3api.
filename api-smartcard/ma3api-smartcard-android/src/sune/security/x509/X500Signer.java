...
public final class X500Signer extends Signer
{
     ...
     */
    public sune.security.x509.AlgorithmId getAlgorithmId() {
        return algid;
    }
     ...
     */
    public sune.security.x509.X500Name getSigner() {
        return agent;
    }
    ...
    public X500Signer(Signature sig, sune.security.x509.X500Name agent) {
        ...
        try {
          this.algid = sune.security.x509.AlgorithmId.getAlgorithmId(sig.getAlgorithm());
