...
public class IssuingDistributionPointExtension extends Extension
     ...
     */
    private sune.security.x509.DistributionPointName distributionPoint = null;

    /*
     * The scope settings for the CRL.
     */
    private sune.security.x509.ReasonFlags revocationReasons = null;
    ...
    public IssuingDistributionPointExtension(
            sune.security.x509.DistributionPointName distributionPoint, sune.security.x509.ReasonFlags revocationReasons,
        ...
        this.extensionId = sune.security.x509.PKIXExtensions.IssuingDistributionPoint_Id;
        this.critical = true;
    ...
    public IssuingDistributionPointExtension(Boolean critical, Object value)
        ...
        while (in != null && in.available() != 0) {
            ...
            if (opt.isContextSpecific(TAG_DISTRIBUTION_POINT) &&
                opt.isConstructed()) {
                distributionPoint =
                    new sune.security.x509.DistributionPointName(opt.data.getDerValue());
                ...
                hasOnlyCACerts = opt.getBoolean();
                       ...
                       !opt.isConstructed()) {
                revocationReasons = new sune.security.x509.ReasonFlags(opt); // expects tag implicit
    ...
    public void set(String name, Object obj) throws IOException {
        if (name.equalsIgnoreCase(POINT)) {
            if (!(obj instanceof sune.security.x509.DistributionPointName)) {
                throw new IOException(
