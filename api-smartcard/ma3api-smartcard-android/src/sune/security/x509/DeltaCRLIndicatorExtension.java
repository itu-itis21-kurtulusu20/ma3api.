...
public class DeltaCRLIndicatorExtension extends CRLNumberExtension {
    ...
    public DeltaCRLIndicatorExtension(int crlNum) throws IOException {
        super(sune.security.x509.PKIXExtensions.DeltaCRLIndicator_Id, true,
    ...
    public DeltaCRLIndicatorExtension(BigInteger crlNum) throws IOException {
        super(sune.security.x509.PKIXExtensions.DeltaCRLIndicator_Id, true, crlNum, NAME, LABEL);
    }
    ...
    throws IOException {
        super(sune.security.x509.PKIXExtensions.DeltaCRLIndicator_Id, critical.booleanValue(),
            value, NAME, LABEL);
    }
