 ...
 */
public class IPAddressName implements sune.security.x509.GeneralNameInterface {
    protected static Logger logger = LoggerFactory.getLogger(IPAddressName.class);
    ...
    public String toString() {
        try {
            ...
            logger.warn("Warning in IPAddressName", e);
