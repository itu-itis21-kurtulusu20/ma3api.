...
public class UniqueIdentity {
     ...
     */
    public UniqueIdentity(sune.security.util.BitArray id) {
        this.id = id;
    }
    ...
    public UniqueIdentity(byte[] id) {
        this.id = new sune.security.util.BitArray(id.length*8, id);
    }
     ...
     */
    public UniqueIdentity(sune.security.util.DerInputStream in) throws IOException {
     ...
     * @exception IOException on decoding errors.
     */
    public UniqueIdentity(sune.security.util.DerValue derVal) throws IOException {
        id = derVal.getUnalignedBitString(true);
    }
     ...
     */
    public void encode(sune.security.util.DerOutputStream out, byte tag) throws IOException {
