 ...
 * {@linkplain javax.smartcardio.TerminalFactory#terminals}.
 *
 * @see javax.smartcardio.TerminalFactory
...
public abstract class CardTerminals {
     ...
     */
    public List<javax.smartcardio.CardTerminal> list() throws javax.smartcardio.CardException {
     ...
     * @throws javax.smartcardio.CardException if the card operation failed
     */
    public abstract List<javax.smartcardio.CardTerminal> list(State state) throws javax.smartcardio.CardException;
     ...
     */
    public javax.smartcardio.CardTerminal getTerminal(String name) {
        if (name == null) {
     ...
     * @throws javax.smartcardio.CardException if the card operation failed
     */
    public void waitForChange() throws javax.smartcardio.CardException {
        waitForChange(0);
    }
     ...
     * {@link #list(State) list(State.CARD_INSERTION)},
     * for example:
     * <pre>
