...
import sune.security.jca.GetInstance;
import sune.security.jca.GetInstance.*;
 ...
 * encouraged to use a {@linkplain Properties} object as the
 ...
 * {@linkplain javax.smartcardio.TerminalFactorySpi} class for more information.
 *
...
public final class TerminalFactory {
    ...
    private static final class NoneFactorySpi extends javax.smartcardio.TerminalFactorySpi {
        final static javax.smartcardio.TerminalFactorySpi INSTANCE = new NoneFactorySpi();
    ...
    private static final class NoneCardTerminals extends javax.smartcardio.CardTerminals {
        final static javax.smartcardio.CardTerminals INSTANCE = new NoneCardTerminals();
        private NoneCardTerminals() {
            // empty
        }
        public List<CardTerminal> list(State state) throws javax.smartcardio.CardException {
            if (state == null) {
    ...
    private TerminalFactory(javax.smartcardio.TerminalFactorySpi spi, Provider provider, String type) {
        this.spi = spi;
    ...
    public static TerminalFactory getInstance(String type, Object params)
        ...
        Instance instance = sune.security.jca.GetInstance.getInstance("TerminalFactory",
            javax.smartcardio.TerminalFactorySpi.class, type, params);
        return new TerminalFactory((javax.smartcardio.TerminalFactorySpi)instance.impl,
    ...
    public static TerminalFactory getInstance(String type, Object params,
        ...
        Instance instance = sune.security.jca.GetInstance.getInstance("TerminalFactory",
            javax.smartcardio.TerminalFactorySpi.class, type, params, provider);
        return new TerminalFactory((javax.smartcardio.TerminalFactorySpi)instance.impl,
            instance.provider, type);
    }
     ...
     * See the class comment of the {@linkplain javax.smartcardio.CardTerminals} class
