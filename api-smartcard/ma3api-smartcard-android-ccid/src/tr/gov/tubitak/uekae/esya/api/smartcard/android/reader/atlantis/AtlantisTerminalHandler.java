...
public class AtlantisTerminalHandler extends TerminalHandler {

    private static String TAG="EsyaAndroidSignAPI-AtlantisTerminalHandler";
    //private static Logger logger = Logger.getLogger(ACSTerminalHandler.class);
    Activity mActivity;
    AtlantisReader mReader;

    public AtlantisTerminalHandler(Activity callerActivity, PendingIntent permissionIntent) {
        ...
        mReader = new AtlantisReader(mUsbManager);
    }
    ...
    public AtlantisReader getmReader() {
        return mReader;
    }
    ...
    public AtlantisTerminalHandler(Activity aActivity,UsbManager aUsbManager,AtlantisReader aReader)
    {
        mActivity = aActivity;
    ...
    public AtlantisTerminalHandler(Activity aActivity)
    {
        mActivity = aActivity;
    ...
    @Override
    public List<CardTerminal> listCardTerminals(CardTerminals.State aState)
            throws CardException
    {
        ...
        for (UsbDevice device : mUsbManager.getDeviceList().values())
        {
            ...
            {
                AtlantisCardTerminal cardTerminal = new AtlantisCardTerminal(mReader, slot, device);
            ...
            throws CardException
    {
        ...
        checkLicense();
        AtlantisCardTerminal atlantisTerminal = (AtlantisCardTerminal) aCardTerminal;
        AtlantisCommandTransmitter transmitter = new AtlantisCommandTransmitter(mReader, atlantisTerminal, mUsbManager, mActivity);
