...
public final class NamedCurve extends ECParameterSpec {
    ...
    public NamedCurve(String name, ObjectIdentifier oid, EllipticCurve curve,
    ...
    private static final Map<String, NamedCurve> fullNameMap =
            new HashMap<String, NamedCurve>();
    ...
    private static void add(String name, String soid, int type, String sfield,
        ...
        try {
            ...
            if (fullNameMap.put(name, params) != null) {
                throw new RuntimeException("Duplication name: " + name);
            }
    ...
    public static Map<String, NamedCurve> getNameCurves() {
        return Collections.unmodifiableMap(nameMap);
    }

    public static Map<String, NamedCurve> getNamedCurvesWithFullName() {
    ...
    static {
        ...
        add("brainpoolP256r1", "1.2.36.3.3.1.8.1.1.7", P,
