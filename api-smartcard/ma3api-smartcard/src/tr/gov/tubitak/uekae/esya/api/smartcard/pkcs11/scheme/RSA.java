...
// ----------------------------------------------------------------------------
// $Id: RSA.java,v 1.1 2004/11/02 11:39:42 serdar Exp $
//
...
public class RSA {
   ...
   public static final BigInteger verify(final PublicKey K, final BigInteger s) {
      try {
         ...
         throw new IllegalArgumentException("Signature representative out of range", e);
      }
   }
   ...
   public static final BigInteger encrypt(final PublicKey K, final BigInteger m) {
      try {
         ...
         throw new IllegalArgumentException("Message representative out of range", e);
      }
   }
...
/*
   private static final BigInteger RSADP(final RSAPrivateKey K, BigInteger c) {
      ...
      if (!(K instanceof RSAPrivateCrtKey)) {
         ...
         // decryption.
         final boolean rsaBlinding = true;
         BigInteger r = null;
         BigInteger e = null;
