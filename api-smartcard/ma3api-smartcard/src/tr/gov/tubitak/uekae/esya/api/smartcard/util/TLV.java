...
public class TLV 
{
	 ...
	 */
	  public static int[] getIcerik(byte[] x,int startIndex)
	  {
		  ...
		  return getDataIndexesByLengthIndex(x, lenghtStartIndex);
	  }

	public static int[] getDataIndexesByLengthIndex(byte[] x,int lenghtStartIndex)
	{
	...
	public static byte [] getDataCopyByLengthIndex(byte[] x, int lenghtStartIndex){
		int[] dataByLengthIndex = getDataIndexesByLengthIndex(x, lenghtStartIndex);
		return Arrays.copyOfRange(x, dataByLengthIndex[0],  dataByLengthIndex[1] + 1);
	}
