/**
 * RSA in oaep icin yayinladigi test caseler
 */
 ...
 *
 */
public class RSAOAEPTestSuite extends TestCase{
	
	public static byte[] SALT = null;
	
	private static OAEPParameterSpec getOAEPParameters()
	{
		return OAEPParameterSpec.DEFAULT;
	}
	
	private static ArrayList<byte[]> importAndDecrypt(KeyPair aKP,String aKeyName,ArrayList<byte[]> aCiphers)
	throws Exception
	{
		...
		if(!sc.isPrivateKeyExist(sid, aKeyName))
			sc.importKeyPair(sid, aKeyName, aKP, null, false, true);
		
		
		
		byte[] msg1 = SmartOp.decrypt(sc, sid, slot, aKeyName, aCiphers.get(0), "RSAOAEP", getOAEPParameters());
		
		byte[] msg2 = SmartOp.decrypt(sc, sid, slot, aKeyName, aCiphers.get(1), "RSAOAEP", getOAEPParameters());
	
		byte[] msg3 = SmartOp.decrypt(sc, sid, slot, aKeyName, aCiphers.get(2), "RSAOAEP", getOAEPParameters());
		
		byte[] msg4 = SmartOp.decrypt(sc, sid, slot, aKeyName, aCiphers.get(3), "RSAOAEP", getOAEPParameters());
		
		byte[] msg5 = SmartOp.decrypt(sc, sid, slot, aKeyName, aCiphers.get(4), "RSAOAEP", getOAEPParameters());
		
		byte[] msg6 = SmartOp.decrypt(sc, sid, slot, aKeyName, aCiphers.get(5), "RSAOAEP", getOAEPParameters());
		

		sc.logout(sid);
		sc.closeSession(sid);
		return add(msg1,msg2 , msg3, msg4, msg5, msg6);
	}
	...
	throws Exception
	{
		...
		ArrayList<byte[]> data = add(msg1, msg2, msg3, msg4, msg5, msg6);
		 ...
		 ArrayList<byte[]> results = importAndDecrypt(new KeyPair(pubk, prik), "oaeptest1024", ciphers);
	...
	throws Exception
	{
		...
		ArrayList<byte[]> data = add(msg1, msg2, msg3, msg4, msg5, msg6);
		 ...
		 ArrayList<byte[]> results = importAndDecrypt(new KeyPair(pubk, prik), "oaeptest1025", ciphers);
	...
	throws Exception
	{
		...
		ArrayList<byte[]> data = add(msg1, msg2, msg3, msg4, msg5, msg6);
		 ...
		 ArrayList<byte[]> results = importAndDecrypt(new KeyPair(pubk, prik), "oaeptest1026", ciphers);
	...
	throws Exception
	{
		...
		ArrayList<byte[]> data = add(msg1, msg2, msg3, msg4, msg5, msg6);
		 ...
		 ArrayList<byte[]> results = importAndDecrypt(new KeyPair(pubk, prik), "oaeptest1027", ciphers);
	...
	throws Exception
	{
		...
		ArrayList<byte[]> data = add(msg1, msg2, msg3, msg4, msg5, msg6);
		 ...
		 ArrayList<byte[]> results = importAndDecrypt(new KeyPair(pubk, prik), "oaeptest1028", ciphers);
	...
	throws Exception
	{
		...
		ArrayList<byte[]> data = add(msg1, msg2, msg3, msg4, msg5, msg6);
		 ...
		 ArrayList<byte[]> results = importAndDecrypt(new KeyPair(pubk, prik), "oaeptest1029", ciphers);
	...
	throws Exception
	{
		...
		ArrayList<byte[]> data = add(msg1, msg2, msg3, msg4, msg5, msg6);
		 ...
		 ArrayList<byte[]> results = importAndDecrypt(new KeyPair(pubk, prik), "oaeptest1030", ciphers);
	...
	throws Exception
	{
		...
		ArrayList<byte[]> data = add(msg1, msg2, msg3, msg4, msg5, msg6);
		 ...
		 ArrayList<byte[]> results = importAndDecrypt(new KeyPair(pubk, prik), "oaeptest1031", ciphers);
	...
	throws Exception
	{
		...
		ArrayList<byte[]> data = add(msg1, msg2, msg3, msg4, msg5, msg6);
		 ...
		 ArrayList<byte[]> results = importAndDecrypt(new KeyPair(pubk, prik), "oaeptest1536", ciphers);
	...
	throws Exception
	{
		...
		ArrayList<byte[]> data = add(msg1, msg2, msg3, msg4, msg5, msg6);
		 ...
		 ArrayList<byte[]> results = importAndDecrypt(new KeyPair(pubk, prik), "oaeptest2048", ciphers);
